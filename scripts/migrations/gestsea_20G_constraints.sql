...
ALTER TABLE "table_contact" ALTER "cn_numero" SET DEFAULT nextval('seq_contact');
ALTER TABLE "table_contact" ALTER "cn_actif" SET DEFAULT true;
ALTER TABLE "table_contact" ALTER "cn_copying" SET DEFAULT false;
ALTER TABLE "table_contact" ALTER "cn_personal" SET DEFAULT false;
...
ALTER TABLE "table_cotisation" ALTER "cs_reduction" SET DEFAULT 0.00;
...
ALTER TABLE "table_estresponsable" ALTER "peac_periodedebut" SET DEFAULT NULL;
...
ALTER TABLE "table_contact" ALTER "cn_copying" SET NOT NULL ;
ALTER TABLE "table_contact" ALTER "cn_personal" SET NOT NULL ;
...
ALTER TABLE "table_cotisation" ALTER "cs_reduction" SET NOT NULL ;
