...
CREATE OR REPLACE VIEW "adresse" AS
   SELECT table_adresse.ad_numero, table_adresse.ak_numero, table_adresse.cp_numero, table_adresse.vi_numero, table_adresse.pe_numero, table_adresse.ad_default, table_adresse.ad_active, table_adresse.ct_numero, table_adresse.ad_ligne2, table_adresse.ad_ligne3, table_adresse.ad_ligne4, table_adresse.ad_ligne5, table_adresse.ad_datestop, table_adresse.created_at, table_adresse.created_by, table_adresse.updated_at, table_adresse.updated_by, table_adresse.lock_version, table_adresse.id, (pe_numero-1000000)||'. '||COALESCE(Ad_Ligne2||', ','')||COALESCE(Ad_Ligne3||', ','')||COALESCE(Ad_Ligne4||', ','')||COALESCE(Ad_Ligne5||', ','')||CP_CodePostal||' '||VI_Nom AS AD_Libelle, COALESCE(Ad_Ligne2,'')||';'||COALESCE(Ad_Ligne3,'')||';'||COALESCE(Ad_Ligne4,'')||';'||COALESCE(Ad_Ligne5,'')||';'||CP_CodePostal||';'||VI_Nom AS AD_CSV, CASE WHEN AD_Default THEN 'Def.' ELSE '' END AS AD_Def, COALESCE(Ad_Ligne2||'#','')||COALESCE(Ad_Ligne3||'#','')||COALESCE(Ad_Ligne4||'#','')||COALESCE(Ad_Ligne5,'') AS AD_Lignes, COALESCE(table_Adresse.CT_Numero, VI.CT_Numero) AS AD_Canton 
     FROM "table_adresse" JOIN table_CodePostal AS CP USING (CP_Numero) JOIN table_Ville AS VI USING (VI_Numero) 
    WHERE AD_Active;
...
CREATE OR REPLACE VIEW "cotisation" AS
   SELECT table_cotisation.cs_numero, table_cotisation.pe_numero, table_cotisation.cs_societe, table_cotisation.ig_numero, table_cotisation.cs_standard, table_cotisation.cs_annee, table_cotisation.cs_detail, table_cotisation.cs_duo, table_cotisation.cs_done, table_cotisation.cs_valid, table_cotisation.cs_report, table_cotisation.cs_nature, ROUND(table_cotisation.cs_montant,2) AS cs_montant, ROUND(table_cotisation.cs_reduction,2) AS cs_reduction, table_cotisation.created_at, table_cotisation.created_by, table_cotisation.updated_at, table_cotisation.updated_by, table_cotisation.lock_version, table_cotisation.id 
...
CREATE OR REPLACE RULE rule_adresse_insert AS
  ...
  DO INSTEAD INSERT INTO "table_adresse"(ad_numero, ak_numero, cp_numero, vi_numero, pe_numero, ad_default, ad_active, ct_numero, ad_ligne2, ad_ligne3, ad_ligne4, ad_ligne5, ad_datestop, created_at, created_by, updated_at, updated_by, lock_version, id) VALUES (COALESCE(NEW.ad_numero,nextval('seq_adresse')), new.ak_numero, new.cp_numero, new.vi_numero, new.pe_numero, COALESCE(NEW.ad_default,false), COALESCE(NEW.ad_active,true), new.ct_numero, new.ad_ligne2, new.ad_ligne3, new.ad_ligne4, new.ad_ligne5, new.ad_datestop, CURRENT_TIMESTAMP, CURRENT_USER, CURRENT_TIMESTAMP, CURRENT_USER, 0, DEFAULT);
CREATE OR REPLACE RULE rule_adresse_update AS
  ON UPDATE TO "adresse"
  DO INSTEAD UPDATE "table_adresse" SET ad_numero=COALESCE(NEW.ad_numero,nextval('seq_adresse')), ak_numero=new.ak_numero, cp_numero=new.cp_numero, vi_numero=new.vi_numero, pe_numero=new.pe_numero, ad_default=COALESCE(NEW.ad_default,false), ad_active=COALESCE(NEW.ad_active,true), ct_numero=new.ct_numero, ad_ligne2=new.ad_ligne2, ad_ligne3=new.ad_ligne3, ad_ligne4=new.ad_ligne4, ad_ligne5=new.ad_ligne5, ad_datestop=new.ad_datestop, created_at=OLD.created_at, created_by=OLD.created_by, updated_at=CURRENT_TIMESTAMP, updated_by=CURRENT_USER, lock_version=OLD.lock_version+1, id=OLD.id WHERE new.AD_Numero=AD_Numero;
...
CREATE OR REPLACE RULE rule_cotisation_insert AS
  ...
  DO INSTEAD INSERT INTO "table_cotisation"(cs_numero, pe_numero, cs_societe, ig_numero, cs_standard, cs_annee, cs_detail, cs_duo, cs_done, cs_valid, cs_report, cs_nature, cs_montant, cs_reduction, created_at, created_by, updated_at, updated_by, lock_version, id) VALUES (new.cs_numero, new.pe_numero, new.cs_societe, new.ig_numero, COALESCE(NEW.cs_standard,false), new.cs_annee, COALESCE(NEW.cs_detail,'{saved:false}'), COALESCE(NEW.cs_duo,false), COALESCE(NEW.cs_done,false), COALESCE(NEW.cs_valid,false), new.cs_report, new.cs_nature, ROUND(COALESCE(NEW.cs_montant,0),2), ROUND(COALESCE(NEW.cs_reduction,0.00),2), CURRENT_TIMESTAMP, CURRENT_USER, CURRENT_TIMESTAMP, CURRENT_USER, 0, DEFAULT);
CREATE OR REPLACE RULE rule_cotisation_update AS
  ON UPDATE TO "cotisation"
  DO INSTEAD UPDATE "table_cotisation" SET cs_numero=new.cs_numero, pe_numero=new.pe_numero, cs_societe=new.cs_societe, ig_numero=new.ig_numero, cs_standard=COALESCE(NEW.cs_standard,false), cs_annee=new.cs_annee, cs_detail=COALESCE(NEW.cs_detail,'{saved:false}'), cs_duo=COALESCE(NEW.cs_duo,false), cs_done=COALESCE(NEW.cs_done,false), cs_valid=COALESCE(NEW.cs_valid,false), cs_report=new.cs_report, cs_nature=new.cs_nature, cs_montant=ROUND(COALESCE(NEW.cs_montant,0),2), cs_reduction=ROUND(COALESCE(NEW.cs_reduction,0.00),2), created_at=OLD.created_at, created_by=OLD.created_by, updated_at=CURRENT_TIMESTAMP, updated_by=CURRENT_USER, lock_version=OLD.lock_version+1, id=OLD.id WHERE new.CS_Numero=CS_Numero;
...
CREATE OR REPLACE RULE rule_devis_insert AS
  ON INSERT TO "devis"
  DO INSTEAD INSERT INTO "table_devis"(de_numero, pe_numero, so_numero, de_date, de_libelle, de_reduction, de_montantht, de_montantttc, em_numero, de_locked, de_acompte, de_lettre, ad_numero, de_civilites, de_introduction, created_at, created_by, updated_at, updated_by, lock_version, id) VALUES (new.de_numero, new.pe_numero, new.so_numero, COALESCE(NEW.de_date,CURRENT_DATE), new.de_libelle, ROUND(new.de_reduction,2), ROUND(new.de_montantht,2), ROUND(new.de_montantttc,2), new.em_numero, COALESCE(NEW.de_locked,false), COALESCE(NEW.de_acompte,false), COALESCE(NEW.de_lettre,false), new.ad_numero, new.de_civilites, new.de_introduction, CURRENT_TIMESTAMP, CURRENT_USER, CURRENT_TIMESTAMP, CURRENT_USER, 0, DEFAULT);
CREATE OR REPLACE RULE rule_devis_update AS
  ON UPDATE TO "devis"
  DO INSTEAD UPDATE "table_devis" SET de_numero=new.de_numero, pe_numero=new.pe_numero, so_numero=new.so_numero, de_date=COALESCE(NEW.de_date,CURRENT_DATE), de_libelle=new.de_libelle, de_reduction=ROUND(new.de_reduction,2), de_montantht=ROUND(new.de_montantht,2), de_montantttc=ROUND(new.de_montantttc,2), em_numero=new.em_numero, de_locked=COALESCE(NEW.de_locked,false), de_acompte=COALESCE(NEW.de_acompte,false), de_lettre=COALESCE(NEW.de_lettre,false), ad_numero=new.ad_numero, de_civilites=new.de_civilites, de_introduction=new.de_introduction, created_at=OLD.created_at, created_by=OLD.created_by, updated_at=CURRENT_TIMESTAMP, updated_by=CURRENT_USER, lock_version=OLD.lock_version+1, id=OLD.id WHERE new.DE_Numero=DE_Numero;
...
CREATE OR REPLACE RULE rule_lignefacture_insert AS
  ...
  DO INSTEAD INSERT INTO "table_lignefacture"(lf_numero, fa_numero, px_numero, pd_numero, lf_quantite, pe_numero, lf_montantht, lf_montantttc, lf_avoir, lf_notes, created_at, created_by, updated_at, updated_by, lock_version, id) VALUES (COALESCE(NEW.lf_numero,nextval('seq_lignefacture')), new.fa_numero, new.px_numero, new.pd_numero, ROUND(COALESCE(NEW.lf_quantite,0),2), new.pe_numero, ROUND(new.lf_montantht,2), ROUND(new.lf_montantttc,2), COALESCE(NEW.lf_avoir,false), new.lf_notes, CURRENT_TIMESTAMP, CURRENT_USER, CURRENT_TIMESTAMP, CURRENT_USER, 0, DEFAULT);
CREATE OR REPLACE RULE rule_lignefacture_update AS
  ON UPDATE TO "lignefacture"
  DO INSTEAD UPDATE "table_lignefacture" SET lf_numero=COALESCE(NEW.lf_numero,nextval('seq_lignefacture')), fa_numero=new.fa_numero, px_numero=new.px_numero, pd_numero=new.pd_numero, lf_quantite=ROUND(COALESCE(NEW.lf_quantite,0),2), pe_numero=new.pe_numero, lf_montantht=ROUND(new.lf_montantht,2), lf_montantttc=ROUND(new.lf_montantttc,2), lf_avoir=COALESCE(NEW.lf_avoir,false), lf_notes=new.lf_notes, created_at=OLD.created_at, created_by=OLD.created_by, updated_at=CURRENT_TIMESTAMP, updated_by=CURRENT_USER, lock_version=OLD.lock_version+1, id=OLD.id WHERE new.LF_Numero=LF_Numero;
