...
function delete_data_source(object) {
...
function listbox_fill(id, query) {
  ...
  if (result.rowCount>0) {
    if (idx<0) {
      ...
      if (idx>=result.rowCount) {
        list.selectedIndex=result.rowCount-1;
      } else {
