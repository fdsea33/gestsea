...
var TAB_COMPO_PPTES = new Array(848);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[758].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[758].NewCle = getNewCle("personne");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[758].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[761];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[762];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[763];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[764];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[765];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[766];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[767];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[768];
...
top.document.getElementById("Update_Personnes_Adresses_9").disabled=false;
 var Esclave_8=TAB_GLOBAL_COMPO[775];
...
top.document.getElementById("Update_Personnes_Contact_17").disabled=false;
 var Esclave_9=TAB_GLOBAL_COMPO[787];
...
top.document.getElementById("Update_Personnes_Attributs_20").disabled=false;
 var Esclave_10=TAB_GLOBAL_COMPO[792];
...
top.document.getElementById("Update_Personnes_Routages_24").disabled=false;
 var Esclave_11=TAB_GLOBAL_COMPO[798];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[758];
...
return TAB_COMPO_PPTES[758].NewCle;
}

function Delete_Personnes_Liste_des_personnes0()
{
 if (TAB_GLOBAL_COMPO[758].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[758].Action_en_cours = DELETE;
...
function Update_Personnes_Liste_des_personnes0()
{
 ...
 TAB_COMPO_PPTES[758].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[758].NewCle = TAB_GLOBAL_COMPO[758].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[758].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[761];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[758].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[758].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[761];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[758].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[758].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[758].Action_en_cours == INSERT)
         {
 ...
 TAB_COMPO_PPTES[775].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[775].NewCle = getNewCle("adresse");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[775].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[780];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[781];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[782];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[783];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[784];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[785];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[786];
 Esclave_6.ActiverComposant(true);
...
top.document.getElementById("Delete_Personnes_Adresses_9").disabled=true;
top.document.getElementById("Update_Personnes_Adresses_9").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[775];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[775].NewCle;
}

function Delete_Personnes_Adresses_9()
{
 if (TAB_GLOBAL_COMPO[775].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[775].Action_en_cours = DELETE;
...
function Update_Personnes_Adresses_9()
{
 ...
 TAB_COMPO_PPTES[775].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[775].NewCle = TAB_GLOBAL_COMPO[775].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[775].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[780];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[775].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[775].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[780];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[781];
...
top.document.getElementById("Update_Personnes_Adresses_9").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[775].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[775].Action_en_cours = null;
 return NewCle;
}
...
function Insert_Personnes_Contact_17()
{
 ...
 TAB_COMPO_PPTES[787].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[787].NewCle = getNewCle("contact");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[787].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
...
top.document.getElementById("Delete_Personnes_Contact_17").disabled=true;
top.document.getElementById("Update_Personnes_Contact_17").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[787];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[787].NewCle;
}

function Delete_Personnes_Contact_17()
{
 if (TAB_GLOBAL_COMPO[787].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[787].Action_en_cours = DELETE;
...
function Update_Personnes_Contact_17()
{
 ...
 TAB_COMPO_PPTES[787].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[787].NewCle = TAB_GLOBAL_COMPO[787].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[787].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[790];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[787].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[787].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[790];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[791];
...
top.document.getElementById("Update_Personnes_Contact_17").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[787].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[787].Action_en_cours = null;
 return NewCle;
}
...
function Insert_Personnes_Attributs_20()
{
 ...
 TAB_COMPO_PPTES[792].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[792].NewCle = getNewCle("attribut");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[792].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[795];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[796];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[797];
 Esclave_2.ActiverComposant(true);
...
top.document.getElementById("Delete_Personnes_Attributs_20").disabled=true;
top.document.getElementById("Update_Personnes_Attributs_20").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[792];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[792].NewCle;
}

function Delete_Personnes_Attributs_20()
{
 if (TAB_GLOBAL_COMPO[792].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[792].Action_en_cours = DELETE;
...
function Update_Personnes_Attributs_20()
{
 ...
 TAB_COMPO_PPTES[792].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[792].NewCle = TAB_GLOBAL_COMPO[792].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[792].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[795];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[792].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[792].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[795];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[796];
...
top.document.getElementById("Update_Personnes_Attributs_20").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[792].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[792].Action_en_cours = null;
 return NewCle;
}
...
function Insert_Personnes_Routages_24()
{
 ...
 TAB_COMPO_PPTES[798].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[798].NewCle = getNewCle("routage");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[798].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
...
top.document.getElementById("Delete_Personnes_Routages_24").disabled=true;
top.document.getElementById("Update_Personnes_Routages_24").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[798];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[798].NewCle;
}

function Delete_Personnes_Routages_24()
{
 if (TAB_GLOBAL_COMPO[798].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[798].Action_en_cours = DELETE;
...
function Update_Personnes_Routages_24()
{
 ...
 TAB_COMPO_PPTES[798].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[798].NewCle = TAB_GLOBAL_COMPO[798].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[798].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[804];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[798].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[798].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[804];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[805];
...
top.document.getElementById("Update_Personnes_Routages_24").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[798].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[798].Action_en_cours = null;
 return NewCle;
}
...
top.TAB_GLOBAL_COMPO[758]=Compo_Personnes_Liste_des_personnes0;
...
top.TAB_GLOBAL_COMPO[761]=Compo_Personnes_Numéro_1;
...
top.TAB_GLOBAL_COMPO[762]=Compo_Personnes_Titre_ou_F_J__2;
...
top.TAB_GLOBAL_COMPO[763]=Compo_Personnes_Nom_ou_D_S__3;
...
top.TAB_GLOBAL_COMPO[764]=Compo_Personnes_Prénom_4;
...
top.TAB_GLOBAL_COMPO[765]=Compo_Personnes_N_TVA_intrac__5;
...
top.TAB_GLOBAL_COMPO[766]=Compo_Personnes_Né_e__le_6;
...
top.TAB_GLOBAL_COMPO[767]=Compo_Personnes_La_personne_est_active__et_peut_être_contactée__7;
...
top.TAB_GLOBAL_COMPO[768]=Compo_Personnes_Cotisations_8;
...
top.TAB_GLOBAL_COMPO[775]=Compo_Personnes_Adresses_9;
...
top.TAB_GLOBAL_COMPO[780]=Compo_Personnes_Apt_ou_Dest__10;
...
top.TAB_GLOBAL_COMPO[781]=Compo_Personnes_Bat__étage____11;
...
top.TAB_GLOBAL_COMPO[782]=Compo_Personnes_N__et_Voie_12;
...
top.TAB_GLOBAL_COMPO[783]=Compo_Personnes_BP_ou_Lieu_dit_13;
...
top.TAB_GLOBAL_COMPO[784]=Compo_Personnes_Code_postal_14;
...
top.TAB_GLOBAL_COMPO[785]=Compo_Personnes_Ville_15;
...
top.TAB_GLOBAL_COMPO[786]=Compo_Personnes_Adresse_par_défaut_16;
...
top.TAB_GLOBAL_COMPO[787]=Compo_Personnes_Contact_17;
...
top.TAB_GLOBAL_COMPO[790]=Compo_Personnes_Type_18;
...
top.TAB_GLOBAL_COMPO[791]=Compo_Personnes_Coordonnée_19;
...
top.TAB_GLOBAL_COMPO[792]=Compo_Personnes_Attributs_20;
...
top.TAB_GLOBAL_COMPO[795]=Compo_Personnes_Attribut_21;
...
top.TAB_GLOBAL_COMPO[796]=Compo_Personnes_Valeur_22;
...
top.TAB_GLOBAL_COMPO[797]=Compo_Personnes_Détail_23;
...
top.TAB_GLOBAL_COMPO[798]=Compo_Personnes_Routages_24;
...
top.TAB_GLOBAL_COMPO[804]=Compo_Personnes_Début_25;
...
top.TAB_GLOBAL_COMPO[805]=Compo_Personnes_Fin_26;
...
top.TAB_GLOBAL_COMPO[806]=Compo_Personnes_Quantité_27;
...
top.TAB_GLOBAL_COMPO[807]=Compo_Personnes_Suspendre_les_relances_28;
...
top.TAB_GLOBAL_COMPO[808]=Compo_Routage_Liste_des_routages0;
...
Compo_Relances_Liste_des_relances0.GenererXUL(top.document.getElementById("Relances_Liste_des_relances0"));
	...
	/* On l'ajoute au tableau global à l'indice 820*/
top.TAB_GLOBAL_COMPO[820]=Compo_Relances_Liste_des_relances0;
...
top.TAB_GLOBAL_COMPO[835]=Compo_Relances_des_adhérents_Liste_des_relances_adhérents0;
 if(ALeDroit(5,"personne"))
 {
/* On refresh les composants non dépendents de l'onget Personnes*/
var Composant_0 = TAB_GLOBAL_COMPO[758];
if (Composant_0!=null){
...
var Composant_0 = TAB_GLOBAL_COMPO[808];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[820];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[835];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
ConstruireOngletEstLie("tabbox_Personnes_Liste_des_personnes0",758);
