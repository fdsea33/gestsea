...
var TAB_COMPO_PPTES = new Array(860);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[770].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[770].NewCle = getNewCle("personne");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[770].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[773];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[774];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[775];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[776];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[777];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[778];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[779];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[780];
...
top.document.getElementById("Update_Personnes_Adresses_9").disabled=false;
 var Esclave_8=TAB_GLOBAL_COMPO[787];
...
top.document.getElementById("Update_Personnes_Contact_17").disabled=false;
 var Esclave_9=TAB_GLOBAL_COMPO[799];
...
top.document.getElementById("Update_Personnes_Attributs_20").disabled=false;
 var Esclave_10=TAB_GLOBAL_COMPO[804];
...
top.document.getElementById("Update_Personnes_Routages_24").disabled=false;
 var Esclave_11=TAB_GLOBAL_COMPO[810];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[770];
...
return TAB_COMPO_PPTES[770].NewCle;
}

function Delete_Personnes_Liste_des_personnes0()
{
 if (TAB_GLOBAL_COMPO[770].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[770].Action_en_cours = DELETE;
...
function Update_Personnes_Liste_des_personnes0()
{
 ...
 TAB_COMPO_PPTES[770].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[770].NewCle = TAB_GLOBAL_COMPO[770].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[770].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[773];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[770].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[770].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[773];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[770].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[770].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[770].Action_en_cours == INSERT)
         {
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[787].NewCle = getNewCle("adresse");
/* On désactive le composant maitre */
...
/* On active les composants esclaves et on vide les champs */
 ...
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[795];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[796];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[797];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[798];
 Esclave_6.ActiverComposant(true);
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[799].NewCle = getNewCle("contact");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[799].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[802];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[803];
 Esclave_1.ActiverComposant(true);
...
function Insert_Personnes_Attributs_20()
{
 ...
 TAB_COMPO_PPTES[804].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[804].NewCle = getNewCle("attribut");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[804].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
...
top.document.getElementById("Delete_Personnes_Attributs_20").disabled=true;
top.document.getElementById("Update_Personnes_Attributs_20").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[804];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[804].NewCle;
}

function Delete_Personnes_Attributs_20()
{
 if (TAB_GLOBAL_COMPO[804].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[804].Action_en_cours = DELETE;
...
function Update_Personnes_Attributs_20()
{
 ...
 TAB_COMPO_PPTES[804].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[804].NewCle = TAB_GLOBAL_COMPO[804].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[804].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[807];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[804].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[804].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[807];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[808];
...
top.document.getElementById("Update_Personnes_Attributs_20").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[804].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[804].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[810].NewCle = getNewCle("routage");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[810].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[816];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[817];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[818];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[819];
 Esclave_3.ActiverComposant(true);
...
top.TAB_GLOBAL_COMPO[770]=Compo_Personnes_Liste_des_personnes0;
...
top.TAB_GLOBAL_COMPO[773]=Compo_Personnes_Numéro_1;
...
top.TAB_GLOBAL_COMPO[774]=Compo_Personnes_Titre_ou_F_J__2;
...
top.TAB_GLOBAL_COMPO[775]=Compo_Personnes_Nom_ou_D_S__3;
...
top.TAB_GLOBAL_COMPO[776]=Compo_Personnes_Prénom_4;
...
top.TAB_GLOBAL_COMPO[777]=Compo_Personnes_N_TVA_intrac__5;
...
top.TAB_GLOBAL_COMPO[778]=Compo_Personnes_Né_e__le_6;
...
top.TAB_GLOBAL_COMPO[779]=Compo_Personnes_La_personne_est_active__et_peut_être_contactée__7;
...
top.TAB_GLOBAL_COMPO[780]=Compo_Personnes_Cotisations_8;
...
top.TAB_GLOBAL_COMPO[787]=Compo_Personnes_Adresses_9;
...
top.TAB_GLOBAL_COMPO[792]=Compo_Personnes_Apt_ou_Dest__10;
...
top.TAB_GLOBAL_COMPO[793]=Compo_Personnes_Bat__étage____11;
...
top.TAB_GLOBAL_COMPO[794]=Compo_Personnes_N__et_Voie_12;
...
top.TAB_GLOBAL_COMPO[795]=Compo_Personnes_BP_ou_Lieu_dit_13;
...
top.TAB_GLOBAL_COMPO[796]=Compo_Personnes_Code_postal_14;
...
top.TAB_GLOBAL_COMPO[797]=Compo_Personnes_Ville_15;
...
top.TAB_GLOBAL_COMPO[798]=Compo_Personnes_Adresse_par_défaut_16;
...
top.TAB_GLOBAL_COMPO[799]=Compo_Personnes_Contact_17;
...
top.TAB_GLOBAL_COMPO[802]=Compo_Personnes_Type_18;
...
top.TAB_GLOBAL_COMPO[803]=Compo_Personnes_Coordonnée_19;
...
top.TAB_GLOBAL_COMPO[804]=Compo_Personnes_Attributs_20;
...
top.TAB_GLOBAL_COMPO[807]=Compo_Personnes_Attribut_21;
...
top.TAB_GLOBAL_COMPO[808]=Compo_Personnes_Valeur_22;
...
top.TAB_GLOBAL_COMPO[809]=Compo_Personnes_Détail_23;
...
top.TAB_GLOBAL_COMPO[810]=Compo_Personnes_Routages_24;
...
top.TAB_GLOBAL_COMPO[816]=Compo_Personnes_Début_25;
...
top.TAB_GLOBAL_COMPO[817]=Compo_Personnes_Fin_26;
...
top.TAB_GLOBAL_COMPO[818]=Compo_Personnes_Quantité_27;
...
top.TAB_GLOBAL_COMPO[819]=Compo_Personnes_Suspendre_les_relances_28;
...
top.TAB_GLOBAL_COMPO[820]=Compo_Routage_Liste_des_routages0;
...
top.TAB_GLOBAL_COMPO[832]=Compo_Relances_Liste_des_relances0;
...
Compo_Relances_des_adhérents_Liste_des_relances_adhérents0.GenererXUL(top.document.getElementById("Relances_des_adhérents_Liste_des_relances_adhérents0"));
	...
	/* On l'ajoute au tableau global à l'indice 847*/
top.TAB_GLOBAL_COMPO[847]=Compo_Relances_des_adhérents_Liste_des_relances_adhérents0;
 if(ALeDroit(5,"personne"))
 {
/* On refresh les composants non dépendents de l'onget Personnes*/
var Composant_0 = TAB_GLOBAL_COMPO[770];
if (Composant_0!=null){
...
var Composant_0 = TAB_GLOBAL_COMPO[847];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
ConstruireOngletEstLie("tabbox_Personnes_Liste_des_personnes0",770);
