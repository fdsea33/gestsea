...
var TAB_COMPO_PPTES = new Array(393);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[333].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[333].NewCle = getNewCle("adherence");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[333].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[337];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[338];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[339];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[340];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[341];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[345];
...
top.document.getElementById("Update_Adhérence_Liste_des_adhérences0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[333];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[333].NewCle;
}

function Delete_Adhérence_Liste_des_adhérences0()
{
 if (TAB_GLOBAL_COMPO[333].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[333].Action_en_cours = DELETE;
...
function Update_Adhérence_Liste_des_adhérences0()
{
 ...
 TAB_COMPO_PPTES[333].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[333].NewCle = TAB_GLOBAL_COMPO[333].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[333].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[337];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[333].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[333].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[337];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[338];
...
top.document.getElementById("Update_Adhérence_Liste_des_adhérences0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[333].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[333].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[245].NewCle = getNewCle("agent");
/* On désactive le composant maitre */
...
/* On active les composants esclaves et on vide les champs */
 ...
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[254];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[255];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[256];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[257];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[258];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[259];
 Esclave_8.ActiverComposant(true);
 var Esclave_9=TAB_GLOBAL_COMPO[260];
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[290].NewCle = getNewCle("canton");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[290].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[293];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[294];
 Esclave_1.ActiverComposant(true);
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[270].NewCle = getNewCle("codepostal");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[270].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[274];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[275];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[279];
 Esclave_2.ActiverComposant(true);
...
{
 TAB_COMPO_PPTES[229].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[229].NewCle = getNewCle("droitprofil");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[229].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[231];
 Esclave_0.ActiverComposant(true);
...
top.document.getElementById("Update_Profils_de_droits_Droits_2").disabled=false;
 var Esclave_1=TAB_GLOBAL_COMPO[232];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Profils_de_droits_Liste_des_profils_de_droits0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[229];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[229].NewCle;
}

function Delete_Profils_de_droits_Liste_des_profils_de_droits0()
{
 if (TAB_GLOBAL_COMPO[229].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[229].Action_en_cours = DELETE;
...
function Update_Profils_de_droits_Liste_des_profils_de_droits0()
{
 ...
 TAB_COMPO_PPTES[229].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[229].NewCle = TAB_GLOBAL_COMPO[229].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[229].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[231];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[229].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[229].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[231];
 Esclave_0.ActiverComposant(false);
...
top.document.getElementById("Update_Profils_de_droits_Liste_des_profils_de_droits0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[229].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 ...
 TAB_COMPO_PPTES[229].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[229].Action_en_cours == INSERT)
         {
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[232].NewCle = getNewCle("droit");
/* On désactive le composant maitre */
...
/* On active les composants esclaves et on vide les champs */
 ...
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[237];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[238];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[239];
 Esclave_4.ActiverComposant(true);
...
TAB_GLOBAL_COMPO[236].my_CompoXUL.value=true;
TAB_GLOBAL_COMPO[236].my_CompoXUL.checked=true;
...
{
 TAB_COMPO_PPTES[213].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[213].NewCle = getNewCle("employe");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[213].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 ...
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[221];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[222];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[223];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[224];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[225];
 Esclave_8.ActiverComposant(true);
 var Esclave_9=TAB_GLOBAL_COMPO[226];
 Esclave_9.ActiverComposant(true);
 var Esclave_10=TAB_GLOBAL_COMPO[227];
 Esclave_10.ActiverComposant(true);
 var Esclave_11=TAB_GLOBAL_COMPO[228];
...
top.document.getElementById("Update_Employés_Liste_des_employés0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[213];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[213].NewCle;
}

function Delete_Employés_Liste_des_employés0()
{
 if (TAB_GLOBAL_COMPO[213].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[213].Action_en_cours = DELETE;
...
function Update_Employés_Liste_des_employés0()
{
 ...
 TAB_COMPO_PPTES[213].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[213].NewCle = TAB_GLOBAL_COMPO[213].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[213].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[217];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[213].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[213].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[217];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[218];
...
top.document.getElementById("Update_Employés_Liste_des_employés0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[213].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 ...
 TAB_COMPO_PPTES[213].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[261].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[261].NewCle = getNewCle("equipe");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[261].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
...
top.document.getElementById("Update_Équipes_Liste_des_équipes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[261];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[261].NewCle;
}

function Delete_Équipes_Liste_des_équipes0()
{
 if (TAB_GLOBAL_COMPO[261].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[261].Action_en_cours = DELETE;
...
function Update_Équipes_Liste_des_équipes0()
{
 ...
 TAB_COMPO_PPTES[261].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[261].NewCle = TAB_GLOBAL_COMPO[261].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[261].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[263];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[261].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[261].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[263];
 Esclave_0.ActiverComposant(false);
...
top.document.getElementById("Update_Équipes_Liste_des_équipes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[261].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 ...
 TAB_COMPO_PPTES[261].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[240].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[240].NewCle = getNewCle("groupetable");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[240].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
...
top.document.getElementById("Update_Groupe_de_tables_Liste_des_groupes_de_tables0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[240];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[240].NewCle;
}

function Delete_Groupe_de_tables_Liste_des_groupes_de_tables0()
{
 if (TAB_GLOBAL_COMPO[240].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[240].Action_en_cours = DELETE;
...
function Update_Groupe_de_tables_Liste_des_groupes_de_tables0()
{
 ...
 TAB_COMPO_PPTES[240].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[240].NewCle = TAB_GLOBAL_COMPO[240].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[240].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[243];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[240].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[240].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[243];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[244];
...
top.document.getElementById("Update_Groupe_de_tables_Liste_des_groupes_de_tables0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[240].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 ...
 TAB_COMPO_PPTES[240].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[372].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[372].NewCle = getNewCle("impression");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[372].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[375];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[376];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[377];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[378];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[379];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[380];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[381];
 Esclave_6.ActiverComposant(true);
...
top.document.getElementById("Update_Modèles_d_impressions_Liste_des_modèles_d_impressions0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[372];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
function Delete_Modèles_d_impressions_Liste_des_modèles_d_impressions0()
{
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[372].Action_en_cours = DELETE;
...
function Update_Modèles_d_impressions_Liste_des_modèles_d_impressions0()
{
 ...
 TAB_COMPO_PPTES[372].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[372].NewCle = TAB_GLOBAL_COMPO[372].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[372].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[375];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[372].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[372].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[375];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[376];
...
top.document.getElementById("Update_Modèles_d_impressions_Liste_des_modèles_d_impressions0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[372].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[372].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[382].NewCle = getNewCle("table_impression");
/* On désactive le composant maitre */
...
/* On active les composants esclaves et on vide les champs */
 ...
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[392];
 Esclave_7.ActiverComposant(true);
...
{
 TAB_COMPO_PPTES[360].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[360].NewCle = getNewCle("modele");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[360].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
...
top.document.getElementById("Update_Modèles_Liste_des_modèles0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[360];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[360].NewCle;
}

function Delete_Modèles_Liste_des_modèles0()
{
 if (TAB_GLOBAL_COMPO[360].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[360].Action_en_cours = DELETE;
...
function Update_Modèles_Liste_des_modèles0()
{
 ...
 TAB_COMPO_PPTES[360].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[360].NewCle = TAB_GLOBAL_COMPO[360].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[360].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[362];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[360].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[360].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[362];
 Esclave_0.ActiverComposant(false);
...
top.document.getElementById("Update_Modèles_Liste_des_modèles0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[360].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[360].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[360].Action_en_cours == INSERT)
         {
                 if (confirm("Pour continuer, vous devez enregistrer votre saisie\n Voulez vous poursuivre ?"))
                {
 ...
 TAB_COMPO_PPTES[363].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[363].NewCle = getNewCle("lignemodele");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[363].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[368];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[369];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[370];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[371];
 Esclave_3.ActiverComposant(true);
...
top.document.getElementById("Delete_Modèles_Lignes_du_modèle_2").disabled=true;
top.document.getElementById("Update_Modèles_Lignes_du_modèle_2").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[363];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[363].NewCle;
}

function Delete_Modèles_Lignes_du_modèle_2()
{
 if (TAB_GLOBAL_COMPO[363].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[363].Action_en_cours = DELETE;
...
function Update_Modèles_Lignes_du_modèle_2()
{
 ...
 TAB_COMPO_PPTES[363].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[363].NewCle = TAB_GLOBAL_COMPO[363].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[363].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[368];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[363].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[363].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[368];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[369];
...
top.document.getElementById("Update_Modèles_Lignes_du_modèle_2").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[363].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[363].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[348].NewCle = getNewCle("periode");
/* On désactive le composant maitre */
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[357].NewCle = getNewCle("prefixe");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[357].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[359];
 Esclave_0.ActiverComposant(true);
...
{
 TAB_COMPO_PPTES[311].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[311].NewCle = getNewCle("produit");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[311].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[314];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[315];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[316];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[317];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[318];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[319];
 Esclave_5.ActiverComposant(true);
...
top.document.getElementById("Update_Produits_Prix_7").disabled=false;
 var Esclave_6=TAB_GLOBAL_COMPO[320];
 Esclave_6.ActiverComposant(true);
...
top.document.getElementById("Update_Produits_Comptes_généraux_11").disabled=false;
 var Esclave_7=TAB_GLOBAL_COMPO[328];
 Esclave_7.ActiverComposant(true);
...
top.document.getElementById("Update_Produits_Liste_des_produits0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[311];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
TAB_GLOBAL_COMPO[317].my_CompoXUL.value=true;
TAB_GLOBAL_COMPO[317].my_CompoXUL.checked=true;

return TAB_COMPO_PPTES[311].NewCle;
}

function Delete_Produits_Liste_des_produits0()
{
 if (TAB_GLOBAL_COMPO[311].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[311].Action_en_cours = DELETE;
...
function Update_Produits_Liste_des_produits0()
{
 ...
 TAB_COMPO_PPTES[311].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[311].NewCle = TAB_GLOBAL_COMPO[311].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[311].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[314];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[311].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[311].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[314];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[315];
...
top.document.getElementById("Update_Produits_Liste_des_produits0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[311].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 ...
 TAB_COMPO_PPTES[311].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[311].Action_en_cours == INSERT)
         {
                 if (confirm("Pour continuer, vous devez enregistrer votre saisie\n Voulez vous poursuivre ?"))
                {
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[320].NewCle = getNewCle("prix");
/* On désactive le composant maitre */
...
TAB_GLOBAL_COMPO[327].my_CompoXUL.selectedIndex=1;
...
function Insert_Produits_Comptes_généraux_11()
{
 ...
 TAB_COMPO_PPTES[328].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[328].NewCle = getNewCle("compteproduit");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[328].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
...
top.document.getElementById("Delete_Produits_Comptes_généraux_11").disabled=true;
top.document.getElementById("Update_Produits_Comptes_généraux_11").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[328];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[328].NewCle;
}

function Delete_Produits_Comptes_généraux_11()
{
 if (TAB_GLOBAL_COMPO[328].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[328].Action_en_cours = DELETE;
...
function Update_Produits_Comptes_généraux_11()
{
 ...
 TAB_COMPO_PPTES[328].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[328].NewCle = TAB_GLOBAL_COMPO[328].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[328].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[331];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[328].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[328].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[331];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[332];
...
top.document.getElementById("Update_Produits_Comptes_généraux_11").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[328].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[328].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[296].NewCle = getNewCle("responsabilite");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[296].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[300];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[301];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[302];
 Esclave_2.ActiverComposant(true);
...
/* On active les composants esclaves et on vide les champs */
 ...
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[209];
 Esclave_2.ActiverComposant(true);
...
{
 TAB_COMPO_PPTES[303].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[303].NewCle = getNewCle("tva");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[303].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[307];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[308];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[309];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[310];
 Esclave_3.ActiverComposant(true);
...
top.document.getElementById("Update_TVA_Liste_des_T_V_A_0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[303];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[303].NewCle;
}

function Delete_TVA_Liste_des_T_V_A_0()
{
 if (TAB_GLOBAL_COMPO[303].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[303].Action_en_cours = DELETE;
...
function Update_TVA_Liste_des_T_V_A_0()
{
 ...
 TAB_COMPO_PPTES[303].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[303].NewCle = TAB_GLOBAL_COMPO[303].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[303].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[307];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[303].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[303].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[307];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[308];
...
top.document.getElementById("Update_TVA_Liste_des_T_V_A_0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[303].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 ...
 TAB_COMPO_PPTES[303].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[282].NewCle = getNewCle("contacttype");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[282].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[285];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[286];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[287];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[288];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[289];
 Esclave_4.ActiverComposant(true);
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[354].NewCle = getNewCle("typejournal");
/* On désactive le composant maitre */
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[264].NewCle = getNewCle("ville");
/* On désactive le composant maitre */
...
top.TAB_GLOBAL_COMPO[333]=Compo_Adhérence_Liste_des_adhérences0;
...
top.TAB_GLOBAL_COMPO[337]=Compo_Adhérence_Produit_1;
...
top.TAB_GLOBAL_COMPO[338]=Compo_Adhérence_Libellé_2;
...
top.TAB_GLOBAL_COMPO[339]=Compo_Adhérence_Réduction_3;
...
top.TAB_GLOBAL_COMPO[340]=Compo_Adhérence_En_cascade_4;
...
top.TAB_GLOBAL_COMPO[341]=Compo_Adhérence_Nature_du_lien_à_utiliser_pour_la_cascade_5;
...
top.TAB_GLOBAL_COMPO[342]=Compo_Adhérence_Indpt_Périodes_disponibles_6;
...
top.TAB_GLOBAL_COMPO[345]=Compo_Adhérence_Périodes_de_validité_7;
...
top.TAB_GLOBAL_COMPO[245]=Compo_Agents_Liste_des_agents0;
...
top.TAB_GLOBAL_COMPO[251]=Compo_Agents_Nom_1;
...
top.TAB_GLOBAL_COMPO[252]=Compo_Agents_Prénom_2;
...
top.TAB_GLOBAL_COMPO[253]=Compo_Agents_Initiales_3;
...
top.TAB_GLOBAL_COMPO[254]=Compo_Agents_En_activité_4;
...
top.TAB_GLOBAL_COMPO[255]=Compo_Agents_Rôle_5;
...
top.TAB_GLOBAL_COMPO[256]=Compo_Agents_Équipe_6;
...
top.TAB_GLOBAL_COMPO[257]=Compo_Agents_Téléphone_professionnel_7;
...
top.TAB_GLOBAL_COMPO[258]=Compo_Agents_Téléphone_portable_8;
...
top.TAB_GLOBAL_COMPO[259]=Compo_Agents_Adresse_e_mail_9;
...
top.TAB_GLOBAL_COMPO[260]=Compo_Agents_Commentaire_10;
...
top.TAB_GLOBAL_COMPO[290]=Compo_Cantons_Liste_des_cantons0;
...
top.TAB_GLOBAL_COMPO[293]=Compo_Cantons_Nom_1;
...
top.TAB_GLOBAL_COMPO[294]=Compo_Cantons_Villes_2;
...
top.TAB_GLOBAL_COMPO[270]=Compo_Codes_postaux_Liste_des_codes_postaux0;
...
top.TAB_GLOBAL_COMPO[274]=Compo_Codes_postaux_Code_postal_1;
...
top.TAB_GLOBAL_COMPO[275]=Compo_Codes_postaux_Bureau_distributeur_2;
...
top.TAB_GLOBAL_COMPO[276]=Compo_Codes_postaux_Indpt_Villes_disponibles_3;
...
top.TAB_GLOBAL_COMPO[279]=Compo_Codes_postaux_Villes_liées_au_code_postal_4;
...
top.TAB_GLOBAL_COMPO[229]=Compo_Profils_de_droits_Liste_des_profils_de_droits0;
...
top.TAB_GLOBAL_COMPO[231]=Compo_Profils_de_droits_Libellé_1;
...
top.TAB_GLOBAL_COMPO[232]=Compo_Profils_de_droits_Droits_2;
...
top.TAB_GLOBAL_COMPO[235]=Compo_Profils_de_droits_Module_3;
...
top.TAB_GLOBAL_COMPO[236]=Compo_Profils_de_droits_Lecture_4;
...
top.TAB_GLOBAL_COMPO[237]=Compo_Profils_de_droits_Ajout_5;
...
top.TAB_GLOBAL_COMPO[238]=Compo_Profils_de_droits_Modification_6;
...
top.TAB_GLOBAL_COMPO[239]=Compo_Profils_de_droits_Suppression_7;
...
top.TAB_GLOBAL_COMPO[213]=Compo_Employés_Liste_des_employés0;
...
top.TAB_GLOBAL_COMPO[217]=Compo_Employés_Agent_1;
...
top.TAB_GLOBAL_COMPO[218]=Compo_Employés_Login_2;
...
top.TAB_GLOBAL_COMPO[219]=Compo_Employés_Mot_de_passe_3;
...
top.TAB_GLOBAL_COMPO[220]=Compo_Employés_Administrateur__Peut_créer_d_autres_utilisateurs__4;
...
top.TAB_GLOBAL_COMPO[221]=Compo_Employés_Cet_employé_peut_effectuer_des_remises_de_chèques_5;
...
top.TAB_GLOBAL_COMPO[222]=Compo_Employés_Cet_employé_peut_facturer_ses_propres_devis_6;
...
top.TAB_GLOBAL_COMPO[223]=Compo_Employés_Cet_employé_peut_facturer_les_devis_de_son_service_7;
...
top.TAB_GLOBAL_COMPO[224]=Compo_Employés_Cet_employé_peut_facturer_tous_les_devis_de_la_société_8;
...
top.TAB_GLOBAL_COMPO[225]=Compo_Employés_Cet_employé_peut_modifier_les_informations_importantes_d_une_fiche__titre__nom__prénom_____9;
...
top.TAB_GLOBAL_COMPO[226]=Compo_Employés_Emploi_10;
...
top.TAB_GLOBAL_COMPO[227]=Compo_Employés_Accès_comptabilité_11;
...
top.TAB_GLOBAL_COMPO[228]=Compo_Employés_Profil_de_droits_12;
...
top.TAB_GLOBAL_COMPO[261]=Compo_Équipes_Liste_des_équipes0;
...
top.TAB_GLOBAL_COMPO[263]=Compo_Équipes_Nom_1;
...
top.TAB_GLOBAL_COMPO[240]=Compo_Groupe_de_tables_Liste_des_groupes_de_tables0;
...
top.TAB_GLOBAL_COMPO[243]=Compo_Groupe_de_tables_Libellé_1;
...
top.TAB_GLOBAL_COMPO[244]=Compo_Groupe_de_tables_Tables_2;
...
top.TAB_GLOBAL_COMPO[372]=Compo_Modèles_d_impressions_Liste_des_modèles_d_impressions0;
...
top.TAB_GLOBAL_COMPO[375]=Compo_Modèles_d_impressions_Libellé_1;
...
top.TAB_GLOBAL_COMPO[376]=Compo_Modèles_d_impressions_Nom_logique_2;
...
top.TAB_GLOBAL_COMPO[377]=Compo_Modèles_d_impressions_Modèle_3;
...
top.TAB_GLOBAL_COMPO[378]=Compo_Modèles_d_impressions_Modèle_utilisé_par_défaut_4;
...
top.TAB_GLOBAL_COMPO[379]=Compo_Modèles_d_impressions_Table_utilisée_5;
...
top.TAB_GLOBAL_COMPO[380]=Compo_Modèles_d_impressions_Sa_clé_6;
...
top.TAB_GLOBAL_COMPO[381]=Compo_Modèles_d_impressions_Son_champs_date_7;
...
top.TAB_GLOBAL_COMPO[382]=Compo_Impressions_Liste_des_modèles_d_impressions0;
...
top.TAB_GLOBAL_COMPO[385]=Compo_Impressions_Société_1;
...
top.TAB_GLOBAL_COMPO[386]=Compo_Impressions_Libellé_2;
...
top.TAB_GLOBAL_COMPO[387]=Compo_Impressions_Nom_logique_3;
...
top.TAB_GLOBAL_COMPO[388]=Compo_Impressions_Modèle_4;
...
top.TAB_GLOBAL_COMPO[389]=Compo_Impressions_Modèle_utilisé_par_défaut_5;
...
top.TAB_GLOBAL_COMPO[390]=Compo_Impressions_Table_utilisée_6;
...
top.TAB_GLOBAL_COMPO[391]=Compo_Impressions_Sa_clé_7;
...
top.TAB_GLOBAL_COMPO[392]=Compo_Impressions_Son_champs_date_8;
...
top.TAB_GLOBAL_COMPO[360]=Compo_Modèles_Liste_des_modèles0;
...
top.TAB_GLOBAL_COMPO[362]=Compo_Modèles_Libellé_1;
...
top.TAB_GLOBAL_COMPO[363]=Compo_Modèles_Lignes_du_modèle_2;
...
top.TAB_GLOBAL_COMPO[368]=Compo_Modèles_Produit_3;
...
top.TAB_GLOBAL_COMPO[369]=Compo_Modèles_Montant_HT_4;
...
top.TAB_GLOBAL_COMPO[370]=Compo_Modèles_Montant_TTC_5;
...
top.TAB_GLOBAL_COMPO[371]=Compo_Modèles_Quantité_6;
...
top.TAB_GLOBAL_COMPO[348]=Compo_Périodes_Liste_des_périodes0;
...
top.TAB_GLOBAL_COMPO[352]=Compo_Périodes_Du_1;
...
top.TAB_GLOBAL_COMPO[353]=Compo_Périodes_Au_2;
...
top.TAB_GLOBAL_COMPO[357]=Compo_Préfixes_Liste_des_préfixes0;
...
top.TAB_GLOBAL_COMPO[359]=Compo_Préfixes_Nom_1;
...
top.TAB_GLOBAL_COMPO[311]=Compo_Produits_Liste_des_produits0;
...
top.TAB_GLOBAL_COMPO[314]=Compo_Produits_Libellé__en_interne__1;
...
top.TAB_GLOBAL_COMPO[315]=Compo_Produits_Titre__pour_les_impressions__2;
...
top.TAB_GLOBAL_COMPO[316]=Compo_Produits_Journal_comptable_3;
...
top.TAB_GLOBAL_COMPO[317]=Compo_Produits_Actif_4;
...
top.TAB_GLOBAL_COMPO[318]=Compo_Produits_Produit_non_quantifiable__Quantité_1__5;
...
top.TAB_GLOBAL_COMPO[319]=Compo_Produits_Soumis_à_de_potentielles_réductions_6;
...
top.TAB_GLOBAL_COMPO[320]=Compo_Produits_Prix_7;
...
top.TAB_GLOBAL_COMPO[325]=Compo_Produits_Tarif_H_T__8;
...
top.TAB_GLOBAL_COMPO[326]=Compo_Produits_Tarif_T_T_C__9;
...
top.TAB_GLOBAL_COMPO[327]=Compo_Produits_T_V_A__10;
...
top.TAB_GLOBAL_COMPO[328]=Compo_Produits_Comptes_généraux_11;
...
top.TAB_GLOBAL_COMPO[331]=Compo_Produits_Compte_12;
...
top.TAB_GLOBAL_COMPO[332]=Compo_Produits_Actif_13;
...
top.TAB_GLOBAL_COMPO[296]=Compo_Responsabilités_Responsabilités0;
...
top.TAB_GLOBAL_COMPO[300]=Compo_Responsabilités_Code_1;
...
top.TAB_GLOBAL_COMPO[301]=Compo_Responsabilités_Nom_2;
...
top.TAB_GLOBAL_COMPO[302]=Compo_Responsabilités_Famille_3;
...
top.TAB_GLOBAL_COMPO[207]=Compo_Services_Nom_1;
...
top.TAB_GLOBAL_COMPO[208]=Compo_Services_Agent_responsable_2;
...
top.TAB_GLOBAL_COMPO[209]=Compo_Services_Employés_3;
...
top.TAB_GLOBAL_COMPO[303]=Compo_TVA_Liste_des_T_V_A_0;
...
Compo_TVA_Taux_1.GenererXUL(top.document.getElementById("TVA_Liste_des_T_V_A_0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 307*/
top.TAB_GLOBAL_COMPO[307]=Compo_TVA_Taux_1;
...
top.TAB_GLOBAL_COMPO[308]=Compo_TVA_Code_2;
...
top.TAB_GLOBAL_COMPO[309]=Compo_TVA_Compte_général_3;
...
top.TAB_GLOBAL_COMPO[310]=Compo_TVA_Actif_4;
...
top.TAB_GLOBAL_COMPO[282]=Compo_Types_de_contacts_Liste_des_types_de_contacts0;
...
top.TAB_GLOBAL_COMPO[285]=Compo_Types_de_contacts_Nom_1;
...
top.TAB_GLOBAL_COMPO[286]=Compo_Types_de_contacts_Code_2;
...
top.TAB_GLOBAL_COMPO[287]=Compo_Types_de_contacts_Peut_être_un_numéro_3;
...
top.TAB_GLOBAL_COMPO[288]=Compo_Types_de_contacts_Peut_être_un_e_mail_4;
...
top.TAB_GLOBAL_COMPO[289]=Compo_Types_de_contacts_Peut_être_une_adresse_web__URL__5;
...
top.TAB_GLOBAL_COMPO[354]=Compo_Types_de_journaux_Liste_des_types_de_journaux0;
...
top.TAB_GLOBAL_COMPO[356]=Compo_Types_de_journaux_Libellé_1;
...
top.TAB_GLOBAL_COMPO[264]=Compo_Villes_Liste_des_villes0;
...
top.TAB_GLOBAL_COMPO[268]=Compo_Villes_Nom_1;
...
top.TAB_GLOBAL_COMPO[269]=Compo_Villes_Canton_2;
...
Filtre_Dep_Agents_0.setComposant(TAB_GLOBAL_COMPO[245],null);
Filtre_Dep_Agents_1.setComposant(TAB_GLOBAL_COMPO[245],null);
Filtre_Dep_Cantons_0.setComposant(TAB_GLOBAL_COMPO[290],null);
   /* ARBRE DU DESSUS */
...
Filtre_Dep_Profils_de_droits_0.setComposant(TAB_GLOBAL_COMPO[229],null);
Filtre_DepFor_Employés_0.setComposant(TAB_GLOBAL_COMPO[213],null);
Filtre_Dep_Équipes_0.setComposant(TAB_GLOBAL_COMPO[261],null);
Filtre_Dep_Groupe_de_tables_0.setComposant(TAB_GLOBAL_COMPO[240],null);
   /* ARBRE DU DESSUS */
...
Filtre_Dep_Périodes_0.setComposant(TAB_GLOBAL_COMPO[348],null);
Filtre_Dep_Produits_0.setComposant(TAB_GLOBAL_COMPO[311],null);
Filtre_Dep_Produits_1.setComposant(TAB_GLOBAL_COMPO[311],null);
...
Filtre_Dep_TVA_0.setComposant(TAB_GLOBAL_COMPO[303],null);
...
Filtre_Dep_Villes_0.setComposant(TAB_GLOBAL_COMPO[264],null);
 if(ALeDroit(5,"acces"))
 {
...
var Composant_0 = TAB_GLOBAL_COMPO[333];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
var Composant_6 = TAB_GLOBAL_COMPO[342];
if (Composant_6!=null){
...
var Composant_3 = TAB_GLOBAL_COMPO[276];
if (Composant_3!=null){
...
var Composant_0 = TAB_GLOBAL_COMPO[229];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[213];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[261];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[240];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[372];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[360];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[357];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[311];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[303];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
