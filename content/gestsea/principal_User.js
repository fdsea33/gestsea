...
*/
 ...
 if (!ValiderChampsType(Table,"de_libelle",TAB_GLOBAL_COMPO[107],de_libelle))
         return -1;
 var ad_numero=GetValAt(108);
 if (ad_numero=="-1")
    ad_numero="null";
 if (!ValiderChampsObligatoire(Table,"ad_numero",TAB_GLOBAL_COMPO[108],ad_numero,true))
         return -1;
 var em_numero=GetValAt(109);
 if (em_numero=="-1")
    em_numero="null";
 if (!ValiderChampsObligatoire(Table,"em_numero",TAB_GLOBAL_COMPO[109],em_numero,true))
         return -1;
...
*/
 ...
 if (!ValiderChampsType(Table,"de_numero",TAB_GLOBAL_COMPO[133],de_numero))
         return -1;
 var ad_numero=GetValAt(134);
 if (ad_numero=="-1")
    ad_numero="null";
 if (!ValiderChampsObligatoire(Table,"ad_numero",TAB_GLOBAL_COMPO[134],ad_numero,true))
         return -1;
 var fa_numero=GetValAt(135);
 if (!ValiderChampsObligatoire(Table,"fa_numero",TAB_GLOBAL_COMPO[135],fa_numero,false))
         return -1;
 if (!ValiderChampsType(Table,"fa_numero",TAB_GLOBAL_COMPO[135],fa_numero))
         return -1;
 var Req="insert into "+Table+" ";
var TabInsertionEnPlus=new Array();
var Asso11=false;
...
*/
 ...
 var CleMaitre = TAB_COMPO_PPTES[144].NewCle;
 var NomCleMaitre = DePrefixerChamp(Compo_Maitre.getCle());
 /* COMPOSANT LISTE AVEC JOINTURE SIMPLE */
