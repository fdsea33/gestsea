...
*/
 ...
 var zt_numero=GetValAt(694);
 if (zt_numero=="-1")
    zt_numero="null";
 if (!ValiderChampsObligatoire(Table,"zt_numero",TAB_GLOBAL_COMPO[694],zt_numero,true))
         return -1;
 var zs_numero=GetValAt(695);
 if (zs_numero=="-1")
    zs_numero="null";
 if (!ValiderChampsObligatoire(Table,"zs_numero",TAB_GLOBAL_COMPO[695],zs_numero,true))
         return -1;
 var zl_numero=GetValAt(696);
 if (zl_numero=="-1")
    zl_numero="null";
 if (!ValiderChampsObligatoire(Table,"zl_numero",TAB_GLOBAL_COMPO[696],zl_numero,true))
         return -1;
 var za_duree=GetValAt(697);
 if (!ValiderChampsObligatoire(Table,"za_duree",TAB_GLOBAL_COMPO[697],za_duree,false))
         return -1;
 if (!ValiderChampsType(Table,"za_duree",TAB_GLOBAL_COMPO[697],za_duree))
         return -1;
 var za_date=GetValAt(698);
 if (!ValiderChampsObligatoire(Table,"za_date",TAB_GLOBAL_COMPO[698],za_date,false))
         return -1;
 if (!ValiderChampsType(Table,"za_date",TAB_GLOBAL_COMPO[698],za_date))
         return -1;
 var za_heuredebut=GetValAt(699);
 if (!ValiderChampsObligatoire(Table,"za_heuredebut",TAB_GLOBAL_COMPO[699],za_heuredebut,false))
         return -1;
 if (!ValiderChampsType(Table,"za_heuredebut",TAB_GLOBAL_COMPO[699],za_heuredebut))
         return -1;
 var za_heurefin=GetValAt(700);
 if (!ValiderChampsObligatoire(Table,"za_heurefin",TAB_GLOBAL_COMPO[700],za_heurefin,false))
         return -1;
 if (!ValiderChampsType(Table,"za_heurefin",TAB_GLOBAL_COMPO[700],za_heurefin))
         return -1;
 var za_qui=GetValAt(701);
 if (!ValiderChampsObligatoire(Table,"za_qui",TAB_GLOBAL_COMPO[701],za_qui,false))
         return -1;
 if (!ValiderChampsType(Table,"za_qui",TAB_GLOBAL_COMPO[701],za_qui))
         return -1;
 var za_champ=GetValAt(702);
 if (!ValiderChampsObligatoire(Table,"za_champ",TAB_GLOBAL_COMPO[702],za_champ,false))
         return -1;
 if (!ValiderChampsType(Table,"za_champ",TAB_GLOBAL_COMPO[702],za_champ))
         return -1;
 var zg_numero=GetValAt(703);
 if (zg_numero=="-1")
    zg_numero="null";
 if (!ValiderChampsObligatoire(Table,"zg_numero",TAB_GLOBAL_COMPO[703],zg_numero,true))
         return -1;
...
*/
 ...
 var Table="tache";
 var CleMaitre = TAB_COMPO_PPTES[704].NewCle;
 var NomCleMaitre = DePrefixerChamp(Compo_Maitre.getCle());
 var zt_libelle=GetValAt(706);
 if (!ValiderChampsObligatoire(Table,"zt_libelle",TAB_GLOBAL_COMPO[706],zt_libelle,false))
         return -1;
 if (!ValiderChampsType(Table,"zt_libelle",TAB_GLOBAL_COMPO[706],zt_libelle))
         return -1;
 var zt_phrase=GetValAt(707);
 if (!ValiderChampsObligatoire(Table,"zt_phrase",TAB_GLOBAL_COMPO[707],zt_phrase,false))
         return -1;
 if (!ValiderChampsType(Table,"zt_phrase",TAB_GLOBAL_COMPO[707],zt_phrase))
         return -1;
 var zt_notes=GetValAt(708);
 if (!ValiderChampsObligatoire(Table,"zt_notes",TAB_GLOBAL_COMPO[708],zt_notes,false))
         return -1;
 if (!ValiderChampsType(Table,"zt_notes",TAB_GLOBAL_COMPO[708],zt_notes))
         return -1;
 var Req="insert into "+Table+" ";
var TabInsertionEnPlus=new Array();
...
*/
 ...
 var NomCleMaitre = DePrefixerChamp(Compo_Maitre.getCle());
 var zu_libelle=GetValAt(715);
 if (!ValiderChampsObligatoire(Table,"zu_libelle",TAB_GLOBAL_COMPO[715],zu_libelle,false))
         return -1;
 if (!ValiderChampsType(Table,"zu_libelle",TAB_GLOBAL_COMPO[715],zu_libelle))
         return -1;
 var zu_notes=GetValAt(716);
 if (!ValiderChampsObligatoire(Table,"zu_notes",TAB_GLOBAL_COMPO[716],zu_notes,false))
         return -1;
 if (!ValiderChampsType(Table,"zu_notes",TAB_GLOBAL_COMPO[716],zu_notes))
         return -1;
 var Req="insert into "+Table+" ";
var TabInsertionEnPlus=new Array();
...
*/
 ...
 var zs_libelle=GetValAt(719);
 if (!ValiderChampsObligatoire(Table,"zs_libelle",TAB_GLOBAL_COMPO[719],zs_libelle,false))
         return -1;
 if (!ValiderChampsType(Table,"zs_libelle",TAB_GLOBAL_COMPO[719],zs_libelle))
         return -1;
 var zs_notes=GetValAt(720);
 if (!ValiderChampsObligatoire(Table,"zs_notes",TAB_GLOBAL_COMPO[720],zs_notes,false))
         return -1;
 if (!ValiderChampsType(Table,"zs_notes",TAB_GLOBAL_COMPO[720],zs_notes))
         return -1;
 var Req="insert into "+Table+" ";
var TabInsertionEnPlus=new Array();
 Req+="("+NomCleMaitre+",zu_numero,zs_libelle,zs_notes"+(TabInsertionEnPlus.length!=0?","+TabInsertionEnPlus[0]:"")+")";
 Req+=" values ("+CleMaitre+","+TAB_COMPO_PPTES[713].NewCle+","+(zs_libelle=="" ? "null" : "'"+ValiderChaine(zs_libelle)+"'" )+","+(zs_notes=="" ? "null" : "'"+ValiderChaine(zs_notes)+"'" )+""+(TabInsertionEnPlus.length!=0?","+TabInsertionEnPlus[1]:"")+")";
...
*/
 ...
 var NomCleMaitre = DePrefixerChamp(Compo_Maitre.getCle());
 var zg_libelle=GetValAt(723);
 if (!ValiderChampsObligatoire(Table,"zg_libelle",TAB_GLOBAL_COMPO[723],zg_libelle,false))
         return -1;
 if (!ValiderChampsType(Table,"zg_libelle",TAB_GLOBAL_COMPO[723],zg_libelle))
         return -1;
 var zg_notes=GetValAt(724);
 if (!ValiderChampsObligatoire(Table,"zg_notes",TAB_GLOBAL_COMPO[724],zg_notes,false))
         return -1;
 if (!ValiderChampsType(Table,"zg_notes",TAB_GLOBAL_COMPO[724],zg_notes))
         return -1;
 var Req="insert into "+Table+" ";
var TabInsertionEnPlus=new Array();
...
*/
 ...
 var NomCleMaitre = DePrefixerChamp(Compo_Maitre.getCle());
 var zl_libelle=GetValAt(711);
 if (!ValiderChampsObligatoire(Table,"zl_libelle",TAB_GLOBAL_COMPO[711],zl_libelle,false))
         return -1;
 if (!ValiderChampsType(Table,"zl_libelle",TAB_GLOBAL_COMPO[711],zl_libelle))
         return -1;
 var zl_notes=GetValAt(712);
 if (!ValiderChampsObligatoire(Table,"zl_notes",TAB_GLOBAL_COMPO[712],zl_notes,false))
         return -1;
 if (!ValiderChampsType(Table,"zl_notes",TAB_GLOBAL_COMPO[712],zl_notes))
         return -1;
 var Req="insert into "+Table+" ";
var TabInsertionEnPlus=new Array();
