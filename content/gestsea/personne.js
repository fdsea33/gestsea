...
var TAB_COMPO_PPTES = new Array(632);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[613].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[613].NewCle = getNewCle("table_personne");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[613].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 ...
 var Esclave_6=TAB_GLOBAL_COMPO[624];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[625];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[629];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[613];
...
return TAB_COMPO_PPTES[613].NewCle;
}

function Delete_Personnes_Liste_des_personnes0()
{
 if (TAB_GLOBAL_COMPO[613].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[613].Action_en_cours = DELETE;
...
function Update_Personnes_Liste_des_personnes0()
{
 ...
 TAB_COMPO_PPTES[613].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[613].NewCle = TAB_GLOBAL_COMPO[613].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[613].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[618];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[613].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[613].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[618];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[613].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[613].Action_en_cours = null;
 return NewCle;
}
...
top.TAB_GLOBAL_COMPO[613]=Compo_Personnes_Liste_des_personnes0;
...
top.TAB_GLOBAL_COMPO[618]=Compo_Personnes_Numéro_1;
...
top.TAB_GLOBAL_COMPO[619]=Compo_Personnes_Titre_ou_F_J__2;
...
top.TAB_GLOBAL_COMPO[620]=Compo_Personnes_Nom_ou_D_S__3;
...
top.TAB_GLOBAL_COMPO[621]=Compo_Personnes_Prénom_4;
...
top.TAB_GLOBAL_COMPO[622]=Compo_Personnes_N_TVA_intrac__5;
...
top.TAB_GLOBAL_COMPO[623]=Compo_Personnes_Né_e__le_6;
...
top.TAB_GLOBAL_COMPO[624]=Compo_Personnes_La_personne_est_active__et_peut_être_contactée__7;
...
top.TAB_GLOBAL_COMPO[625]=Compo_Personnes_Adhésions_8;
...
top.TAB_GLOBAL_COMPO[629]=Compo_Personnes_Observations_9;
...
ConstruireOngletEstLie("tabbox_Personnes_Liste_des_personnes0",613);
