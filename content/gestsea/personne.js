...
var TAB_COMPO_PPTES = new Array(1505);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[1486].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1486].NewCle = getNewCle("table_personne");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1486].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1491];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1492];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[1493];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[1494];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[1495];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[1496];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[1497];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[1498];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[1502];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1486];
...
return TAB_COMPO_PPTES[1486].NewCle;
}

function Delete_Personnes_Liste_des_personnes0()
{
 if (TAB_GLOBAL_COMPO[1486].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[1486].Action_en_cours = DELETE;
...
function Update_Personnes_Liste_des_personnes0()
{
 ...
 TAB_COMPO_PPTES[1486].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1486].NewCle = TAB_GLOBAL_COMPO[1486].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1486].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1491];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1486].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1486].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1491];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1486].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1486].Action_en_cours = null;
 return NewCle;
}
...
Compo_Personnes_Liste_des_personnes0.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0"));
	...
	/* On l'ajoute au tableau global à l'indice 1486*/
top.TAB_GLOBAL_COMPO[1486]=Compo_Personnes_Liste_des_personnes0;
...
Compo_Personnes_Numéro_1.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1491*/
top.TAB_GLOBAL_COMPO[1491]=Compo_Personnes_Numéro_1;
...
Compo_Personnes_Titre_ou_F_J__2.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1492*/
top.TAB_GLOBAL_COMPO[1492]=Compo_Personnes_Titre_ou_F_J__2;
...
Compo_Personnes_Nom_ou_D_S__3.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1493*/
top.TAB_GLOBAL_COMPO[1493]=Compo_Personnes_Nom_ou_D_S__3;
...
Compo_Personnes_Prénom_4.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1494*/
top.TAB_GLOBAL_COMPO[1494]=Compo_Personnes_Prénom_4;
...
Compo_Personnes_N_TVA_intrac__5.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1495*/
top.TAB_GLOBAL_COMPO[1495]=Compo_Personnes_N_TVA_intrac__5;
...
Compo_Personnes_Né_e__le_6.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1496*/
top.TAB_GLOBAL_COMPO[1496]=Compo_Personnes_Né_e__le_6;
...
Compo_Personnes_La_personne_est_active__et_peut_être_contactée__7.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1497*/
top.TAB_GLOBAL_COMPO[1497]=Compo_Personnes_La_personne_est_active__et_peut_être_contactée__7;
...
Compo_Personnes_Adhésions_8.GenererXUL(top.document.getElementById("Personnes_Adhésions_8"));
	...
	/* On l'ajoute au tableau global à l'indice 1498*/
top.TAB_GLOBAL_COMPO[1498]=Compo_Personnes_Adhésions_8;
...
Compo_Personnes_Observations_9.GenererXUL(top.document.getElementById("Personnes_Observations_9"));
	...
	/* On l'ajoute au tableau global à l'indice 1502*/
top.TAB_GLOBAL_COMPO[1502]=Compo_Personnes_Observations_9;
 if(ALeDroit(5,"table_personne"))
 {
/* On refresh les composants non dépendents de l'onget Personnes*/
var Composant_0 = TAB_GLOBAL_COMPO[1486];
if (Composant_0!=null){
...
ConstruireOngletEstLie("tabbox_Personnes_Liste_des_personnes0",1486);
