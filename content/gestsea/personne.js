...
{
 TAB_COMPO_PPTES[639].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[639].NewCle = getNewCle("table_personne");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[639].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[644];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[645];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[646];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[647];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[648];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[649];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[650];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[651];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[655];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[639];
...
return TAB_COMPO_PPTES[639].NewCle;
}

function Delete_Personnes_Liste_des_personnes0()
{
 if (TAB_GLOBAL_COMPO[639].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[639].Action_en_cours = DELETE;
...
function Update_Personnes_Liste_des_personnes0()
{
 ...
 TAB_COMPO_PPTES[639].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[639].NewCle = TAB_GLOBAL_COMPO[639].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[639].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[644];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[639].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[639].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[644];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[639].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[639].Action_en_cours = null;
 return NewCle;
}
...
top.TAB_GLOBAL_COMPO[639]=Compo_Personnes_Liste_des_personnes0;
...
top.TAB_GLOBAL_COMPO[644]=Compo_Personnes_Numéro_1;
...
top.TAB_GLOBAL_COMPO[645]=Compo_Personnes_Titre_ou_F_J__2;
...
top.TAB_GLOBAL_COMPO[646]=Compo_Personnes_Nom_ou_D_S__3;
...
top.TAB_GLOBAL_COMPO[647]=Compo_Personnes_Prénom_4;
...
top.TAB_GLOBAL_COMPO[648]=Compo_Personnes_N_TVA_intrac__5;
...
top.TAB_GLOBAL_COMPO[649]=Compo_Personnes_Né_e__le_6;
...
top.TAB_GLOBAL_COMPO[650]=Compo_Personnes_La_personne_est_active__et_peut_être_contactée__7;
...
top.TAB_GLOBAL_COMPO[651]=Compo_Personnes_Adhésions_8;
...
top.TAB_GLOBAL_COMPO[655]=Compo_Personnes_Observations_9;
 if(ALeDroit(5,"table_personne"))
 {
/* On refresh les composants non dépendents de l'onget Personnes*/
var Composant_0 = TAB_GLOBAL_COMPO[639];
if (Composant_0!=null){
...
ConstruireOngletEstLie("tabbox_Personnes_Liste_des_personnes0",639);
