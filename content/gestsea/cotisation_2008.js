...
//    alert(query);
  ...
  //      num_reglement = elem("wg-reglement-menulist").selectedItem.value;
    ...
    //    if (elem("wg-reglement-menulist").selectedIndex>0)
      ...
      query="INSERT INTO cotisation (cs_numero, pe_numero, cs_annee, cs_detail, cs_standard, cs_nature, cs_societe) VALUES ("+num_cotisation+","+num_personne+", "+annee+", '"+bulletin+"', true, 'standard',"+current_societe()+");";
      pgsql_update(query);
