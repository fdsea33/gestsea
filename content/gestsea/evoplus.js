...
var TAB_COMPO_PPTES = new Array(1615);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[1579].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1579].NewCle = getNewCle("table_evoplus");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1579].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1584];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1585];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[1586];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[1587];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[1588];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[1589];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[1590];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[1591];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[1592];
 Esclave_8.ActiverComposant(true);
 var Esclave_9=TAB_GLOBAL_COMPO[1593];
 Esclave_9.ActiverComposant(true);
 var Esclave_10=TAB_GLOBAL_COMPO[1594];
 Esclave_10.ActiverComposant(true);
 var Esclave_11=TAB_GLOBAL_COMPO[1595];
 Esclave_11.ActiverComposant(true);
 var Esclave_12=TAB_GLOBAL_COMPO[1596];
 Esclave_12.ActiverComposant(true);
 var Esclave_13=TAB_GLOBAL_COMPO[1597];
 Esclave_13.ActiverComposant(true);
 var Esclave_14=TAB_GLOBAL_COMPO[1598];
 Esclave_14.ActiverComposant(true);
 var Esclave_15=TAB_GLOBAL_COMPO[1599];
 Esclave_15.ActiverComposant(true);
 var Esclave_16=TAB_GLOBAL_COMPO[1600];
 Esclave_16.ActiverComposant(true);
 var Esclave_17=TAB_GLOBAL_COMPO[1601];
 Esclave_17.ActiverComposant(true);
 var Esclave_18=TAB_GLOBAL_COMPO[1602];
 Esclave_18.ActiverComposant(true);
 var Esclave_19=TAB_GLOBAL_COMPO[1603];
 Esclave_19.ActiverComposant(true);
 var Esclave_20=TAB_GLOBAL_COMPO[1604];
 Esclave_20.ActiverComposant(true);
 var Esclave_21=TAB_GLOBAL_COMPO[1605];
 Esclave_21.ActiverComposant(true);
 var Esclave_22=TAB_GLOBAL_COMPO[1606];
 Esclave_22.ActiverComposant(true);
 var Esclave_23=TAB_GLOBAL_COMPO[1607];
 Esclave_23.ActiverComposant(true);
 var Esclave_24=TAB_GLOBAL_COMPO[1608];
 Esclave_24.ActiverComposant(true);
 var Esclave_25=TAB_GLOBAL_COMPO[1609];
 Esclave_25.ActiverComposant(true);
 var Esclave_26=TAB_GLOBAL_COMPO[1610];
 Esclave_26.ActiverComposant(true);
 var Esclave_27=TAB_GLOBAL_COMPO[1611];
 Esclave_27.ActiverComposant(true);
 var Esclave_28=TAB_GLOBAL_COMPO[1612];
 Esclave_28.ActiverComposant(true);
 var Esclave_29=TAB_GLOBAL_COMPO[1613];
 Esclave_29.ActiverComposant(true);
 var Esclave_30=TAB_GLOBAL_COMPO[1614];
...
top.document.getElementById("Update_Evoplus_Liste_des_evoplus0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1579];
...
return TAB_COMPO_PPTES[1579].NewCle;
}

function Delete_Evoplus_Liste_des_evoplus0()
{
 if (TAB_GLOBAL_COMPO[1579].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[1579].Action_en_cours = DELETE;
...
function Update_Evoplus_Liste_des_evoplus0()
{
 ...
 TAB_COMPO_PPTES[1579].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1579].NewCle = TAB_GLOBAL_COMPO[1579].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1579].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1584];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1579].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1579].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1584];
...
top.document.getElementById("Update_Evoplus_Liste_des_evoplus0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1579].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1579].Action_en_cours = null;
 return NewCle;
}
...
Compo_Evoplus_Liste_des_evoplus0.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0"));
	...
	/* On l'ajoute au tableau global à l'indice 1579*/
top.TAB_GLOBAL_COMPO[1579]=Compo_Evoplus_Liste_des_evoplus0;
...
Compo_Evoplus_Source_1.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1584*/
top.TAB_GLOBAL_COMPO[1584]=Compo_Evoplus_Source_1;
...
Compo_Evoplus_N_Fiche_2.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1585*/
top.TAB_GLOBAL_COMPO[1585]=Compo_Evoplus_N_Fiche_2;
...
Compo_Evoplus_Titre_3.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1586*/
top.TAB_GLOBAL_COMPO[1586]=Compo_Evoplus_Titre_3;
...
Compo_Evoplus_Nom_Prénom_4.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1587*/
top.TAB_GLOBAL_COMPO[1587]=Compo_Evoplus_Nom_Prénom_4;
...
Compo_Evoplus_Complément_5.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1588*/
top.TAB_GLOBAL_COMPO[1588]=Compo_Evoplus_Complément_5;
...
Compo_Evoplus_Ad1_6.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1589*/
top.TAB_GLOBAL_COMPO[1589]=Compo_Evoplus_Ad1_6;
...
Compo_Evoplus_Ad2_7.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1590*/
top.TAB_GLOBAL_COMPO[1590]=Compo_Evoplus_Ad2_7;
...
Compo_Evoplus_Ad3_8.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1591*/
top.TAB_GLOBAL_COMPO[1591]=Compo_Evoplus_Ad3_8;
...
Compo_Evoplus_CP_9.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1592*/
top.TAB_GLOBAL_COMPO[1592]=Compo_Evoplus_CP_9;
...
Compo_Evoplus_Ville_10.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1593*/
top.TAB_GLOBAL_COMPO[1593]=Compo_Evoplus_Ville_10;
...
Compo_Evoplus_né_le_11.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1594*/
top.TAB_GLOBAL_COMPO[1594]=Compo_Evoplus_né_le_11;
...
Compo_Evoplus_tel_12.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1595*/
top.TAB_GLOBAL_COMPO[1595]=Compo_Evoplus_tel_12;
...
Compo_Evoplus_fax_13.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1596*/
top.TAB_GLOBAL_COMPO[1596]=Compo_Evoplus_fax_13;
...
Compo_Evoplus_mob_14.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1597*/
top.TAB_GLOBAL_COMPO[1597]=Compo_Evoplus_mob_14;
...
Compo_Evoplus_Qualification_15.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1598*/
top.TAB_GLOBAL_COMPO[1598]=Compo_Evoplus_Qualification_15;
...
Compo_Evoplus_Fortait__montant__16.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1599*/
top.TAB_GLOBAL_COMPO[1599]=Compo_Evoplus_Fortait__montant__16;
...
Compo_Evoplus_Productions_17.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1600*/
top.TAB_GLOBAL_COMPO[1600]=Compo_Evoplus_Productions_17;
...
Compo_Evoplus_Nb_d_hectares_18.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1601*/
top.TAB_GLOBAL_COMPO[1601]=Compo_Evoplus_Nb_d_hectares_18;
...
Compo_Evoplus_Nb_salariés_19.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1602*/
top.TAB_GLOBAL_COMPO[1602]=Compo_Evoplus_Nb_salariés_19;
...
Compo_Evoplus_SACEA_montant_20.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1603*/
top.TAB_GLOBAL_COMPO[1603]=Compo_Evoplus_SACEA_montant_20;
...
Compo_Evoplus_Nb_CM_21.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1604*/
top.TAB_GLOBAL_COMPO[1604]=Compo_Evoplus_Nb_CM_21;
...
Compo_Evoplus_CM_Montant_22.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1605*/
top.TAB_GLOBAL_COMPO[1605]=Compo_Evoplus_CM_Montant_22;
...
Compo_Evoplus_CM_Noms_23.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1606*/
top.TAB_GLOBAL_COMPO[1606]=Compo_Evoplus_CM_Noms_23;
...
Compo_Evoplus_Option_1_24.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1607*/
top.TAB_GLOBAL_COMPO[1607]=Compo_Evoplus_Option_1_24;
...
Compo_Evoplus_Option_2_25.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1608*/
top.TAB_GLOBAL_COMPO[1608]=Compo_Evoplus_Option_2_25;
...
Compo_Evoplus_Option_3_26.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1609*/
top.TAB_GLOBAL_COMPO[1609]=Compo_Evoplus_Option_3_26;
...
Compo_Evoplus_Option_4_27.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1610*/
top.TAB_GLOBAL_COMPO[1610]=Compo_Evoplus_Option_4_27;
...
Compo_Evoplus_Option_retenue_28.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1611*/
top.TAB_GLOBAL_COMPO[1611]=Compo_Evoplus_Option_retenue_28;
...
Compo_Evoplus_Cout_retenu_29.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1612*/
top.TAB_GLOBAL_COMPO[1612]=Compo_Evoplus_Cout_retenu_29;
...
Compo_Evoplus_Statut_30.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1613*/
top.TAB_GLOBAL_COMPO[1613]=Compo_Evoplus_Statut_30;
...
Compo_Evoplus_Remarque_31.GenererXUL(top.document.getElementById("Evoplus_Liste_des_evoplus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1614*/
top.TAB_GLOBAL_COMPO[1614]=Compo_Evoplus_Remarque_31;
 if(ALeDroit(5,"table_evoplus"))
 {
/* On refresh les composants non dépendents de l'onget Evoplus*/
var Composant_0 = TAB_GLOBAL_COMPO[1579];
if (Composant_0!=null){
