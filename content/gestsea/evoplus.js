...
var TAB_COMPO_PPTES = new Array(770);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[733].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[733].NewCle = getNewCle("table_evoplus");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[733].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[738];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[739];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[740];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[741];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[742];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[743];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[744];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[745];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[746];
 Esclave_8.ActiverComposant(true);
 var Esclave_9=TAB_GLOBAL_COMPO[747];
 Esclave_9.ActiverComposant(true);
 var Esclave_10=TAB_GLOBAL_COMPO[748];
 Esclave_10.ActiverComposant(true);
 var Esclave_11=TAB_GLOBAL_COMPO[749];
 Esclave_11.ActiverComposant(true);
 var Esclave_12=TAB_GLOBAL_COMPO[750];
 Esclave_12.ActiverComposant(true);
 var Esclave_13=TAB_GLOBAL_COMPO[751];
 Esclave_13.ActiverComposant(true);
 var Esclave_14=TAB_GLOBAL_COMPO[752];
 Esclave_14.ActiverComposant(true);
 var Esclave_15=TAB_GLOBAL_COMPO[753];
 Esclave_15.ActiverComposant(true);
 var Esclave_16=TAB_GLOBAL_COMPO[754];
 Esclave_16.ActiverComposant(true);
 var Esclave_17=TAB_GLOBAL_COMPO[755];
 Esclave_17.ActiverComposant(true);
 var Esclave_18=TAB_GLOBAL_COMPO[756];
 Esclave_18.ActiverComposant(true);
 var Esclave_19=TAB_GLOBAL_COMPO[757];
 Esclave_19.ActiverComposant(true);
 var Esclave_20=TAB_GLOBAL_COMPO[758];
 Esclave_20.ActiverComposant(true);
 var Esclave_21=TAB_GLOBAL_COMPO[759];
 Esclave_21.ActiverComposant(true);
 var Esclave_22=TAB_GLOBAL_COMPO[760];
 Esclave_22.ActiverComposant(true);
 var Esclave_23=TAB_GLOBAL_COMPO[761];
 Esclave_23.ActiverComposant(true);
 var Esclave_24=TAB_GLOBAL_COMPO[762];
 Esclave_24.ActiverComposant(true);
 var Esclave_25=TAB_GLOBAL_COMPO[763];
 Esclave_25.ActiverComposant(true);
 var Esclave_26=TAB_GLOBAL_COMPO[764];
 Esclave_26.ActiverComposant(true);
 var Esclave_27=TAB_GLOBAL_COMPO[765];
 Esclave_27.ActiverComposant(true);
 var Esclave_28=TAB_GLOBAL_COMPO[766];
 Esclave_28.ActiverComposant(true);
 var Esclave_29=TAB_GLOBAL_COMPO[767];
 Esclave_29.ActiverComposant(true);
 var Esclave_30=TAB_GLOBAL_COMPO[768];
 Esclave_30.ActiverComposant(true);
 var Esclave_31=TAB_GLOBAL_COMPO[769];
...
top.document.getElementById("Update_Evoplus_Liste_des_evoplus0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[733];
...
return TAB_COMPO_PPTES[733].NewCle;
}

function Delete_Evoplus_Liste_des_evoplus0()
{
 if (TAB_GLOBAL_COMPO[733].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[733].Action_en_cours = DELETE;
...
function Update_Evoplus_Liste_des_evoplus0()
{
 ...
 TAB_COMPO_PPTES[733].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[733].NewCle = TAB_GLOBAL_COMPO[733].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[733].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[738];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[733].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[733].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[738];
...
top.document.getElementById("Update_Evoplus_Liste_des_evoplus0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[733].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[733].Action_en_cours = null;
 return NewCle;
}
...
top.TAB_GLOBAL_COMPO[733]=Compo_Evoplus_Liste_des_evoplus0;
...
top.TAB_GLOBAL_COMPO[738]=Compo_Evoplus_N_Pers_1;
...
top.TAB_GLOBAL_COMPO[739]=Compo_Evoplus_Source_2;
...
top.TAB_GLOBAL_COMPO[740]=Compo_Evoplus_N_Fiche_3;
...
top.TAB_GLOBAL_COMPO[741]=Compo_Evoplus_Titre_4;
...
top.TAB_GLOBAL_COMPO[742]=Compo_Evoplus_Nom_Prénom_5;
...
top.TAB_GLOBAL_COMPO[743]=Compo_Evoplus_Complément_6;
...
top.TAB_GLOBAL_COMPO[744]=Compo_Evoplus_Ad1_7;
...
top.TAB_GLOBAL_COMPO[745]=Compo_Evoplus_Ad2_8;
...
top.TAB_GLOBAL_COMPO[746]=Compo_Evoplus_Ad3_9;
...
top.TAB_GLOBAL_COMPO[747]=Compo_Evoplus_CP_10;
...
top.TAB_GLOBAL_COMPO[748]=Compo_Evoplus_Ville_11;
...
top.TAB_GLOBAL_COMPO[749]=Compo_Evoplus_né_le_12;
...
top.TAB_GLOBAL_COMPO[750]=Compo_Evoplus_tel_13;
...
top.TAB_GLOBAL_COMPO[751]=Compo_Evoplus_fax_14;
...
top.TAB_GLOBAL_COMPO[752]=Compo_Evoplus_mob_15;
...
top.TAB_GLOBAL_COMPO[753]=Compo_Evoplus_Qualification_16;
...
top.TAB_GLOBAL_COMPO[754]=Compo_Evoplus_Fortait__montant__17;
...
top.TAB_GLOBAL_COMPO[755]=Compo_Evoplus_Productions_18;
...
top.TAB_GLOBAL_COMPO[756]=Compo_Evoplus_Nb_d_hectares_19;
...
top.TAB_GLOBAL_COMPO[757]=Compo_Evoplus_Nb_salariés_20;
...
top.TAB_GLOBAL_COMPO[758]=Compo_Evoplus_SACEA_montant_21;
...
top.TAB_GLOBAL_COMPO[759]=Compo_Evoplus_Nb_CM_22;
...
top.TAB_GLOBAL_COMPO[760]=Compo_Evoplus_CM_Montant_23;
...
top.TAB_GLOBAL_COMPO[761]=Compo_Evoplus_CM_Noms_24;
...
top.TAB_GLOBAL_COMPO[762]=Compo_Evoplus_Option_1_25;
...
top.TAB_GLOBAL_COMPO[763]=Compo_Evoplus_Option_2_26;
...
top.TAB_GLOBAL_COMPO[764]=Compo_Evoplus_Option_3_27;
...
top.TAB_GLOBAL_COMPO[765]=Compo_Evoplus_Option_4_28;
...
top.TAB_GLOBAL_COMPO[766]=Compo_Evoplus_Option_retenue_29;
...
top.TAB_GLOBAL_COMPO[767]=Compo_Evoplus_Cout_retenu_30;
...
top.TAB_GLOBAL_COMPO[768]=Compo_Evoplus_Statut_31;
...
top.TAB_GLOBAL_COMPO[769]=Compo_Evoplus_Remarque_32;
 if(ALeDroit(5,"table_evoplus"))
 {
/* On refresh les composants non dépendents de l'onget Evoplus*/
var Composant_0 = TAB_GLOBAL_COMPO[733];
if (Composant_0!=null){
