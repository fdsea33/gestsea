...
*/
 ...
 var pe_id=GetValAt(631);
 if (!ValiderChampsObligatoire(Table,"pe_id",TAB_GLOBAL_COMPO[631],pe_id,false))
         return -1;
 if (!ValiderChampsType(Table,"pe_id",TAB_GLOBAL_COMPO[631],pe_id))
         return -1;
 var np_numero=GetValAt(632);
 if (np_numero=="-1")
    np_numero="null";
 if (!ValiderChampsObligatoire(Table,"np_numero",TAB_GLOBAL_COMPO[632],np_numero,true))
         return -1;
 var pe_nom=GetValAt(633);
 if (!ValiderChampsObligatoire(Table,"pe_nom",TAB_GLOBAL_COMPO[633],pe_nom,false))
         return -1;
 if (!ValiderChampsType(Table,"pe_nom",TAB_GLOBAL_COMPO[633],pe_nom))
         return -1;
 var pe_prenom=GetValAt(634);
 if (!ValiderChampsObligatoire(Table,"pe_prenom",TAB_GLOBAL_COMPO[634],pe_prenom,false))
         return -1;
 if (!ValiderChampsType(Table,"pe_prenom",TAB_GLOBAL_COMPO[634],pe_prenom))
         return -1;
 var pe_numtvaic=GetValAt(635);
 if (!ValiderChampsObligatoire(Table,"pe_numtvaic",TAB_GLOBAL_COMPO[635],pe_numtvaic,false))
         return -1;
 if (!ValiderChampsType(Table,"pe_numtvaic",TAB_GLOBAL_COMPO[635],pe_numtvaic))
         return -1;
 var pe_naissance=GetValAt(636);
 if (!ValiderChampsObligatoire(Table,"pe_naissance",TAB_GLOBAL_COMPO[636],pe_naissance,false))
         return -1;
 if (!ValiderChampsType(Table,"pe_naissance",TAB_GLOBAL_COMPO[636],pe_naissance))
         return -1;
 var pe_actif=GetValAt(637);
 if (!ValiderChampsObligatoire(Table,"pe_actif",TAB_GLOBAL_COMPO[637],pe_actif,false))
         return -1;
 if (!ValiderChampsType(Table,"pe_actif",TAB_GLOBAL_COMPO[637],pe_actif))
         return -1;
