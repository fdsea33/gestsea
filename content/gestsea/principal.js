...
var TAB_COMPO_PPTES = new Array(606);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[387].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[387].NewCle = getNewCle("personne");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[387].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[390];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[391];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[392];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[393];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[394];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[395];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[396];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[397];
...
top.document.getElementById("Update_Personnes_Observations_9").disabled=false;
 var Esclave_8=TAB_GLOBAL_COMPO[404];
...
top.document.getElementById("Update_Personnes_Adresses_12").disabled=false;
 var Esclave_9=TAB_GLOBAL_COMPO[409];
...
top.document.getElementById("Update_Personnes_Contact_20").disabled=false;
 var Esclave_10=TAB_GLOBAL_COMPO[421];
...
top.document.getElementById("Update_Personnes_Tâches_23").disabled=false;
 var Esclave_11=TAB_GLOBAL_COMPO[426];
...
top.document.getElementById("Update_Personnes_Responsabilités_29").disabled=false;
 var Esclave_12=TAB_GLOBAL_COMPO[437];
...
top.document.getElementById("Update_Personnes_Attributs_35").disabled=false;
 var Esclave_13=TAB_GLOBAL_COMPO[449];
 ...
 var Esclave_16=TAB_GLOBAL_COMPO[469];
...
top.document.getElementById("Update_Personnes_Routages_42").disabled=false;
 var Esclave_17=TAB_GLOBAL_COMPO[475];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[387];
...
return TAB_COMPO_PPTES[387].NewCle;
}

function Delete_Personnes_Liste_des_personnes0()
{
 if (TAB_GLOBAL_COMPO[387].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[387].Action_en_cours = DELETE;
...
function Update_Personnes_Liste_des_personnes0()
{
 ...
 TAB_COMPO_PPTES[387].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[387].NewCle = TAB_GLOBAL_COMPO[387].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[387].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[390];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[387].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[387].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[390];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[387].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[387].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[387].Action_en_cours == INSERT)
         {
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[404].NewCle = getNewCle("observation");
/* On désactive le composant maitre */
...
function Insert_Personnes_Adresses_12()
{
 ...
 TAB_COMPO_PPTES[409].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[409].NewCle = getNewCle("adresse");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[409].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[414];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[415];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[416];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[417];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[418];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[419];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[420];
 Esclave_6.ActiverComposant(true);
...
top.document.getElementById("Delete_Personnes_Adresses_12").disabled=true;
top.document.getElementById("Update_Personnes_Adresses_12").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[409];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[409].NewCle;
}

function Delete_Personnes_Adresses_12()
{
 if (TAB_GLOBAL_COMPO[409].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[409].Action_en_cours = DELETE;
...
function Update_Personnes_Adresses_12()
{
 ...
 TAB_COMPO_PPTES[409].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[409].NewCle = TAB_GLOBAL_COMPO[409].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[409].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[414];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[409].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[409].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[414];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[415];
...
top.document.getElementById("Update_Personnes_Adresses_12").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[409].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[409].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[421].NewCle = getNewCle("contact");
/* On désactive le composant maitre */
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[426].NewCle = getNewCle("appel");
/* On désactive le composant maitre */
...
TAB_GLOBAL_COMPO[432].my_CompoXUL.value=today;
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[437].NewCle = getNewCle("estresponsable");
/* On désactive le composant maitre */
...
/* On active les composants esclaves et on vide les champs */
 ...
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[447];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[448];
 Esclave_4.ActiverComposant(true);
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[449].NewCle = getNewCle("attribut");
/* On désactive le composant maitre */
...
function Insert_Personnes_Routages_42()
{
 ...
 TAB_COMPO_PPTES[475].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[475].NewCle = getNewCle("routage");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[475].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[481];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[482];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[483];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[484];
 Esclave_3.ActiverComposant(true);
...
top.document.getElementById("Delete_Personnes_Routages_42").disabled=true;
top.document.getElementById("Update_Personnes_Routages_42").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[475];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[475].NewCle;
}

function Delete_Personnes_Routages_42()
{
 if (TAB_GLOBAL_COMPO[475].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[475].Action_en_cours = DELETE;
...
function Update_Personnes_Routages_42()
{
 ...
 TAB_COMPO_PPTES[475].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[475].NewCle = TAB_GLOBAL_COMPO[475].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[475].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[481];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[475].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[475].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[481];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[482];
...
top.document.getElementById("Update_Personnes_Routages_42").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[475].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[475].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[485].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[485].NewCle = getNewCle("devis");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[485].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[490];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[491];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[492];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[493];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[494];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[495];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[496];
 Esclave_6.ActiverComposant(true);
...
top.document.getElementById("Update_Devis_Lignes_du_devis_8").disabled=false;
 var Esclave_7=TAB_GLOBAL_COMPO[497];
 Esclave_7.ActiverComposant(true);
...
top.document.getElementById("Update_Devis_Liste_des_devis0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[485];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
var ladate=new Date();
var today=ladate.getDate()+"/"+(ladate.getMonth()+1)+"/"+ladate.getFullYear();
TAB_GLOBAL_COMPO[490].my_CompoXUL.value=today;
TAB_GLOBAL_COMPO[495].my_CompoXUL.value="Chère Madame, Cher Monsieur";
TAB_GLOBAL_COMPO[496].my_CompoXUL.value="Suite à notre conversation, je vous communique les éléments du devis concernant mon intervention sur le dossier de ";

return TAB_COMPO_PPTES[485].NewCle;
}

function Delete_Devis_Liste_des_devis0()
{
 if (TAB_GLOBAL_COMPO[485].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[485].Action_en_cours = DELETE;
...
function Update_Devis_Liste_des_devis0()
{
 ...
 TAB_COMPO_PPTES[485].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[485].NewCle = TAB_GLOBAL_COMPO[485].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[485].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[490];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[485].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[485].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[490];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[491];
...
top.document.getElementById("Update_Devis_Liste_des_devis0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[485].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 ...
 TAB_COMPO_PPTES[485].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[485].Action_en_cours == INSERT)
         {
                 if (confirm("Pour continuer, vous devez enregistrer votre saisie\n Voulez vous poursuivre ?"))
                {
 ...
 TAB_COMPO_PPTES[497].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[497].NewCle = getNewCle("ligne");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[497].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
...
top.document.getElementById("Delete_Devis_Lignes_du_devis_8").disabled=true;
top.document.getElementById("Update_Devis_Lignes_du_devis_8").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[497];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
TAB_GLOBAL_COMPO[503].my_CompoXUL.value=1;

return TAB_COMPO_PPTES[497].NewCle;
}

function Delete_Devis_Lignes_du_devis_8()
{
 if (TAB_GLOBAL_COMPO[497].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[497].Action_en_cours = DELETE;
...
function Update_Devis_Lignes_du_devis_8()
{
 ...
 TAB_COMPO_PPTES[497].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[497].NewCle = TAB_GLOBAL_COMPO[497].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[497].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[502];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[497].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[497].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[502];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[503];
...
top.document.getElementById("Update_Devis_Lignes_du_devis_8").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[497].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[497].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[505].NewCle = getNewCle("facture");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[505].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[511];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[512];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[513];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[514];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[515];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[516];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[517];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[518];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[519];
 Esclave_8.ActiverComposant(true);
 var Esclave_9=TAB_GLOBAL_COMPO[524];
 Esclave_9.ActiverComposant(true);
...
top.document.getElementById("Update_Facture_Règlements_11").disabled=false;
 var Esclave_10=TAB_GLOBAL_COMPO[527];
 Esclave_10.ActiverComposant(true);
...
top.document.getElementById("Update_Facture_Routages_16").disabled=false;
 var Esclave_11=TAB_GLOBAL_COMPO[537];
 Esclave_11.ActiverComposant(true);
...
function Insert_Facture_Règlements_11()
{
 ...
 TAB_COMPO_PPTES[527].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[527].NewCle = getNewCle("facturereglement");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[527].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[533];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[534];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[535];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[536];
 Esclave_3.ActiverComposant(true);
...
top.document.getElementById("Delete_Facture_Règlements_11").disabled=true;
top.document.getElementById("Update_Facture_Règlements_11").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[527];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[527].NewCle;
}

function Delete_Facture_Règlements_11()
{
 if (TAB_GLOBAL_COMPO[527].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[527].Action_en_cours = DELETE;
...
function Update_Facture_Règlements_11()
{
 ...
 TAB_COMPO_PPTES[527].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[527].NewCle = TAB_GLOBAL_COMPO[527].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[527].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[533];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[527].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[527].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[533];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[534];
...
top.document.getElementById("Update_Facture_Règlements_11").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[527].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[527].Action_en_cours = null;
 return NewCle;
}
...
function Insert_Facture_Routages_16()
{
 ...
 TAB_COMPO_PPTES[537].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[537].NewCle = getNewCle("routage");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[537].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[542];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[543];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[544];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[545];
 Esclave_3.ActiverComposant(true);
...
top.document.getElementById("Delete_Facture_Routages_16").disabled=true;
top.document.getElementById("Update_Facture_Routages_16").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[537];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[537].NewCle;
}

function Delete_Facture_Routages_16()
{
 if (TAB_GLOBAL_COMPO[537].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[537].Action_en_cours = DELETE;
...
function Update_Facture_Routages_16()
{
 ...
 TAB_COMPO_PPTES[537].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[537].NewCle = TAB_GLOBAL_COMPO[537].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[537].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[542];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[537].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[537].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[542];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[543];
...
top.document.getElementById("Update_Facture_Routages_16").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[537].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[537].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[546].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[546].NewCle = getNewCle("avoir");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[546].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[550];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[551];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[552];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[553];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[554];
 Esclave_4.ActiverComposant(true);
...
top.document.getElementById("Update_Avoir_Liste_des_avoirs0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[546];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[546].NewCle;
}

function Delete_Avoir_Liste_des_avoirs0()
{
 if (TAB_GLOBAL_COMPO[546].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[546].Action_en_cours = DELETE;
...
function Update_Avoir_Liste_des_avoirs0()
{
 ...
 TAB_COMPO_PPTES[546].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[546].NewCle = TAB_GLOBAL_COMPO[546].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[546].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[550];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[546].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[546].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[550];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[551];
...
top.document.getElementById("Update_Avoir_Liste_des_avoirs0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[546].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 ...
 TAB_COMPO_PPTES[546].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[559].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[559].NewCle = getNewCle("reglement");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[559].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[563];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[564];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[565];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[566];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[567];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[568];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[569];
 Esclave_6.ActiverComposant(true);
...
top.document.getElementById("Update_Réglement_Factures_concernées_8").disabled=false;
 var Esclave_7=TAB_GLOBAL_COMPO[570];
 Esclave_7.ActiverComposant(true);
...
top.document.getElementById("Update_Réglement_Dont_reversements____13").disabled=false;
 var Esclave_8=TAB_GLOBAL_COMPO[579];
 Esclave_8.ActiverComposant(true);
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[559];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[559].NewCle;
}

function Delete_Réglement_Liste_des_réglements0()
{
 if (TAB_GLOBAL_COMPO[559].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[559].Action_en_cours = DELETE;
...
function Update_Réglement_Liste_des_réglements0()
{
 ...
 TAB_COMPO_PPTES[559].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[559].NewCle = TAB_GLOBAL_COMPO[559].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[559].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[563];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[559].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[559].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[563];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[564];
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[559].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 ...
 TAB_COMPO_PPTES[559].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[559].Action_en_cours == INSERT)
         {
                 if (confirm("Pour continuer, vous devez enregistrer votre saisie\n Voulez vous poursuivre ?"))
                {
 ...
 TAB_COMPO_PPTES[570].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[570].NewCle = getNewCle("facturereglement");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[570].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[575];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[576];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[577];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[578];
 Esclave_3.ActiverComposant(true);
...
top.document.getElementById("Delete_Réglement_Factures_concernées_8").disabled=true;
top.document.getElementById("Update_Réglement_Factures_concernées_8").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[570];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[570].NewCle;
}

function Delete_Réglement_Factures_concernées_8()
{
 if (TAB_GLOBAL_COMPO[570].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[570].Action_en_cours = DELETE;
...
function Update_Réglement_Factures_concernées_8()
{
 ...
 TAB_COMPO_PPTES[570].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[570].NewCle = TAB_GLOBAL_COMPO[570].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[570].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[575];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[570].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[570].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[575];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[576];
...
top.document.getElementById("Update_Réglement_Factures_concernées_8").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[570].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[570].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[579].NewCle = getNewCle("repartition");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[579].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[582];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[583];
 Esclave_1.ActiverComposant(true);
...
{
 TAB_COMPO_PPTES[591].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[591].NewCle = getNewCle("listereglement");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[591].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
...
top.document.getElementById("Update_Bordereaux_de_réglements_Liste_des_bordereaux_de_remise_en_banque0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[591];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
function Delete_Bordereaux_de_réglements_Liste_des_bordereaux_de_remise_en_banque0()
{
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[591].Action_en_cours = DELETE;
...
function Update_Bordereaux_de_réglements_Liste_des_bordereaux_de_remise_en_banque0()
{
 ...
 TAB_COMPO_PPTES[591].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[591].NewCle = TAB_GLOBAL_COMPO[591].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[591].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[597];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[591].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[591].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[597];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[598];
...
top.document.getElementById("Update_Bordereaux_de_réglements_Liste_des_bordereaux_de_remise_en_banque0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[591].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[591].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[584].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[584].NewCle = getNewCle("cotisation");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[584].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[589];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[590];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Cotisations_Liste_des_cotisations0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[584];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[584].NewCle;
}

function Delete_Cotisations_Liste_des_cotisations0()
{
 if (TAB_GLOBAL_COMPO[584].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[584].Action_en_cours = DELETE;
...
function Update_Cotisations_Liste_des_cotisations0()
{
 ...
 TAB_COMPO_PPTES[584].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[584].NewCle = TAB_GLOBAL_COMPO[584].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[584].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[589];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[584].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[584].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[589];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[590];
...
top.document.getElementById("Update_Cotisations_Liste_des_cotisations0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[584].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[584].Action_en_cours = null;
 return NewCle;
}
...
top.TAB_GLOBAL_COMPO[387]=Compo_Personnes_Liste_des_personnes0;
...
top.TAB_GLOBAL_COMPO[390]=Compo_Personnes_Numéro_1;
...
top.TAB_GLOBAL_COMPO[391]=Compo_Personnes_Titre_ou_F_J__2;
...
top.TAB_GLOBAL_COMPO[392]=Compo_Personnes_Nom_ou_D_S__3;
...
top.TAB_GLOBAL_COMPO[393]=Compo_Personnes_Prénom_4;
...
top.TAB_GLOBAL_COMPO[394]=Compo_Personnes_N_TVA_intrac__5;
...
top.TAB_GLOBAL_COMPO[395]=Compo_Personnes_Né_e__le_6;
...
top.TAB_GLOBAL_COMPO[396]=Compo_Personnes_La_personne_est_active__et_peut_être_contactée__7;
...
top.TAB_GLOBAL_COMPO[397]=Compo_Personnes_Cotisations_8;
...
top.TAB_GLOBAL_COMPO[404]=Compo_Personnes_Observations_9;
...
top.TAB_GLOBAL_COMPO[407]=Compo_Personnes_Importance_10;
...
top.TAB_GLOBAL_COMPO[408]=Compo_Personnes_Description_11;
...
top.TAB_GLOBAL_COMPO[409]=Compo_Personnes_Adresses_12;
...
top.TAB_GLOBAL_COMPO[414]=Compo_Personnes_Type_13;
...
top.TAB_GLOBAL_COMPO[415]=Compo_Personnes_Apt_ou_Dest__14;
...
top.TAB_GLOBAL_COMPO[416]=Compo_Personnes_Bat__étage____15;
...
top.TAB_GLOBAL_COMPO[417]=Compo_Personnes_N__et_Voie_16;
...
top.TAB_GLOBAL_COMPO[418]=Compo_Personnes_BP_ou_Lieu_dit_17;
...
top.TAB_GLOBAL_COMPO[419]=Compo_Personnes_Code_postal_18;
...
top.TAB_GLOBAL_COMPO[420]=Compo_Personnes_Ville_19;
...
top.TAB_GLOBAL_COMPO[421]=Compo_Personnes_Contact_20;
...
top.TAB_GLOBAL_COMPO[424]=Compo_Personnes_Type_21;
...
top.TAB_GLOBAL_COMPO[425]=Compo_Personnes_Coordonnée_22;
...
top.TAB_GLOBAL_COMPO[426]=Compo_Personnes_Tâches_23;
...
top.TAB_GLOBAL_COMPO[432]=Compo_Personnes_Date_24;
...
top.TAB_GLOBAL_COMPO[433]=Compo_Personnes_Type_25;
...
top.TAB_GLOBAL_COMPO[434]=Compo_Personnes_Motif_26;
...
top.TAB_GLOBAL_COMPO[435]=Compo_Personnes_Durée__min__27;
...
top.TAB_GLOBAL_COMPO[436]=Compo_Personnes_Détails_complémentaires_28;
...
top.TAB_GLOBAL_COMPO[437]=Compo_Personnes_Responsabilités_29;
...
top.TAB_GLOBAL_COMPO[444]=Compo_Personnes_Responsabilité_30;
...
top.TAB_GLOBAL_COMPO[445]=Compo_Personnes_Titre_31;
...
top.TAB_GLOBAL_COMPO[446]=Compo_Personnes_Du_32;
...
top.TAB_GLOBAL_COMPO[447]=Compo_Personnes_Au_33;
...
top.TAB_GLOBAL_COMPO[448]=Compo_Personnes_Fin_de_mandat_34;
...
top.TAB_GLOBAL_COMPO[449]=Compo_Personnes_Attributs_35;
...
top.TAB_GLOBAL_COMPO[452]=Compo_Personnes_Attribut_36;
...
top.TAB_GLOBAL_COMPO[453]=Compo_Personnes_Valeur_37;
...
top.TAB_GLOBAL_COMPO[454]=Compo_Personnes_Détail_38;
...
top.TAB_GLOBAL_COMPO[455]=Compo_Personnes_Devis_39;
...
top.TAB_GLOBAL_COMPO[461]=Compo_Personnes_Factures_40;
...
top.TAB_GLOBAL_COMPO[469]=Compo_Personnes_Réglements_41;
...
top.TAB_GLOBAL_COMPO[475]=Compo_Personnes_Routages_42;
...
top.TAB_GLOBAL_COMPO[481]=Compo_Personnes_Début_43;
...
top.TAB_GLOBAL_COMPO[482]=Compo_Personnes_Fin_44;
...
Compo_Personnes_Quantité_45.GenererXUL(top.document.getElementById("Personnes_Routages_42_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 483*/
top.TAB_GLOBAL_COMPO[483]=Compo_Personnes_Quantité_45;
...
top.TAB_GLOBAL_COMPO[484]=Compo_Personnes_Suspendre_les_relances_46;
...
top.TAB_GLOBAL_COMPO[485]=Compo_Devis_Liste_des_devis0;
...
top.TAB_GLOBAL_COMPO[490]=Compo_Devis_Date_1;
...
top.TAB_GLOBAL_COMPO[491]=Compo_Devis_Libellé_2;
...
top.TAB_GLOBAL_COMPO[492]=Compo_Devis_Suivi_par_3;
...
Compo_Devis_Acompte_à_payer_4.GenererXUL(top.document.getElementById("Devis_Liste_des_devis0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 493*/
top.TAB_GLOBAL_COMPO[493]=Compo_Devis_Acompte_à_payer_4;
...
top.TAB_GLOBAL_COMPO[494]=Compo_Devis_Devis_sous_forme_de_lettre_5;
...
top.TAB_GLOBAL_COMPO[495]=Compo_Devis_Civilités_6;
...
top.TAB_GLOBAL_COMPO[496]=Compo_Devis_Introduction_de_la_lettre_7;
...
top.TAB_GLOBAL_COMPO[497]=Compo_Devis_Lignes_du_devis_8;
...
top.TAB_GLOBAL_COMPO[502]=Compo_Devis_Produit_9;
...
top.TAB_GLOBAL_COMPO[503]=Compo_Devis_Quantité_10;
...
top.TAB_GLOBAL_COMPO[504]=Compo_Devis_Notes_11;
...
top.TAB_GLOBAL_COMPO[505]=Compo_Facture_Liste_des_factures0;
...
top.TAB_GLOBAL_COMPO[511]=Compo_Facture_N__Facture_1;
...
top.TAB_GLOBAL_COMPO[512]=Compo_Facture_Date_2;
...
top.TAB_GLOBAL_COMPO[513]=Compo_Facture_Libellé_3;
...
top.TAB_GLOBAL_COMPO[514]=Compo_Facture_Réduction_4;
...
top.TAB_GLOBAL_COMPO[515]=Compo_Facture_Montant_HT_5;
...
top.TAB_GLOBAL_COMPO[516]=Compo_Facture_Montant_TTC_6;
...
top.TAB_GLOBAL_COMPO[517]=Compo_Facture_N_Devis_d_origine_7;
...
top.TAB_GLOBAL_COMPO[518]=Compo_Facture_Annotation_8;
...
top.TAB_GLOBAL_COMPO[519]=Compo_Facture_Lignes_de_la_facture_9;
...
Compo_Facture_Avoirs_de_la_facture_10.GenererXUL(top.document.getElementById("Facture_Avoirs_de_la_facture_10"));
	...
	/* On l'ajoute au tableau global à l'indice 524*/
top.TAB_GLOBAL_COMPO[524]=Compo_Facture_Avoirs_de_la_facture_10;
...
top.TAB_GLOBAL_COMPO[527]=Compo_Facture_Règlements_11;
...
top.TAB_GLOBAL_COMPO[533]=Compo_Facture_Règlement_12;
...
top.TAB_GLOBAL_COMPO[534]=Compo_Facture_Ce_règlement_est_un_acompte_13;
...
Compo_Facture_Une_part_du_montant_du_règlement_est_utilisé_14.GenererXUL(top.document.getElementById("Facture_Règlements_11_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 535*/
top.TAB_GLOBAL_COMPO[535]=Compo_Facture_Une_part_du_montant_du_règlement_est_utilisé_14;
...
top.TAB_GLOBAL_COMPO[536]=Compo_Facture_Montant_de_la_part_15;
...
top.TAB_GLOBAL_COMPO[537]=Compo_Facture_Routages_16;
...
top.TAB_GLOBAL_COMPO[542]=Compo_Facture_Adresse_17;
...
top.TAB_GLOBAL_COMPO[543]=Compo_Facture_Début_18;
...
top.TAB_GLOBAL_COMPO[544]=Compo_Facture_Fin_19;
...
top.TAB_GLOBAL_COMPO[545]=Compo_Facture_Quantité_20;
...
top.TAB_GLOBAL_COMPO[546]=Compo_Avoir_Liste_des_avoirs0;
...
top.TAB_GLOBAL_COMPO[550]=Compo_Avoir_N__Facture_1;
...
top.TAB_GLOBAL_COMPO[551]=Compo_Avoir_Date_2;
...
top.TAB_GLOBAL_COMPO[552]=Compo_Avoir_Montant_TTC_3;
...
top.TAB_GLOBAL_COMPO[553]=Compo_Avoir_Montant_HT_4;
...
top.TAB_GLOBAL_COMPO[554]=Compo_Avoir_Lignes_de_l_avoir_5;
...
top.TAB_GLOBAL_COMPO[559]=Compo_Réglement_Liste_des_réglements0;
...
top.TAB_GLOBAL_COMPO[563]=Compo_Réglement_Date_1;
...
top.TAB_GLOBAL_COMPO[564]=Compo_Réglement_Montant_2;
...
top.TAB_GLOBAL_COMPO[565]=Compo_Réglement_Mode_3;
...
top.TAB_GLOBAL_COMPO[566]=Compo_Réglement_Banque_4;
...
top.TAB_GLOBAL_COMPO[567]=Compo_Réglement_N__compte_5;
...
top.TAB_GLOBAL_COMPO[568]=Compo_Réglement_Référence_6;
...
top.TAB_GLOBAL_COMPO[569]=Compo_Réglement_Responsable_7;
...
top.TAB_GLOBAL_COMPO[570]=Compo_Réglement_Factures_concernées_8;
...
top.TAB_GLOBAL_COMPO[575]=Compo_Réglement_Facture_9;
...
top.TAB_GLOBAL_COMPO[576]=Compo_Réglement_Acompte_10;
...
top.TAB_GLOBAL_COMPO[577]=Compo_Réglement_La_facture_reçoit_seulement_une_part_du_réglement_11;
...
top.TAB_GLOBAL_COMPO[578]=Compo_Réglement_Montant_de_la_part_12;
...
top.TAB_GLOBAL_COMPO[579]=Compo_Réglement_Dont_reversements____13;
...
top.TAB_GLOBAL_COMPO[582]=Compo_Réglement_Montant_14;
...
top.TAB_GLOBAL_COMPO[583]=Compo_Réglement_Vers_15;
...
top.TAB_GLOBAL_COMPO[591]=Compo_Bordereaux_de_réglements_Liste_des_bordereaux_de_remise_en_banque0;
...
top.TAB_GLOBAL_COMPO[597]=Compo_Bordereaux_de_réglements_Employé_e__1;
...
top.TAB_GLOBAL_COMPO[598]=Compo_Bordereaux_de_réglements_Mode_reg__2;
...
top.TAB_GLOBAL_COMPO[599]=Compo_Bordereaux_de_réglements_Commentaire_3;
...
top.TAB_GLOBAL_COMPO[600]=Compo_Bordereaux_de_réglements_Liste_des_règlements_4;
...
var Cotisations_Société_2=new clAttribut("pe_description","personne",null);


	/* Ce composant représente: personne.pe_description sous le nom "Société" */
...
top.TAB_GLOBAL_COMPO[584]=Compo_Cotisations_Liste_des_cotisations0;
...
top.TAB_GLOBAL_COMPO[589]=Compo_Cotisations_Description_1;

	/* Ce composant représente: des éléments de la table personne sous le nom "Société" */
 if(ALeDroit(0,"personne"))
 {
...
top.TAB_GLOBAL_COMPO[590]=Compo_Cotisations_Société_2;
Filtre_DepFor_Devis_0.setComposant(TAB_GLOBAL_COMPO[485],null);
Filtre_DepFor_Facture_0.setComposant(TAB_GLOBAL_COMPO[505],null);
Filtre_Dep_Avoir_0.setComposant(TAB_GLOBAL_COMPO[546],null);
Filtre_Dep_Réglement_0.setComposant(TAB_GLOBAL_COMPO[559],null);
Filtre_DepFor_Réglement_1.setComposant(TAB_GLOBAL_COMPO[559],null);
 if(ALeDroit(5,"personne"))
 {
/* On refresh les composants non dépendents de l'onget Personnes*/
var Composant_0 = TAB_GLOBAL_COMPO[387];
if (Composant_0!=null){
...
var Composant_0 = TAB_GLOBAL_COMPO[485];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[546];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[559];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[591];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[584];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
ConstruireOngletEstLie("tabbox_Personnes_Liste_des_personnes0",387);
