...
TAB_GLOBAL_COMPO[521].my_CompoXUL.value="Chère Madame, Cher Monsieur";
TAB_GLOBAL_COMPO[522].my_CompoXUL.value="Suite à notre conversation, je vous communique les éléments du devis concernant mon intervention sur le dossier de ";
...
/* On active les composants esclaves et on vide les champs */
 ...
 Esclave_11.ActiverComposant(true);
top.document.getElementById("Validate_Facture_Règlements_13").disabled=true;
top.document.getElementById("Annuler_Facture_Règlements_13").disabled=true;
top.document.getElementById("Insert_Facture_Règlements_13").disabled=false;
top.document.getElementById("Delete_Facture_Règlements_13").disabled=false;
top.document.getElementById("Update_Facture_Règlements_13").disabled=false;
...
/* On active les composants esclaves et on vide les champs */
 ...
 var Esclave_11=TAB_GLOBAL_COMPO[551];
 Esclave_11.ActiverComposant(false);
Annuler_Facture_Règlements_13();
top.document.getElementById("Validate_Facture_Règlements_13").disabled=true;
top.document.getElementById("Annuler_Facture_Règlements_13").disabled=true;
top.document.getElementById("Insert_Facture_Règlements_13").disabled=true;
top.document.getElementById("Delete_Facture_Règlements_13").disabled=true;
top.document.getElementById("Update_Facture_Règlements_13").disabled=true;
 var Esclave_12=TAB_GLOBAL_COMPO[557];
 Esclave_12.ActiverComposant(false);
...
function Insert_Facture_Règlements_13()
{
...
/* On active les composants esclaves et on vide les champs */
 ...
 Esclave_3.ActiverComposant(true);
top.document.getElementById("Validate_Facture_Règlements_13").disabled=false;
top.document.getElementById("Annuler_Facture_Règlements_13").disabled=false;
top.document.getElementById("Insert_Facture_Règlements_13").disabled=true;
top.document.getElementById("Delete_Facture_Règlements_13").disabled=true;
top.document.getElementById("Update_Facture_Règlements_13").disabled=true;
...
function Delete_Facture_Règlements_13()
{
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[557].Action_en_cours = DELETE;
         User_Delete_Facture_Règlements_13(Maitre);
        Maitre.RefreshTotal();
 }
}

function Update_Facture_Règlements_13()
{
 if (TAB_GLOBAL_COMPO[557].getCleVal()==-1)
 {
         alert("Vous devez selectionner l'enregistrement à mettre à jour");
...
function Validate_Facture_Règlements_13(retour)
{
 /* Retour à l'onget appellant si appelle par gérer */
if (retour==null)
        retour=true;
 ...
 switch(TAB_COMPO_PPTES[557].Action_en_cours){
        case INSERT :
        if ((NewCle = User_Insert_Facture_Règlements_13(Maitre))==-1)
                return -1;
        break;
        case UPDATE :
        if ((User_Update_Facture_Règlements_13(Maitre))==-1)
                return -1;
        break;
 }
 /* On construit la requete pour ajouter les nouvelles cles */
...
function Annuler_Facture_Règlements_13()
{
 TAB_COMPO_PPTES[557].Action_en_cours = null;
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[557].ActiverComposant(true,true);
...
/* On active les composants esclaves et on vide les champs */
 ...
 Esclave_7.ActiverComposant(true);
top.document.getElementById("Validate_Réglement_Factures_concernées_9").disabled=true;
top.document.getElementById("Annuler_Réglement_Factures_concernées_9").disabled=true;
top.document.getElementById("Insert_Réglement_Factures_concernées_9").disabled=false;
top.document.getElementById("Delete_Réglement_Factures_concernées_9").disabled=false;
top.document.getElementById("Update_Réglement_Factures_concernées_9").disabled=false;
 var Esclave_8=TAB_GLOBAL_COMPO[589];
 Esclave_8.ActiverComposant(true);
top.document.getElementById("Validate_Réglement_Dont_reversements____14").disabled=true;
top.document.getElementById("Annuler_Réglement_Dont_reversements____14").disabled=true;
top.document.getElementById("Insert_Réglement_Dont_reversements____14").disabled=false;
top.document.getElementById("Delete_Réglement_Dont_reversements____14").disabled=false;
top.document.getElementById("Update_Réglement_Dont_reversements____14").disabled=false;
...
/* On active les composants esclaves et on vide les champs */
 ...
 var Esclave_7=TAB_GLOBAL_COMPO[588];
 Esclave_7.ActiverComposant(false);
Annuler_Réglement_Factures_concernées_9();
top.document.getElementById("Validate_Réglement_Factures_concernées_9").disabled=true;
top.document.getElementById("Annuler_Réglement_Factures_concernées_9").disabled=true;
top.document.getElementById("Insert_Réglement_Factures_concernées_9").disabled=true;
top.document.getElementById("Delete_Réglement_Factures_concernées_9").disabled=true;
top.document.getElementById("Update_Réglement_Factures_concernées_9").disabled=true;
 var Esclave_8=TAB_GLOBAL_COMPO[589];
 Esclave_8.ActiverComposant(false);
Annuler_Réglement_Dont_reversements____14();
top.document.getElementById("Validate_Réglement_Dont_reversements____14").disabled=true;
top.document.getElementById("Annuler_Réglement_Dont_reversements____14").disabled=true;
top.document.getElementById("Insert_Réglement_Dont_reversements____14").disabled=true;
top.document.getElementById("Delete_Réglement_Dont_reversements____14").disabled=true;
top.document.getElementById("Update_Réglement_Dont_reversements____14").disabled=true;
 var Esclave_9=TAB_GLOBAL_COMPO[598];
 Esclave_9.ActiverComposant(false);
...
function Insert_Réglement_Factures_concernées_9()
{
 if (TAB_COMPO_PPTES[577].Action_en_cours == INSERT)
         {
                 if (confirm("Pour continuer, vous devez enregistrer votre saisie\n Voulez vous poursuivre ?"))
                {
                        ...
                        Insert_Réglement_Factures_concernées_9();
                }
                 return;
         }
...
/* On active les composants esclaves et on vide les champs */
 ...
 Esclave_3.ActiverComposant(true);
top.document.getElementById("Validate_Réglement_Factures_concernées_9").disabled=false;
top.document.getElementById("Annuler_Réglement_Factures_concernées_9").disabled=false;
top.document.getElementById("Insert_Réglement_Factures_concernées_9").disabled=true;
top.document.getElementById("Delete_Réglement_Factures_concernées_9").disabled=true;
top.document.getElementById("Update_Réglement_Factures_concernées_9").disabled=true;
...
function Delete_Réglement_Factures_concernées_9()
{
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[589].Action_en_cours = DELETE;
         User_Delete_Réglement_Factures_concernées_9(Maitre);
        Maitre.RefreshTotal();
 }
}

function Update_Réglement_Factures_concernées_9()
{
 if (TAB_GLOBAL_COMPO[589].getCleVal()==-1)
 {
         alert("Vous devez selectionner l'enregistrement à mettre à jour");
...
function Validate_Réglement_Factures_concernées_9(retour)
{
 /* Retour à l'onget appellant si appelle par gérer */
if (retour==null)
        retour=true;
 ...
 switch(TAB_COMPO_PPTES[589].Action_en_cours){
        case INSERT :
        if ((NewCle = User_Insert_Réglement_Factures_concernées_9(Maitre))==-1)
                return -1;
        break;
        case UPDATE :
        if ((User_Update_Réglement_Factures_concernées_9(Maitre))==-1)
                return -1;
        break;
 }
 /* On construit la requete pour ajouter les nouvelles cles */
...
function Annuler_Réglement_Factures_concernées_9()
{
 TAB_COMPO_PPTES[589].Action_en_cours = null;
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[589].ActiverComposant(true,true);
...
function Insert_Réglement_Dont_reversements____14()
{
 if (TAB_COMPO_PPTES[577].Action_en_cours == INSERT)
         {
                 if (confirm("Pour continuer, vous devez enregistrer votre saisie\n Voulez vous poursuivre ?"))
                {
                        ...
                        Insert_Réglement_Dont_reversements____14();
                }
                 return;
         }
...
/* On active les composants esclaves et on vide les champs */
 ...
 Esclave_1.ActiverComposant(true);
top.document.getElementById("Validate_Réglement_Dont_reversements____14").disabled=false;
top.document.getElementById("Annuler_Réglement_Dont_reversements____14").disabled=false;
top.document.getElementById("Insert_Réglement_Dont_reversements____14").disabled=true;
top.document.getElementById("Delete_Réglement_Dont_reversements____14").disabled=true;
top.document.getElementById("Update_Réglement_Dont_reversements____14").disabled=true;
...
function Delete_Réglement_Dont_reversements____14()
{
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[598].Action_en_cours = DELETE;
         User_Delete_Réglement_Dont_reversements____14(Maitre);
        Maitre.RefreshTotal();
 }
}

function Update_Réglement_Dont_reversements____14()
{
 if (TAB_GLOBAL_COMPO[598].getCleVal()==-1)
 {
         alert("Vous devez selectionner l'enregistrement à mettre à jour");
...
function Validate_Réglement_Dont_reversements____14(retour)
{
 /* Retour à l'onget appellant si appelle par gérer */
if (retour==null)
        retour=true;
 ...
 switch(TAB_COMPO_PPTES[598].Action_en_cours){
        case INSERT :
        if ((NewCle = User_Insert_Réglement_Dont_reversements____14(Maitre))==-1)
                return -1;
        break;
        case UPDATE :
        if ((User_Update_Réglement_Dont_reversements____14(Maitre))==-1)
                return -1;
        break;
 }
 /* On construit la requete pour ajouter les nouvelles cles */
...
function Annuler_Réglement_Dont_reversements____14()
{
 TAB_COMPO_PPTES[598].Action_en_cours = null;
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[598].ActiverComposant(true,true);
...
Compo_Personnes_Numéro_1.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 408*/
top.TAB_GLOBAL_COMPO[408]=Compo_Personnes_Numéro_1;
...
Compo_Personnes_Titre_ou_F_J__2.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 409*/
...
Compo_Personnes_Prénom_4.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 411*/
top.TAB_GLOBAL_COMPO[411]=Compo_Personnes_Prénom_4;
...
Compo_Personnes_N_TVA_intrac__5.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 412*/
...
top.TAB_GLOBAL_COMPO[413]=Compo_Personnes_Né_e__le_6;
...
top.TAB_GLOBAL_COMPO[414]=Compo_Personnes_La_personne_est_active__et_peut_être_contactée__7;
...
Compo_Personnes_Description_11.GenererXUL(top.document.getElementById("Personnes_Observations_9_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 428*/
...
Compo_Personnes_Adresses_12.GenererXUL(top.document.getElementById("Personnes_Adresses_12"));
	...
	/* On l'ajoute au tableau global à l'indice 429*/
...
Compo_Personnes_Apt_ou_Dest__13.GenererXUL(top.document.getElementById("Personnes_Adresses_12_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 434*/
...
Compo_Personnes_Bat__étage____14.GenererXUL(top.document.getElementById("Personnes_Adresses_12_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 435*/
top.TAB_GLOBAL_COMPO[435]=Compo_Personnes_Bat__étage____14;
...
Compo_Personnes_N__et_Voie_15.GenererXUL(top.document.getElementById("Personnes_Adresses_12_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 436*/
...
Compo_Personnes_BP_ou_Lieu_dit_16.GenererXUL(top.document.getElementById("Personnes_Adresses_12_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 437*/
...
top.TAB_GLOBAL_COMPO[440]=Compo_Personnes_Canton__si_différent_de_celui_par_défaut__19;
...
top.TAB_GLOBAL_COMPO[441]=Compo_Personnes_Adresse_par_défaut_20;
...
Compo_Personnes_Type_22.GenererXUL(top.document.getElementById("Personnes_Contact_21_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 446*/
...
Compo_Personnes_Coordonnée_23.GenererXUL(top.document.getElementById("Personnes_Contact_21_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 447*/
top.TAB_GLOBAL_COMPO[447]=Compo_Personnes_Coordonnée_23;
...
Compo_Personnes_Coordonnée_strictement_personnelle_24.GenererXUL(top.document.getElementById("Personnes_Contact_21_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 448*/
top.TAB_GLOBAL_COMPO[448]=Compo_Personnes_Coordonnée_strictement_personnelle_24;
...
Compo_Personnes_Tâches_25.GenererXUL(top.document.getElementById("Personnes_Tâches_25"));
	...
	/* On l'ajoute au tableau global à l'indice 449*/
top.TAB_GLOBAL_COMPO[449]=Compo_Personnes_Tâches_25;
...
Compo_Personnes_Type_27.GenererXUL(top.document.getElementById("Personnes_Tâches_25_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 456*/
...
Compo_Personnes_Motif_28.GenererXUL(top.document.getElementById("Personnes_Tâches_25_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 457*/
...
top.TAB_GLOBAL_COMPO[458]=Compo_Personnes_Durée__min__29;
...
top.TAB_GLOBAL_COMPO[459]=Compo_Personnes_Détails_complémentaires_30;
...
top.TAB_GLOBAL_COMPO[460]=Compo_Personnes_Responsabilités_31;
...
top.TAB_GLOBAL_COMPO[467]=Compo_Personnes_Responsabilité_32;
...
Compo_Personnes_Titre_33.GenererXUL(top.document.getElementById("Personnes_Responsabilités_31_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 468*/
...
Compo_Personnes_Du_34.GenererXUL(top.document.getElementById("Personnes_Responsabilités_31_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 469*/
...
Compo_Personnes_Au_35.GenererXUL(top.document.getElementById("Personnes_Responsabilités_31_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 470*/
...
Compo_Personnes_Fin_de_mandat_36.GenererXUL(top.document.getElementById("Personnes_Responsabilités_31_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 471*/
...
Compo_Personnes_Attributs_37.GenererXUL(top.document.getElementById("Personnes_Attributs_37"));
	...
	/* On l'ajoute au tableau global à l'indice 472*/
...
Compo_Personnes_Attribut_38.GenererXUL(top.document.getElementById("Personnes_Attributs_37_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 475*/
...
Compo_Personnes_Valeur_39.GenererXUL(top.document.getElementById("Personnes_Attributs_37_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 476*/
...
Compo_Personnes_Détail_40.GenererXUL(top.document.getElementById("Personnes_Attributs_37_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 477*/
top.TAB_GLOBAL_COMPO[477]=Compo_Personnes_Détail_40;
...
Compo_Personnes_Devis_41.GenererXUL(top.document.getElementById("Personnes_Devis_41"));
	...
	/* On l'ajoute au tableau global à l'indice 478*/
...
Compo_Personnes_Factures_42.GenererXUL(top.document.getElementById("Personnes_Factures_42"));
	...
	/* On l'ajoute au tableau global à l'indice 484*/
...
Compo_Personnes_Réglements_43.GenererXUL(top.document.getElementById("Personnes_Réglements_43"));
	...
	/* On l'ajoute au tableau global à l'indice 494*/
top.TAB_GLOBAL_COMPO[494]=Compo_Personnes_Réglements_43;
...
Compo_Personnes_Début_45.GenererXUL(top.document.getElementById("Personnes_Routages_44_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 506*/
top.TAB_GLOBAL_COMPO[506]=Compo_Personnes_Début_45;
...
top.TAB_GLOBAL_COMPO[508]=Compo_Personnes_Quantité_47;
...
top.TAB_GLOBAL_COMPO[517]=Compo_Devis_Libellé_2;
...
top.TAB_GLOBAL_COMPO[521]=Compo_Devis_Civilités_6;
...
Compo_Devis_Produit_9.GenererXUL(top.document.getElementById("Devis_Lignes_du_devis_8_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 529*/
...
Compo_Devis_Quantité_10.GenererXUL(top.document.getElementById("Devis_Lignes_du_devis_8_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 530*/
top.TAB_GLOBAL_COMPO[530]=Compo_Devis_Quantité_10;
...
Compo_Devis_Produit_acheté_pour_la_personne__facultatif__12.GenererXUL(top.document.getElementById("Devis_Lignes_du_devis_8_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 532*/
top.TAB_GLOBAL_COMPO[532]=Compo_Devis_Produit_acheté_pour_la_personne__facultatif__12;
...
var Col_N1_Qté__De_Facture_Lignes_de_la_facture_12=new clAttribut("lf_quantite","lignefacture",null);
...
var Facture_Lignes_de_la_facture_12=new clEnsembleAttributs("lignefacture",
	...
	,new clLiaison(null,Col_N1_Qté__De_Facture_Lignes_de_la_facture_12)
...
var Titre_Facture_Lignes_de_la_facture_12=new Array("Produit","Qté.","Montant HT","Montant TTC","hidden_Pour");
...
var Col_N0_N__De_Facture_Règlements_13=new clAttribut("rg_numero","facturereglement",null);

var Col_N1_Date_De_Facture_Règlements_13=new clAttribut("rg_date","reglement",null);

var Joint_Col_N1_Date_De_Facture_Règlements_13=new clJointureMulti("facturereglement",
	new Array(
	new stJointure("reglement","rg_numero","rg_numero",null,true)
	));
var Col_N2_Part_De_Facture_Règlements_13=new clAttribut("fr_montant","facturereglement",null);

var Col_N3_R_Mnt__De_Facture_Règlements_13=new clAttribut("rg_montant","reglement",null);

var Joint_Col_N3_R_Mnt__De_Facture_Règlements_13=new clJointureMulti("facturereglement",
	new Array(
	new stJointure("reglement","rg_numero","rg_numero",null,true)
	));
var Facture_Règlement_14=new clAttribut("rg_libelle","reglement",null);


	/* Ce composant représente: reglement.rg_libelle sous le nom "Règlement" */
var Compo_Facture_Règlement_14=new clCompoListeDeroulanteSimple(Facture_Règlement_14,new Array(clCompoListeDeroulanteSimple.prototype.FiltreParDefaut(),Filtre_Dep_Réglement_0=new clInterfaceFiltrageRelationOnglet("Réglement",Gerer_Réglement,OuvrirOnglet_Facture)),"Règlement");
var Joint_Esclave_Facture_Règlement_14=new clJointureMulti("facturereglement",
	new Array(
	new stJointure("reglement","rg_numero","rg_numero",null,false)
	));
var Facture_Ce_règlement_est_un_acompte_15=new clAttribut("fr_acompte","facturereglement",null);


	/* Ce composant représente: facturereglement.fr_acompte sous le nom "Ce règlement est un acompte" */
var Compo_Facture_Ce_règlement_est_un_acompte_15=new clCompoCheckBox(Facture_Ce_règlement_est_un_acompte_15,null,"Ce règlement est un acompte");
var Facture_Une_part_du_montant_du_règlement_est_utilisé_16=new clAttribut("fr_partiel","facturereglement",null);


	/* Ce composant représente: facturereglement.fr_partiel sous le nom "Une part du montant du règlement est utilisé" */
var Compo_Facture_Une_part_du_montant_du_règlement_est_utilisé_16=new clCompoCheckBox(Facture_Une_part_du_montant_du_règlement_est_utilisé_16,null,"Une part du montant du règlement est utilisé");
...
var Facture_Règlements_13=new clEnsembleAttributs("facturereglement",
	new Array(
	new clLiaison(null,Col_N0_N__De_Facture_Règlements_13)
	,new clLiaison(Joint_Col_N1_Date_De_Facture_Règlements_13,Col_N1_Date_De_Facture_Règlements_13)
	,new clLiaison(null,Col_N2_Part_De_Facture_Règlements_13)
	,new clLiaison(Joint_Col_N3_R_Mnt__De_Facture_Règlements_13,Col_N3_R_Mnt__De_Facture_Règlements_13)
	),
	new Array(
	new clLiaison(Joint_Esclave_Facture_Règlement_14,Facture_Règlement_14)
	,new clLiaison(null,Facture_Ce_règlement_est_un_acompte_15)
	,new clLiaison(null,Facture_Une_part_du_montant_du_règlement_est_utilisé_16)
	,new clLiaison(null,Facture_Montant_de_la_part_17)
	));

var Titre_Facture_Règlements_13=new Array("N°","Date","Part","R.Mnt.");

	/* Ce composant représente: des éléments de la table facturereglement sous le nom "Règlements" */
var Compo_Facture_Règlements_13=new clCompoListe(Facture_Règlements_13,null,Titre_Facture_Règlements_13,"Règlements",true,false);
var Joint_Esclave_Facture_Règlements_13=new clJointureMulti("facture",
	new Array(
	new stJointure("facturereglement","fa_numero","fa_numero",null,false)
	));
var Col_N0_Début_De_Facture_Routages_18=new clAttribut("ro_debutservice","routage",null);

var Col_N1_Fin_De_Facture_Routages_18=new clAttribut("ro_finservice","routage",null);

var Col_N2_Qté__De_Facture_Routages_18=new clAttribut("ro_quantite","routage",null);
...
var Facture_Début_20=new clAttribut("ro_debutservice","routage",null);


	/* Ce composant représente: routage.ro_debutservice sous le nom "Début" */
var Compo_Facture_Début_20=new clCompoTextBox(Facture_Début_20,null,"Début",false,false);
...
var Facture_Quantité_22=new clAttribut("ro_quantite","routage",null);


	/* Ce composant représente: routage.ro_quantite sous le nom "Quantité" */
var Compo_Facture_Quantité_22=new clCompoTextBox(Facture_Quantité_22,null,"Quantité",false,false);
var Facture_Routages_18=new clEnsembleAttributs("routage",
	new Array(
	new clLiaison(null,Col_N0_Début_De_Facture_Routages_18)
	,new clLiaison(null,Col_N1_Fin_De_Facture_Routages_18)
	,new clLiaison(null,Col_N2_Qté__De_Facture_Routages_18)
	...
	,new clLiaison(null,Facture_Début_20)
	,new clLiaison(null,Facture_Fin_21)
	,new clLiaison(null,Facture_Quantité_22)
	));

var Titre_Facture_Routages_18=new Array("Début","Fin","Qté.","hidden_N°P","Personne","hidden_Adresse");
...
var Facture_Liste_des_factures0=new clEnsembleAttributs("facture",
	...
	,new clLiaison(Joint_Esclave_Facture_Règlements_13,Facture_Règlements_13)
...
Compo_Facture_Liste_des_factures0.GenererXUL(top.document.getElementById("Facture_Liste_des_factures0"));
	...
	/* On l'ajoute au tableau global à l'indice 533*/
...
Compo_Facture_Libellé_3.GenererXUL(top.document.getElementById("Facture_Liste_des_factures0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 542*/
top.TAB_GLOBAL_COMPO[542]=Compo_Facture_Libellé_3;
...
Compo_Facture_Réduction_4.GenererXUL(top.document.getElementById("Facture_Liste_des_factures0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 543*/
top.TAB_GLOBAL_COMPO[543]=Compo_Facture_Réduction_4;
...
Compo_Facture_Montant_HT_5.GenererXUL(top.document.getElementById("Facture_Liste_des_factures0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 544*/
...
Compo_Facture_Montant_TTC_6.GenererXUL(top.document.getElementById("Facture_Liste_des_factures0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 545*/
...
Compo_Facture_Lignes_de_la_facture_12.GenererXUL(top.document.getElementById("Facture_Lignes_de_la_facture_12"));
	...
	/* On l'ajoute au tableau global à l'indice 551*/
top.TAB_GLOBAL_COMPO[551]=Compo_Facture_Lignes_de_la_facture_12;
 ...
 {
Compo_Facture_Règlements_13.GenererXUL(top.document.getElementById("Facture_Règlements_13"));

 }

	/* On l'ajoute au tableau global à l'indice 557*/
top.TAB_GLOBAL_COMPO[557]=Compo_Facture_Règlements_13;

	/* Ce composant représente: des éléments de la table reglement sous le nom "Règlement" */
 if(ALeDroit(0,"reglement"))
 {
Compo_Facture_Règlement_14.GenererXUL(top.document.getElementById("Facture_Règlements_13_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 562*/
top.TAB_GLOBAL_COMPO[562]=Compo_Facture_Règlement_14;

	/* Ce composant représente: des éléments de la table facturereglement sous le nom "Ce règlement est un acompte" */
 if(ALeDroit(0,"facturereglement"))
 {
Compo_Facture_Ce_règlement_est_un_acompte_15.GenererXUL(top.document.getElementById("Facture_Règlements_13_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 563*/
top.TAB_GLOBAL_COMPO[563]=Compo_Facture_Ce_règlement_est_un_acompte_15;
 ...
 if(ALeDroit(0,"facturereglement"))
 {
Compo_Facture_Une_part_du_montant_du_règlement_est_utilisé_16.GenererXUL(top.document.getElementById("Facture_Règlements_13_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 564*/
top.TAB_GLOBAL_COMPO[564]=Compo_Facture_Une_part_du_montant_du_règlement_est_utilisé_16;

	/* Ce composant représente: des éléments de la table facturereglement sous le nom "Montant de la part" */
 if(ALeDroit(0,"facturereglement"))
 {
Compo_Facture_Montant_de_la_part_17.GenererXUL(top.document.getElementById("Facture_Règlements_13_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 565*/
...
Compo_Facture_Routages_18.GenererXUL(top.document.getElementById("Facture_Routages_18"));
	...
	/* On l'ajoute au tableau global à l'indice 566*/
...
top.TAB_GLOBAL_COMPO[573]=Compo_Facture_Adresse_19;
 ...
 if(ALeDroit(0,"routage"))
 {
Compo_Facture_Début_20.GenererXUL(top.document.getElementById("Facture_Routages_18_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 574*/
top.TAB_GLOBAL_COMPO[574]=Compo_Facture_Début_20;
...
Compo_Facture_Fin_21.GenererXUL(top.document.getElementById("Facture_Routages_18_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 575*/
top.TAB_GLOBAL_COMPO[575]=Compo_Facture_Fin_21;

	/* Ce composant représente: des éléments de la table routage sous le nom "Quantité" */
 if(ALeDroit(0,"routage"))
 {
Compo_Facture_Quantité_22.GenererXUL(top.document.getElementById("Facture_Routages_18_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 576*/
top.TAB_GLOBAL_COMPO[576]=Compo_Facture_Quantité_22;
...
var Réglement_Remise_de_chèque_8=new clAttribut("lr_numero","reglement",null);


	/* Ce composant représente: reglement.lr_numero sous le nom "Remise de chèque" */
var Compo_Réglement_Remise_de_chèque_8=new clCompolabel(Réglement_Remise_de_chèque_8,null,"Remise de chèque",undefined,undefined);
var Col_N0_N__Fact__De_Réglement_Factures_concernées_9=new clAttribut("fa_numfact","facture",null);

var Joint_Col_N0_N__Fact__De_Réglement_Factures_concernées_9=new clJointureMulti("facturereglement",
	new Array(
	new stJointure("facture","fa_numero","fa_numero",null,true)
	));
var Col_N1_Date_De_Réglement_Factures_concernées_9=new clAttribut("fa_date","facture",null);

var Joint_Col_N1_Date_De_Réglement_Factures_concernées_9=new clJointureMulti("facturereglement",
	new Array(
	new stJointure("facture","fa_numero","fa_numero",null,true)
	));
var Col_N2_F_Mnt__De_Réglement_Factures_concernées_9=new clAttribut("fa_montantttc","facture",null);

var Joint_Col_N2_F_Mnt__De_Réglement_Factures_concernées_9=new clJointureMulti("facturereglement",
	new Array(
	new stJointure("facture","fa_numero","fa_numero",null,true)
	));
var Col_N3_Mnt__De_Réglement_Factures_concernées_9=new clAttribut("fr_montant","facturereglement",null);

var Réglement_Facture_10=new clAttribut("fa_numfact","facture",null);


	/* Ce composant représente: facture.fa_numfact sous le nom "Facture" */
var Compo_Réglement_Facture_10=new clCompoListeDeroulanteSimple(Réglement_Facture_10,null,"Facture");
var Joint_Esclave_Réglement_Facture_10=new clJointureMulti("facturereglement",
	new Array(
	new stJointure("facture","fa_numero","fa_numero",null,false)
	));
var Réglement_Acompte_11=new clAttribut("fr_acompte","facturereglement",null);


	/* Ce composant représente: facturereglement.fr_acompte sous le nom "Acompte" */
var Compo_Réglement_Acompte_11=new clCompoCheckBox(Réglement_Acompte_11,null,"Acompte");
var Réglement_La_facture_reçoit_seulement_une_part_du_réglement_12=new clAttribut("fr_partiel","facturereglement",null);


	/* Ce composant représente: facturereglement.fr_partiel sous le nom "La facture reçoit seulement une part du réglement" */
var Compo_Réglement_La_facture_reçoit_seulement_une_part_du_réglement_12=new clCompoCheckBox(Réglement_La_facture_reçoit_seulement_une_part_du_réglement_12,null,"La facture reçoit seulement une part du réglement");
var Réglement_Montant_de_la_part_13=new clAttribut("fr_montant","facturereglement",null);


	/* Ce composant représente: facturereglement.fr_montant sous le nom "Montant de la part" */
var Compo_Réglement_Montant_de_la_part_13=new clCompoTextBox(Réglement_Montant_de_la_part_13,null,"Montant de la part",false,false);
var Réglement_Factures_concernées_9=new clEnsembleAttributs("facturereglement",
	new Array(
	new clLiaison(Joint_Col_N0_N__Fact__De_Réglement_Factures_concernées_9,Col_N0_N__Fact__De_Réglement_Factures_concernées_9)
	,new clLiaison(Joint_Col_N1_Date_De_Réglement_Factures_concernées_9,Col_N1_Date_De_Réglement_Factures_concernées_9)
	,new clLiaison(Joint_Col_N2_F_Mnt__De_Réglement_Factures_concernées_9,Col_N2_F_Mnt__De_Réglement_Factures_concernées_9)
	,new clLiaison(null,Col_N3_Mnt__De_Réglement_Factures_concernées_9)
	),
	new Array(
	new clLiaison(Joint_Esclave_Réglement_Facture_10,Réglement_Facture_10)
	,new clLiaison(null,Réglement_Acompte_11)
	,new clLiaison(null,Réglement_La_facture_reçoit_seulement_une_part_du_réglement_12)
	,new clLiaison(null,Réglement_Montant_de_la_part_13)
	));

var Titre_Réglement_Factures_concernées_9=new Array("N° Fact.","Date","F.Mnt.","Mnt.");

	/* Ce composant représente: des éléments de la table facturereglement sous le nom "Factures concernées" */
var Compo_Réglement_Factures_concernées_9=new clCompoListe(Réglement_Factures_concernées_9,null,Titre_Réglement_Factures_concernées_9,"Factures concernées",true,false);
var Joint_Esclave_Réglement_Factures_concernées_9=new clJointureMulti("reglement",
	new Array(
	new stJointure("facturereglement","rg_numero","rg_numero",null,false)
	));
var Col_N0_Montant_De_Réglement_Dont_reversements____14=new clAttribut("rp_montant","repartition",null);

var Col_N1_Vers_De_Réglement_Dont_reversements____14=new clAttribut("mp_libelle","moderepartition",null);

var Joint_Col_N1_Vers_De_Réglement_Dont_reversements____14=new clJointureMulti("repartition",
	new Array(
	new stJointure("moderepartition","mp_numero","mp_numero",null,true)
	));
var Réglement_Montant_15=new clAttribut("rp_montant","repartition",null);


	/* Ce composant représente: repartition.rp_montant sous le nom "Montant" */
var Compo_Réglement_Montant_15=new clCompoTextBox(Réglement_Montant_15,null,"Montant",false,false);
var Réglement_Vers_16=new clAttribut("mp_libelle","moderepartition",null);


	/* Ce composant représente: moderepartition.mp_libelle sous le nom "Vers" */
var Compo_Réglement_Vers_16=new clCompoListeDeroulanteSimple(Réglement_Vers_16,null,"Vers");
var Joint_Esclave_Réglement_Vers_16=new clJointureMulti("repartition",
	new Array(
	new stJointure("moderepartition","mp_numero","mp_numero",null,false)
	));
var Réglement_Dont_reversements____14=new clEnsembleAttributs("repartition",
	new Array(
	new clLiaison(null,Col_N0_Montant_De_Réglement_Dont_reversements____14)
	,new clLiaison(Joint_Col_N1_Vers_De_Réglement_Dont_reversements____14,Col_N1_Vers_De_Réglement_Dont_reversements____14)
	),
	new Array(
	new clLiaison(null,Réglement_Montant_15)
	,new clLiaison(Joint_Esclave_Réglement_Vers_16,Réglement_Vers_16)
	));

var Titre_Réglement_Dont_reversements____14=new Array("Montant","Vers");

	/* Ce composant représente: des éléments de la table repartition sous le nom "Dont reversements..." */
var Compo_Réglement_Dont_reversements____14=new clCompoListe(Réglement_Dont_reversements____14,null,Titre_Réglement_Dont_reversements____14,"Dont reversements...",true,false);
var Joint_Esclave_Réglement_Dont_reversements____14=new clJointureMulti("reglement",
	new Array(
...
var Réglement_Liste_des_réglements0=new clEnsembleAttributs("reglement",
	...
	,new clLiaison(null,Réglement_Remise_de_chèque_8)
	,new clLiaison(Joint_Esclave_Réglement_Factures_concernées_9,Réglement_Factures_concernées_9)
	,new clLiaison(Joint_Esclave_Réglement_Dont_reversements____14,Réglement_Dont_reversements____14)
	));
...
Compo_Réglement_Liste_des_réglements0.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0"));
	...
	/* On l'ajoute au tableau global à l'indice 577*/
top.TAB_GLOBAL_COMPO[577]=Compo_Réglement_Liste_des_réglements0;
...
top.TAB_GLOBAL_COMPO[581]=Compo_Réglement_Date_1;
...
top.TAB_GLOBAL_COMPO[582]=Compo_Réglement_Montant_2;
...
top.TAB_GLOBAL_COMPO[583]=Compo_Réglement_Mode_3;
...
Compo_Réglement_Banque_4.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 584*/
top.TAB_GLOBAL_COMPO[584]=Compo_Réglement_Banque_4;
...
Compo_Réglement_N__compte_5.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 585*/
top.TAB_GLOBAL_COMPO[585]=Compo_Réglement_N__compte_5;
...
top.TAB_GLOBAL_COMPO[586]=Compo_Réglement_Référence_6;
...
top.TAB_GLOBAL_COMPO[587]=Compo_Réglement_Responsable_7;

	/* Ce composant représente: des éléments de la table reglement sous le nom "Remise de chèque" */
 if(ALeDroit(0,"reglement"))
 {
Compo_Réglement_Remise_de_chèque_8.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 588*/
top.TAB_GLOBAL_COMPO[588]=Compo_Réglement_Remise_de_chèque_8;

	/* Ce composant représente: facturereglement.undefined sous le nom "Factures concernées" */
 if(ALeDroit(0,"facturereglement"))
 {
Compo_Réglement_Factures_concernées_9.GenererXUL(top.document.getElementById("Réglement_Factures_concernées_9"));

 }

	/* On l'ajoute au tableau global à l'indice 589*/
top.TAB_GLOBAL_COMPO[589]=Compo_Réglement_Factures_concernées_9;

	/* Ce composant représente: des éléments de la table facture sous le nom "Facture" */
 if(ALeDroit(0,"facture"))
 {
Compo_Réglement_Facture_10.GenererXUL(top.document.getElementById("Réglement_Factures_concernées_9_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 594*/
top.TAB_GLOBAL_COMPO[594]=Compo_Réglement_Facture_10;

	/* Ce composant représente: des éléments de la table facturereglement sous le nom "Acompte" */
 if(ALeDroit(0,"facturereglement"))
 {
Compo_Réglement_Acompte_11.GenererXUL(top.document.getElementById("Réglement_Factures_concernées_9_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 595*/
top.TAB_GLOBAL_COMPO[595]=Compo_Réglement_Acompte_11;
 ...
 if(ALeDroit(0,"facturereglement"))
 {
Compo_Réglement_La_facture_reçoit_seulement_une_part_du_réglement_12.GenererXUL(top.document.getElementById("Réglement_Factures_concernées_9_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 596*/
top.TAB_GLOBAL_COMPO[596]=Compo_Réglement_La_facture_reçoit_seulement_une_part_du_réglement_12;

	/* Ce composant représente: des éléments de la table facturereglement sous le nom "Montant de la part" */
 if(ALeDroit(0,"facturereglement"))
 {
Compo_Réglement_Montant_de_la_part_13.GenererXUL(top.document.getElementById("Réglement_Factures_concernées_9_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 597*/
top.TAB_GLOBAL_COMPO[597]=Compo_Réglement_Montant_de_la_part_13;

	/* Ce composant représente: repartition.undefined sous le nom "Dont reversements..." */
 if(ALeDroit(0,"repartition"))
 {
Compo_Réglement_Dont_reversements____14.GenererXUL(top.document.getElementById("Réglement_Dont_reversements____14"));

 }

	/* On l'ajoute au tableau global à l'indice 598*/
top.TAB_GLOBAL_COMPO[598]=Compo_Réglement_Dont_reversements____14;

	/* Ce composant représente: des éléments de la table repartition sous le nom "Montant" */
 if(ALeDroit(0,"repartition"))
 {
Compo_Réglement_Montant_15.GenererXUL(top.document.getElementById("Réglement_Dont_reversements____14_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 601*/
top.TAB_GLOBAL_COMPO[601]=Compo_Réglement_Montant_15;

	/* Ce composant représente: des éléments de la table moderepartition sous le nom "Vers" */
 if(ALeDroit(0,"moderepartition"))
 {
Compo_Réglement_Vers_16.GenererXUL(top.document.getElementById("Réglement_Dont_reversements____14_Slaves"));

 }

	/* On l'ajoute au tableau global à l'indice 602*/
top.TAB_GLOBAL_COMPO[602]=Compo_Réglement_Vers_16;
...
top.TAB_GLOBAL_COMPO[615]=Compo_Bordereaux_de_réglements_Liste_des_bordereaux_de_remise_en_banque0;
...
top.TAB_GLOBAL_COMPO[621]=Compo_Bordereaux_de_réglements_Employé_e__1;
...
top.TAB_GLOBAL_COMPO[622]=Compo_Bordereaux_de_réglements_Mode_reg__2;
...
Compo_Bordereaux_de_réglements_Commentaire_3.GenererXUL(top.document.getElementById("Bordereaux_de_réglements_Liste_des_bordereaux_de_remise_en_banque0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 623*/
top.TAB_GLOBAL_COMPO[623]=Compo_Bordereaux_de_réglements_Commentaire_3;
...
Compo_Bordereaux_de_réglements_Liste_des_règlements_4.GenererXUL(top.document.getElementById("Bordereaux_de_réglements_Liste_des_règlements_4"));
	...
	/* On l'ajoute au tableau global à l'indice 624*/
top.TAB_GLOBAL_COMPO[624]=Compo_Bordereaux_de_réglements_Liste_des_règlements_4;
...
Compo_Cotisations_Société_2.GenererXUL(top.document.getElementById("Cotisations_Liste_des_cotisations0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 610*/
top.TAB_GLOBAL_COMPO[610]=Compo_Cotisations_Société_2;
...
top.TAB_GLOBAL_COMPO[612]=Compo_Cotisations_Année_4;
...
top.TAB_GLOBAL_COMPO[614]=Compo_Cotisations_Détail_6;
...
Filtre_Dep_Réglement_0.setComposant(TAB_GLOBAL_COMPO[577],null);
Filtre_DepFor_Réglement_1.setComposant(TAB_GLOBAL_COMPO[577],null);
...
nb_button++;
 ...
 {
top.document.getElementById("Insert_Facture_Règlements_13").hidden=true;
...
nb_button++;
 ...
 {
top.document.getElementById("Delete_Facture_Règlements_13").hidden=true;
...
nb_button++;
 ...
 {
top.document.getElementById("Update_Facture_Règlements_13").hidden=true;

 }
if (nb_button==0)
{
        top.document.getElementById("Validate_Facture_Règlements_13").hidden=true;
        top.document.getElementById("Annuler_Facture_Règlements_13").hidden=true;
}
var nb_button=0
 if(ALeDroit(2,"routage"))
 {
...
nb_button++;
 ...
 {
top.document.getElementById("Insert_Réglement_Factures_concernées_9").hidden=true;
...
nb_button++;
 ...
 {
top.document.getElementById("Delete_Réglement_Factures_concernées_9").hidden=true;
...
nb_button++;
 ...
 {
top.document.getElementById("Update_Réglement_Factures_concernées_9").hidden=true;

 }
if (nb_button==0)
{
        top.document.getElementById("Validate_Réglement_Factures_concernées_9").hidden=true;
        top.document.getElementById("Annuler_Réglement_Factures_concernées_9").hidden=true;
}
var nb_button=0
...
nb_button++;
 ...
 {
top.document.getElementById("Insert_Réglement_Dont_reversements____14").hidden=true;
...
nb_button++;
 ...
 {
top.document.getElementById("Delete_Réglement_Dont_reversements____14").hidden=true;
...
nb_button++;
 ...
 {
top.document.getElementById("Update_Réglement_Dont_reversements____14").hidden=true;

 }
if (nb_button==0)
{
        top.document.getElementById("Validate_Réglement_Dont_reversements____14").hidden=true;
        top.document.getElementById("Annuler_Réglement_Dont_reversements____14").hidden=true;
}
