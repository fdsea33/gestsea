...
var TAB_COMPO_PPTES = new Array(668);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[632].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[632].NewCle = getNewCle("personne");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[632].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[637];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[638];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[639];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[640];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[641];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[642];
...
top.document.getElementById("Update_Personnes_Adresses_7").disabled=false;
 var Esclave_6=TAB_GLOBAL_COMPO[643];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[632];
...
return TAB_COMPO_PPTES[632].NewCle;
}

function Delete_Personnes_Liste_des_personnes0()
{
 if (TAB_GLOBAL_COMPO[632].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[632].Action_en_cours = DELETE;
...
function Update_Personnes_Liste_des_personnes0()
{
 ...
 TAB_COMPO_PPTES[632].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[632].NewCle = TAB_GLOBAL_COMPO[632].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[632].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[637];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[632].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[632].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[637];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[632].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[632].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[632].Action_en_cours == INSERT)
         {
 ...
 TAB_COMPO_PPTES[643].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[643].NewCle = getNewCle("adresse");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[643].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[648];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[649];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[650];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[651];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[652];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[653];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[654];
 Esclave_6.ActiverComposant(true);
...
top.document.getElementById("Delete_Personnes_Adresses_7").disabled=true;
top.document.getElementById("Update_Personnes_Adresses_7").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[643];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[643].NewCle;
}

function Delete_Personnes_Adresses_7()
{
 if (TAB_GLOBAL_COMPO[643].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[643].Action_en_cours = DELETE;
...
function Update_Personnes_Adresses_7()
{
 ...
 TAB_COMPO_PPTES[643].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[643].NewCle = TAB_GLOBAL_COMPO[643].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[643].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[648];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[643].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[643].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[648];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[649];
...
top.document.getElementById("Update_Personnes_Adresses_7").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[643].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[643].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[655].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[655].NewCle = getNewCle("reglement");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[655].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[660];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[661];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[662];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[663];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[664];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[665];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[666];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[667];
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[655];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[655].NewCle;
}

function Delete_Réglement_Liste_des_réglements0()
{
 if (TAB_GLOBAL_COMPO[655].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[655].Action_en_cours = DELETE;
...
function Update_Réglement_Liste_des_réglements0()
{
 ...
 TAB_COMPO_PPTES[655].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[655].NewCle = TAB_GLOBAL_COMPO[655].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[655].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[660];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[655].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[655].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[660];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[661];
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[655].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[655].Action_en_cours = null;
 return NewCle;
}
...
top.TAB_GLOBAL_COMPO[632]=Compo_Personnes_Liste_des_personnes0;
...
Compo_Personnes_Numéro_1.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 637*/
top.TAB_GLOBAL_COMPO[637]=Compo_Personnes_Numéro_1;
...
Compo_Personnes_Titre_ou_F_J__2.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 638*/
top.TAB_GLOBAL_COMPO[638]=Compo_Personnes_Titre_ou_F_J__2;
...
Compo_Personnes_Nom_ou_D_S__3.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 639*/
top.TAB_GLOBAL_COMPO[639]=Compo_Personnes_Nom_ou_D_S__3;
...
Compo_Personnes_Prénom_4.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 640*/
top.TAB_GLOBAL_COMPO[640]=Compo_Personnes_Prénom_4;
...
top.TAB_GLOBAL_COMPO[641]=Compo_Personnes_N_TVA_intrac__5;
...
top.TAB_GLOBAL_COMPO[642]=Compo_Personnes_Né_e__le_6;
...
top.TAB_GLOBAL_COMPO[643]=Compo_Personnes_Adresses_7;
...
top.TAB_GLOBAL_COMPO[648]=Compo_Personnes_Type_8;
...
Compo_Personnes_Apt_ou_Dest__9.GenererXUL(top.document.getElementById("Personnes_Adresses_7_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 649*/
top.TAB_GLOBAL_COMPO[649]=Compo_Personnes_Apt_ou_Dest__9;
...
Compo_Personnes_Bat__étage____10.GenererXUL(top.document.getElementById("Personnes_Adresses_7_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 650*/
top.TAB_GLOBAL_COMPO[650]=Compo_Personnes_Bat__étage____10;
...
top.TAB_GLOBAL_COMPO[651]=Compo_Personnes_N__et_Voie_11;
...
top.TAB_GLOBAL_COMPO[652]=Compo_Personnes_BP_ou_Lieu_dit_12;
...
top.TAB_GLOBAL_COMPO[653]=Compo_Personnes_Code_postal_13;
...
top.TAB_GLOBAL_COMPO[654]=Compo_Personnes_Ville_14;
...
top.TAB_GLOBAL_COMPO[655]=Compo_Réglement_Liste_des_réglements0;
...
top.TAB_GLOBAL_COMPO[660]=Compo_Réglement_Personne_1;
...
top.TAB_GLOBAL_COMPO[661]=Compo_Réglement_Date_2;
...
top.TAB_GLOBAL_COMPO[662]=Compo_Réglement_Montant_3;
...
top.TAB_GLOBAL_COMPO[663]=Compo_Réglement_Mode_4;
...
top.TAB_GLOBAL_COMPO[664]=Compo_Réglement_Banque_5;
...
top.TAB_GLOBAL_COMPO[665]=Compo_Réglement_N__compte_6;
...
top.TAB_GLOBAL_COMPO[666]=Compo_Réglement_Référence_7;
...
top.TAB_GLOBAL_COMPO[667]=Compo_Réglement_Responsable_8;
 if(ALeDroit(5,"personne"))
 {
/* On refresh les composants non dépendents de l'onget Personnes*/
var Composant_0 = TAB_GLOBAL_COMPO[632];
if (Composant_0!=null){
...
var Composant_0 = TAB_GLOBAL_COMPO[655];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
