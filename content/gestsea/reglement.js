...
var TAB_COMPO_PPTES = new Array(686);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[651].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[651].NewCle = getNewCle("personne");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[651].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[656];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[657];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[658];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[659];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[660];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[661];
...
top.document.getElementById("Update_Personnes_Adresses_7").disabled=false;
 var Esclave_6=TAB_GLOBAL_COMPO[662];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[651];
...
return TAB_COMPO_PPTES[651].NewCle;
}

function Delete_Personnes_Liste_des_personnes0()
{
 if (TAB_GLOBAL_COMPO[651].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[651].Action_en_cours = DELETE;
...
function Update_Personnes_Liste_des_personnes0()
{
 ...
 TAB_COMPO_PPTES[651].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[651].NewCle = TAB_GLOBAL_COMPO[651].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[651].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[656];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[651].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[651].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[656];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[651].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[651].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[651].Action_en_cours == INSERT)
         {
 ...
 TAB_COMPO_PPTES[662].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[662].NewCle = getNewCle("adresse");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[662].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[666];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[667];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[668];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[669];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[670];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[671];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[672];
 Esclave_6.ActiverComposant(true);
...
top.document.getElementById("Delete_Personnes_Adresses_7").disabled=true;
top.document.getElementById("Update_Personnes_Adresses_7").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[662];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[662].NewCle;
}

function Delete_Personnes_Adresses_7()
{
 if (TAB_GLOBAL_COMPO[662].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[662].Action_en_cours = DELETE;
...
function Update_Personnes_Adresses_7()
{
 ...
 TAB_COMPO_PPTES[662].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[662].NewCle = TAB_GLOBAL_COMPO[662].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[662].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[666];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[662].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[662].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[666];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[667];
...
top.document.getElementById("Update_Personnes_Adresses_7").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[662].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[662].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[673].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[673].NewCle = getNewCle("reglement");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[673].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[678];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[679];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[680];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[681];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[682];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[683];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[684];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[685];
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[673];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[673].NewCle;
}

function Delete_Réglement_Liste_des_réglements0()
{
 if (TAB_GLOBAL_COMPO[673].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[673].Action_en_cours = DELETE;
...
function Update_Réglement_Liste_des_réglements0()
{
 ...
 TAB_COMPO_PPTES[673].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[673].NewCle = TAB_GLOBAL_COMPO[673].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[673].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[678];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[673].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[673].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[678];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[679];
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[673].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[673].Action_en_cours = null;
 return NewCle;
}
...
Compo_Personnes_Liste_des_personnes0.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0"));
	...
	/* On l'ajoute au tableau global à l'indice 651*/
top.TAB_GLOBAL_COMPO[651]=Compo_Personnes_Liste_des_personnes0;
...
top.TAB_GLOBAL_COMPO[656]=Compo_Personnes_Numéro_1;
...
top.TAB_GLOBAL_COMPO[657]=Compo_Personnes_Titre_ou_F_J__2;
...
top.TAB_GLOBAL_COMPO[658]=Compo_Personnes_Nom_ou_D_S__3;
...
top.TAB_GLOBAL_COMPO[659]=Compo_Personnes_Prénom_4;
...
top.TAB_GLOBAL_COMPO[660]=Compo_Personnes_N_TVA_intrac__5;
...
top.TAB_GLOBAL_COMPO[661]=Compo_Personnes_Né_e__le_6;
...
top.TAB_GLOBAL_COMPO[662]=Compo_Personnes_Adresses_7;
...
top.TAB_GLOBAL_COMPO[666]=Compo_Personnes_Type_8;
...
top.TAB_GLOBAL_COMPO[667]=Compo_Personnes_Apt_ou_Dest__9;
...
top.TAB_GLOBAL_COMPO[668]=Compo_Personnes_Bat__étage____10;
...
top.TAB_GLOBAL_COMPO[669]=Compo_Personnes_N__et_Voie_11;
...
top.TAB_GLOBAL_COMPO[670]=Compo_Personnes_BP_ou_Lieu_dit_12;
...
top.TAB_GLOBAL_COMPO[671]=Compo_Personnes_Code_postal_13;
...
top.TAB_GLOBAL_COMPO[672]=Compo_Personnes_Ville_14;
...
top.TAB_GLOBAL_COMPO[673]=Compo_Réglement_Liste_des_réglements0;
...
top.TAB_GLOBAL_COMPO[678]=Compo_Réglement_Personne_1;
...
top.TAB_GLOBAL_COMPO[679]=Compo_Réglement_Date_2;
...
top.TAB_GLOBAL_COMPO[680]=Compo_Réglement_Montant_3;
...
top.TAB_GLOBAL_COMPO[681]=Compo_Réglement_Mode_4;
...
top.TAB_GLOBAL_COMPO[682]=Compo_Réglement_Banque_5;
...
top.TAB_GLOBAL_COMPO[683]=Compo_Réglement_N__compte_6;
...
top.TAB_GLOBAL_COMPO[684]=Compo_Réglement_Référence_7;
...
top.TAB_GLOBAL_COMPO[685]=Compo_Réglement_Responsable_8;
 if(ALeDroit(5,"personne"))
 {
/* On refresh les composants non dépendents de l'onget Personnes*/
var Composant_0 = TAB_GLOBAL_COMPO[651];
if (Composant_0!=null){
...
var Composant_0 = TAB_GLOBAL_COMPO[673];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
