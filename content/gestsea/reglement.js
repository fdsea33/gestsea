...
var TAB_COMPO_PPTES = new Array(1541);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[1505].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1505].NewCle = getNewCle("personne");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1505].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1510];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1511];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[1512];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[1513];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[1514];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[1515];
...
top.document.getElementById("Update_Personnes_Adresses_7").disabled=false;
 var Esclave_6=TAB_GLOBAL_COMPO[1516];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1505];
...
return TAB_COMPO_PPTES[1505].NewCle;
}

function Delete_Personnes_Liste_des_personnes0()
{
 if (TAB_GLOBAL_COMPO[1505].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[1505].Action_en_cours = DELETE;
...
function Update_Personnes_Liste_des_personnes0()
{
 ...
 TAB_COMPO_PPTES[1505].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1505].NewCle = TAB_GLOBAL_COMPO[1505].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1505].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1510];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1505].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1505].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1510];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1505].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1505].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[1505].Action_en_cours == INSERT)
         {
 ...
 TAB_COMPO_PPTES[1516].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1516].NewCle = getNewCle("adresse");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1516].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1521];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1522];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[1523];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[1524];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[1525];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[1526];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[1527];
 Esclave_6.ActiverComposant(true);
...
top.document.getElementById("Delete_Personnes_Adresses_7").disabled=true;
top.document.getElementById("Update_Personnes_Adresses_7").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1516];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[1516].NewCle;
}

function Delete_Personnes_Adresses_7()
{
 if (TAB_GLOBAL_COMPO[1516].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[1516].Action_en_cours = DELETE;
...
function Update_Personnes_Adresses_7()
{
 ...
 TAB_COMPO_PPTES[1516].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1516].NewCle = TAB_GLOBAL_COMPO[1516].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1516].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1521];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1516].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1516].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1521];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[1522];
...
top.document.getElementById("Update_Personnes_Adresses_7").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1516].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1516].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[1528].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1528].NewCle = getNewCle("reglement");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1528].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1533];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1534];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[1535];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[1536];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[1537];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[1538];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[1539];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[1540];
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1528];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[1528].NewCle;
}

function Delete_Réglement_Liste_des_réglements0()
{
 if (TAB_GLOBAL_COMPO[1528].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[1528].Action_en_cours = DELETE;
...
function Update_Réglement_Liste_des_réglements0()
{
 ...
 TAB_COMPO_PPTES[1528].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1528].NewCle = TAB_GLOBAL_COMPO[1528].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1528].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1533];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1528].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1528].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1533];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[1534];
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1528].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1528].Action_en_cours = null;
 return NewCle;
}
...
Compo_Personnes_Liste_des_personnes0.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0"));
	...
	/* On l'ajoute au tableau global à l'indice 1505*/
top.TAB_GLOBAL_COMPO[1505]=Compo_Personnes_Liste_des_personnes0;
...
Compo_Personnes_Numéro_1.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1510*/
top.TAB_GLOBAL_COMPO[1510]=Compo_Personnes_Numéro_1;
...
Compo_Personnes_Titre_ou_F_J__2.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1511*/
top.TAB_GLOBAL_COMPO[1511]=Compo_Personnes_Titre_ou_F_J__2;
...
Compo_Personnes_Nom_ou_D_S__3.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1512*/
top.TAB_GLOBAL_COMPO[1512]=Compo_Personnes_Nom_ou_D_S__3;
...
Compo_Personnes_Prénom_4.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1513*/
top.TAB_GLOBAL_COMPO[1513]=Compo_Personnes_Prénom_4;
...
Compo_Personnes_N_TVA_intrac__5.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1514*/
top.TAB_GLOBAL_COMPO[1514]=Compo_Personnes_N_TVA_intrac__5;
...
Compo_Personnes_Né_e__le_6.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1515*/
top.TAB_GLOBAL_COMPO[1515]=Compo_Personnes_Né_e__le_6;
...
Compo_Personnes_Adresses_7.GenererXUL(top.document.getElementById("Personnes_Adresses_7"));
	...
	/* On l'ajoute au tableau global à l'indice 1516*/
top.TAB_GLOBAL_COMPO[1516]=Compo_Personnes_Adresses_7;
...
Compo_Personnes_Type_8.GenererXUL(top.document.getElementById("Personnes_Adresses_7_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1521*/
top.TAB_GLOBAL_COMPO[1521]=Compo_Personnes_Type_8;
...
Compo_Personnes_Apt_ou_Dest__9.GenererXUL(top.document.getElementById("Personnes_Adresses_7_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1522*/
top.TAB_GLOBAL_COMPO[1522]=Compo_Personnes_Apt_ou_Dest__9;
...
Compo_Personnes_Bat__étage____10.GenererXUL(top.document.getElementById("Personnes_Adresses_7_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1523*/
top.TAB_GLOBAL_COMPO[1523]=Compo_Personnes_Bat__étage____10;
...
Compo_Personnes_N__et_Voie_11.GenererXUL(top.document.getElementById("Personnes_Adresses_7_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1524*/
top.TAB_GLOBAL_COMPO[1524]=Compo_Personnes_N__et_Voie_11;
...
Compo_Personnes_BP_ou_Lieu_dit_12.GenererXUL(top.document.getElementById("Personnes_Adresses_7_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1525*/
top.TAB_GLOBAL_COMPO[1525]=Compo_Personnes_BP_ou_Lieu_dit_12;
...
Compo_Personnes_Code_postal_13.GenererXUL(top.document.getElementById("Personnes_Adresses_7_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1526*/
top.TAB_GLOBAL_COMPO[1526]=Compo_Personnes_Code_postal_13;
...
Compo_Personnes_Ville_14.GenererXUL(top.document.getElementById("Personnes_Adresses_7_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1527*/
top.TAB_GLOBAL_COMPO[1527]=Compo_Personnes_Ville_14;
...
Compo_Réglement_Liste_des_réglements0.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0"));
	...
	/* On l'ajoute au tableau global à l'indice 1528*/
top.TAB_GLOBAL_COMPO[1528]=Compo_Réglement_Liste_des_réglements0;
...
Compo_Réglement_Personne_1.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1533*/
top.TAB_GLOBAL_COMPO[1533]=Compo_Réglement_Personne_1;
...
Compo_Réglement_Date_2.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1534*/
top.TAB_GLOBAL_COMPO[1534]=Compo_Réglement_Date_2;
...
Compo_Réglement_Montant_3.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1535*/
top.TAB_GLOBAL_COMPO[1535]=Compo_Réglement_Montant_3;
...
Compo_Réglement_Mode_4.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1536*/
top.TAB_GLOBAL_COMPO[1536]=Compo_Réglement_Mode_4;
...
Compo_Réglement_Banque_5.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1537*/
top.TAB_GLOBAL_COMPO[1537]=Compo_Réglement_Banque_5;
...
Compo_Réglement_N__compte_6.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1538*/
top.TAB_GLOBAL_COMPO[1538]=Compo_Réglement_N__compte_6;
...
Compo_Réglement_Référence_7.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1539*/
top.TAB_GLOBAL_COMPO[1539]=Compo_Réglement_Référence_7;
...
Compo_Réglement_Responsable_8.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1540*/
top.TAB_GLOBAL_COMPO[1540]=Compo_Réglement_Responsable_8;
 if(ALeDroit(5,"personne"))
 {
/* On refresh les composants non dépendents de l'onget Personnes*/
var Composant_0 = TAB_GLOBAL_COMPO[1505];
if (Composant_0!=null){
...
var Composant_0 = TAB_GLOBAL_COMPO[1528];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
