...
var TAB_COMPO_PPTES = new Array(693);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[680].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[680].NewCle = getNewCle("reglement");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[680].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[685];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[686];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[687];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[688];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[689];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[690];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[691];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[692];
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[680];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[680].NewCle;
}

function Delete_Réglement_Liste_des_réglements0()
{
 if (TAB_GLOBAL_COMPO[680].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[680].Action_en_cours = DELETE;
...
function Update_Réglement_Liste_des_réglements0()
{
 ...
 TAB_COMPO_PPTES[680].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[680].NewCle = TAB_GLOBAL_COMPO[680].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[680].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[685];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[680].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[680].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[685];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[686];
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[680].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[680].Action_en_cours = null;
 return NewCle;
}
...
top.TAB_GLOBAL_COMPO[669]=Compo_Personnes_Adresses_7;
...
top.TAB_GLOBAL_COMPO[673]=Compo_Personnes_Type_8;
...
top.TAB_GLOBAL_COMPO[674]=Compo_Personnes_Apt_ou_Dest__9;
...
top.TAB_GLOBAL_COMPO[675]=Compo_Personnes_Bat__étage____10;
...
top.TAB_GLOBAL_COMPO[676]=Compo_Personnes_N__et_Voie_11;
...
top.TAB_GLOBAL_COMPO[677]=Compo_Personnes_BP_ou_Lieu_dit_12;
...
top.TAB_GLOBAL_COMPO[678]=Compo_Personnes_Code_postal_13;
...
top.TAB_GLOBAL_COMPO[679]=Compo_Personnes_Ville_14;
...
top.TAB_GLOBAL_COMPO[680]=Compo_Réglement_Liste_des_réglements0;
...
top.TAB_GLOBAL_COMPO[685]=Compo_Réglement_Personne_1;
...
top.TAB_GLOBAL_COMPO[686]=Compo_Réglement_Date_2;
...
top.TAB_GLOBAL_COMPO[687]=Compo_Réglement_Montant_3;
...
top.TAB_GLOBAL_COMPO[688]=Compo_Réglement_Mode_4;
...
top.TAB_GLOBAL_COMPO[689]=Compo_Réglement_Banque_5;
...
top.TAB_GLOBAL_COMPO[690]=Compo_Réglement_N__compte_6;
...
top.TAB_GLOBAL_COMPO[691]=Compo_Réglement_Référence_7;
...
top.TAB_GLOBAL_COMPO[692]=Compo_Réglement_Responsable_8;
...
var Composant_0 = TAB_GLOBAL_COMPO[680];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
