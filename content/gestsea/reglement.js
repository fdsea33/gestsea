...
var TAB_COMPO_PPTES = new Array(1370);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[1332].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1332].NewCle = getNewCle("personne");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1332].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1337];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1338];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[1339];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[1340];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[1341];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[1342];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[1343];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[1344];
...
top.document.getElementById("Update_Personnes_Adresses_9").disabled=false;
 var Esclave_8=TAB_GLOBAL_COMPO[1345];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1332];
...
return TAB_COMPO_PPTES[1332].NewCle;
}

function Delete_Personnes_Liste_des_personnes0()
{
 if (TAB_GLOBAL_COMPO[1332].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[1332].Action_en_cours = DELETE;
...
function Update_Personnes_Liste_des_personnes0()
{
 ...
 TAB_COMPO_PPTES[1332].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1332].NewCle = TAB_GLOBAL_COMPO[1332].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1332].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1337];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1332].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1332].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1337];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1332].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1332].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[1332].Action_en_cours == INSERT)
         {
 ...
 TAB_COMPO_PPTES[1345].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1345].NewCle = getNewCle("adresse");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1345].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1350];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1351];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[1352];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[1353];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[1354];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[1355];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[1356];
 Esclave_6.ActiverComposant(true);
...
top.document.getElementById("Delete_Personnes_Adresses_9").disabled=true;
top.document.getElementById("Update_Personnes_Adresses_9").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1345];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[1345].NewCle;
}

function Delete_Personnes_Adresses_9()
{
 if (TAB_GLOBAL_COMPO[1345].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[1345].Action_en_cours = DELETE;
...
function Update_Personnes_Adresses_9()
{
 ...
 TAB_COMPO_PPTES[1345].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1345].NewCle = TAB_GLOBAL_COMPO[1345].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1345].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1350];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1345].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1345].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1350];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[1351];
...
top.document.getElementById("Update_Personnes_Adresses_9").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1345].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1345].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[1357].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1357].NewCle = getNewCle("reglement");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1357].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1362];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1363];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[1364];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[1365];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[1366];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[1367];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[1368];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[1369];
 Esclave_7.ActiverComposant(true);
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1357];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[1357].NewCle;
}

function Delete_Réglement_Liste_des_réglements0()
{
 if (TAB_GLOBAL_COMPO[1357].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[1357].Action_en_cours = DELETE;
...
function Update_Réglement_Liste_des_réglements0()
{
 ...
 TAB_COMPO_PPTES[1357].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1357].NewCle = TAB_GLOBAL_COMPO[1357].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1357].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1362];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1357].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1357].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1362];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[1363];
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1357].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1357].Action_en_cours = null;
 return NewCle;
}
...
Compo_Personnes_Liste_des_personnes0.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0"));
	...
	/* On l'ajoute au tableau global à l'indice 1332*/
top.TAB_GLOBAL_COMPO[1332]=Compo_Personnes_Liste_des_personnes0;
...
Compo_Personnes_Numéro_1.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1337*/
top.TAB_GLOBAL_COMPO[1337]=Compo_Personnes_Numéro_1;
...
Compo_Personnes_Titre_ou_F_J__2.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1338*/
top.TAB_GLOBAL_COMPO[1338]=Compo_Personnes_Titre_ou_F_J__2;
...
Compo_Personnes_Nom_ou_D_S__3.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1339*/
top.TAB_GLOBAL_COMPO[1339]=Compo_Personnes_Nom_ou_D_S__3;
...
Compo_Personnes_Prénom_4.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1340*/
top.TAB_GLOBAL_COMPO[1340]=Compo_Personnes_Prénom_4;
...
Compo_Personnes_N_TVA_intrac__5.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1341*/
top.TAB_GLOBAL_COMPO[1341]=Compo_Personnes_N_TVA_intrac__5;
...
Compo_Personnes_Né_e__le_6.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1342*/
top.TAB_GLOBAL_COMPO[1342]=Compo_Personnes_Né_e__le_6;
...
Compo_Personnes_Etat_7.GenererXUL(top.document.getElementById("Personnes_Liste_des_personnes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1343*/
top.TAB_GLOBAL_COMPO[1343]=Compo_Personnes_Etat_7;
...
top.TAB_GLOBAL_COMPO[1344]=Compo_Personnes_Type_8;
...
Compo_Personnes_Adresses_9.GenererXUL(top.document.getElementById("Personnes_Adresses_9"));
	...
	/* On l'ajoute au tableau global à l'indice 1345*/
top.TAB_GLOBAL_COMPO[1345]=Compo_Personnes_Adresses_9;
...
top.TAB_GLOBAL_COMPO[1350]=Compo_Personnes_Type_10;
...
Compo_Personnes_Apt_ou_Dest__11.GenererXUL(top.document.getElementById("Personnes_Adresses_9_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1351*/
top.TAB_GLOBAL_COMPO[1351]=Compo_Personnes_Apt_ou_Dest__11;
...
Compo_Personnes_Bat__étage____12.GenererXUL(top.document.getElementById("Personnes_Adresses_9_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1352*/
top.TAB_GLOBAL_COMPO[1352]=Compo_Personnes_Bat__étage____12;
...
Compo_Personnes_N__et_Voie_13.GenererXUL(top.document.getElementById("Personnes_Adresses_9_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1353*/
top.TAB_GLOBAL_COMPO[1353]=Compo_Personnes_N__et_Voie_13;
...
Compo_Personnes_BP_ou_Lieu_dit_14.GenererXUL(top.document.getElementById("Personnes_Adresses_9_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1354*/
top.TAB_GLOBAL_COMPO[1354]=Compo_Personnes_BP_ou_Lieu_dit_14;
...
Compo_Personnes_Code_postal_15.GenererXUL(top.document.getElementById("Personnes_Adresses_9_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1355*/
top.TAB_GLOBAL_COMPO[1355]=Compo_Personnes_Code_postal_15;
...
top.TAB_GLOBAL_COMPO[1356]=Compo_Personnes_Ville_16;
...
top.TAB_GLOBAL_COMPO[1357]=Compo_Réglement_Liste_des_réglements0;
...
Compo_Réglement_Personne_1.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1362*/
top.TAB_GLOBAL_COMPO[1362]=Compo_Réglement_Personne_1;
...
Compo_Réglement_Date_2.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1363*/
top.TAB_GLOBAL_COMPO[1363]=Compo_Réglement_Date_2;
...
Compo_Réglement_Montant_3.GenererXUL(top.document.getElementById("Réglement_Liste_des_réglements0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1364*/
top.TAB_GLOBAL_COMPO[1364]=Compo_Réglement_Montant_3;
...
top.TAB_GLOBAL_COMPO[1365]=Compo_Réglement_Mode_4;
...
top.TAB_GLOBAL_COMPO[1366]=Compo_Réglement_Banque_5;
...
top.TAB_GLOBAL_COMPO[1367]=Compo_Réglement_N__compte_6;
...
top.TAB_GLOBAL_COMPO[1368]=Compo_Réglement_Référence_7;
...
top.TAB_GLOBAL_COMPO[1369]=Compo_Réglement_Responsable_8;
 if(ALeDroit(5,"personne"))
 {
/* On refresh les composants non dépendents de l'onget Personnes*/
var Composant_0 = TAB_GLOBAL_COMPO[1332];
if (Composant_0!=null){
...
var Composant_0 = TAB_GLOBAL_COMPO[1357];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
