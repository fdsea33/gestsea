...
var TAB_COMPO_PPTES = new Array(685);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[647].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[647].NewCle = getNewCle("personne");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[647].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[652];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[653];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[654];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[655];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[656];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[657];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[658];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[659];
...
top.document.getElementById("Update_Personnes_Adresses_9").disabled=false;
 var Esclave_8=TAB_GLOBAL_COMPO[660];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[647];
...
return TAB_COMPO_PPTES[647].NewCle;
}

function Delete_Personnes_Liste_des_personnes0()
{
 if (TAB_GLOBAL_COMPO[647].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[647].Action_en_cours = DELETE;
...
function Update_Personnes_Liste_des_personnes0()
{
 ...
 TAB_COMPO_PPTES[647].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[647].NewCle = TAB_GLOBAL_COMPO[647].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[647].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[652];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[647].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[647].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[652];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[647].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[647].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[647].Action_en_cours == INSERT)
         {
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[660].NewCle = getNewCle("adresse");
/* On désactive le composant maitre */
...
{
 TAB_COMPO_PPTES[672].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[672].NewCle = getNewCle("reglement");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[672].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 ...
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[684];
 Esclave_7.ActiverComposant(true);
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[672];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[672].NewCle;
}

function Delete_Réglement_Liste_des_réglements0()
{
 if (TAB_GLOBAL_COMPO[672].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[672].Action_en_cours = DELETE;
...
function Update_Réglement_Liste_des_réglements0()
{
 ...
 TAB_COMPO_PPTES[672].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[672].NewCle = TAB_GLOBAL_COMPO[672].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[672].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[677];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[672].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[672].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[677];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[678];
...
top.document.getElementById("Update_Réglement_Liste_des_réglements0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[672].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[672].Action_en_cours = null;
 return NewCle;
}
...
top.TAB_GLOBAL_COMPO[647]=Compo_Personnes_Liste_des_personnes0;
...
top.TAB_GLOBAL_COMPO[652]=Compo_Personnes_Numéro_1;
...
top.TAB_GLOBAL_COMPO[653]=Compo_Personnes_Titre_ou_F_J__2;
...
top.TAB_GLOBAL_COMPO[654]=Compo_Personnes_Nom_ou_D_S__3;
...
top.TAB_GLOBAL_COMPO[655]=Compo_Personnes_Prénom_4;
...
top.TAB_GLOBAL_COMPO[656]=Compo_Personnes_N_TVA_intrac__5;
...
top.TAB_GLOBAL_COMPO[657]=Compo_Personnes_Né_e__le_6;
...
top.TAB_GLOBAL_COMPO[658]=Compo_Personnes_Etat_7;
...
top.TAB_GLOBAL_COMPO[659]=Compo_Personnes_Type_8;
...
top.TAB_GLOBAL_COMPO[660]=Compo_Personnes_Adresses_9;
...
top.TAB_GLOBAL_COMPO[665]=Compo_Personnes_Type_10;
...
top.TAB_GLOBAL_COMPO[666]=Compo_Personnes_Apt_ou_Dest__11;
...
top.TAB_GLOBAL_COMPO[667]=Compo_Personnes_Bat__étage____12;
...
top.TAB_GLOBAL_COMPO[668]=Compo_Personnes_N__et_Voie_13;
...
top.TAB_GLOBAL_COMPO[669]=Compo_Personnes_BP_ou_Lieu_dit_14;
...
top.TAB_GLOBAL_COMPO[670]=Compo_Personnes_Code_postal_15;
...
top.TAB_GLOBAL_COMPO[671]=Compo_Personnes_Ville_16;
...
top.TAB_GLOBAL_COMPO[672]=Compo_Réglement_Liste_des_réglements0;
...
top.TAB_GLOBAL_COMPO[677]=Compo_Réglement_Personne_1;
...
top.TAB_GLOBAL_COMPO[678]=Compo_Réglement_Date_2;
...
top.TAB_GLOBAL_COMPO[679]=Compo_Réglement_Montant_3;
...
top.TAB_GLOBAL_COMPO[680]=Compo_Réglement_Mode_4;
...
top.TAB_GLOBAL_COMPO[681]=Compo_Réglement_Banque_5;
...
top.TAB_GLOBAL_COMPO[682]=Compo_Réglement_N__compte_6;
...
top.TAB_GLOBAL_COMPO[683]=Compo_Réglement_Référence_7;
...
top.TAB_GLOBAL_COMPO[684]=Compo_Réglement_Responsable_8;
 if(ALeDroit(5,"personne"))
 {
/* On refresh les composants non dépendents de l'onget Personnes*/
var Composant_0 = TAB_GLOBAL_COMPO[647];
if (Composant_0!=null){
...
var Composant_0 = TAB_GLOBAL_COMPO[672];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
