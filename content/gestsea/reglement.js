...
var TAB_COMPO_PPTES = new Array(681);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[645].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[645].NewCle = getNewCle("personne");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[645].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[650];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[651];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[652];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[653];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[654];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[655];
...
top.document.getElementById("Update_Personnes_Adresses_7").disabled=false;
 var Esclave_6=TAB_GLOBAL_COMPO[656];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[645];
...
return TAB_COMPO_PPTES[645].NewCle;
}

function Delete_Personnes_Liste_des_personnes0()
{
 if (TAB_GLOBAL_COMPO[645].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[645].Action_en_cours = DELETE;
...
function Update_Personnes_Liste_des_personnes0()
{
 ...
 TAB_COMPO_PPTES[645].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[645].NewCle = TAB_GLOBAL_COMPO[645].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[645].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[650];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[645].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[645].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[650];
...
top.document.getElementById("Update_Personnes_Liste_des_personnes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[645].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[645].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[645].Action_en_cours == INSERT)
         {
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[656].NewCle = getNewCle("adresse");
/* On désactive le composant maitre */
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[668].NewCle = getNewCle("reglement");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[668].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[673];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[674];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[675];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[676];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[677];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[678];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[679];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[680];
...
top.TAB_GLOBAL_COMPO[645]=Compo_Personnes_Liste_des_personnes0;
...
top.TAB_GLOBAL_COMPO[650]=Compo_Personnes_Numéro_1;
...
top.TAB_GLOBAL_COMPO[651]=Compo_Personnes_Titre_ou_F_J__2;
...
top.TAB_GLOBAL_COMPO[652]=Compo_Personnes_Nom_ou_D_S__3;
...
top.TAB_GLOBAL_COMPO[653]=Compo_Personnes_Prénom_4;
...
top.TAB_GLOBAL_COMPO[654]=Compo_Personnes_N_TVA_intrac__5;
...
top.TAB_GLOBAL_COMPO[655]=Compo_Personnes_Né_e__le_6;
...
top.TAB_GLOBAL_COMPO[656]=Compo_Personnes_Adresses_7;
...
top.TAB_GLOBAL_COMPO[661]=Compo_Personnes_Type_8;
...
top.TAB_GLOBAL_COMPO[662]=Compo_Personnes_Apt_ou_Dest__9;
...
top.TAB_GLOBAL_COMPO[663]=Compo_Personnes_Bat__étage____10;
...
top.TAB_GLOBAL_COMPO[664]=Compo_Personnes_N__et_Voie_11;
...
top.TAB_GLOBAL_COMPO[665]=Compo_Personnes_BP_ou_Lieu_dit_12;
...
top.TAB_GLOBAL_COMPO[666]=Compo_Personnes_Code_postal_13;
...
top.TAB_GLOBAL_COMPO[667]=Compo_Personnes_Ville_14;
...
top.TAB_GLOBAL_COMPO[668]=Compo_Réglement_Liste_des_réglements0;
...
top.TAB_GLOBAL_COMPO[673]=Compo_Réglement_Personne_1;
...
top.TAB_GLOBAL_COMPO[674]=Compo_Réglement_Date_2;
...
top.TAB_GLOBAL_COMPO[675]=Compo_Réglement_Montant_3;
...
top.TAB_GLOBAL_COMPO[676]=Compo_Réglement_Mode_4;
...
top.TAB_GLOBAL_COMPO[677]=Compo_Réglement_Banque_5;
...
top.TAB_GLOBAL_COMPO[678]=Compo_Réglement_N__compte_6;
...
top.TAB_GLOBAL_COMPO[679]=Compo_Réglement_Référence_7;
...
top.TAB_GLOBAL_COMPO[680]=Compo_Réglement_Responsable_8;
 if(ALeDroit(5,"personne"))
 {
/* On refresh les composants non dépendents de l'onget Personnes*/
var Composant_0 = TAB_GLOBAL_COMPO[645];
if (Composant_0!=null){
