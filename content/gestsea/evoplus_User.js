...
*/
 ...
 var CleMaitre = TAB_COMPO_PPTES[721].NewCle;
 var NomCleMaitre = DePrefixerChamp(Compo_Maitre.getCle());
 var pe_numero=GetValAt(726);
 if (pe_numero=="-1")
    pe_numero="null";
 if (!ValiderChampsObligatoire(Table,"pe_numero",TAB_GLOBAL_COMPO[726],pe_numero,true))
         return -1;
 var source=GetValAt(727);
 if (!ValiderChampsObligatoire(Table,"source",TAB_GLOBAL_COMPO[727],source,false))
         return -1;
 if (!ValiderChampsType(Table,"source",TAB_GLOBAL_COMPO[727],source))
         return -1;
 var numero=GetValAt(728);
 if (!ValiderChampsObligatoire(Table,"numero",TAB_GLOBAL_COMPO[728],numero,false))
         return -1;
 if (!ValiderChampsType(Table,"numero",TAB_GLOBAL_COMPO[728],numero))
         return -1;
 var titre=GetValAt(729);
 if (!ValiderChampsObligatoire(Table,"titre",TAB_GLOBAL_COMPO[729],titre,false))
         return -1;
 if (!ValiderChampsType(Table,"titre",TAB_GLOBAL_COMPO[729],titre))
         return -1;
 var nom=GetValAt(730);
 if (!ValiderChampsObligatoire(Table,"nom",TAB_GLOBAL_COMPO[730],nom,false))
         return -1;
 if (!ValiderChampsType(Table,"nom",TAB_GLOBAL_COMPO[730],nom))
         return -1;
 var complement=GetValAt(731);
 if (!ValiderChampsObligatoire(Table,"complement",TAB_GLOBAL_COMPO[731],complement,false))
         return -1;
 if (!ValiderChampsType(Table,"complement",TAB_GLOBAL_COMPO[731],complement))
         return -1;
 var ad1=GetValAt(732);
 if (!ValiderChampsObligatoire(Table,"ad1",TAB_GLOBAL_COMPO[732],ad1,false))
         return -1;
 if (!ValiderChampsType(Table,"ad1",TAB_GLOBAL_COMPO[732],ad1))
         return -1;
 var ad2=GetValAt(733);
 if (!ValiderChampsObligatoire(Table,"ad2",TAB_GLOBAL_COMPO[733],ad2,false))
         return -1;
 if (!ValiderChampsType(Table,"ad2",TAB_GLOBAL_COMPO[733],ad2))
         return -1;
 var ad3=GetValAt(734);
 if (!ValiderChampsObligatoire(Table,"ad3",TAB_GLOBAL_COMPO[734],ad3,false))
         return -1;
 if (!ValiderChampsType(Table,"ad3",TAB_GLOBAL_COMPO[734],ad3))
         return -1;
 var cp=GetValAt(735);
 if (!ValiderChampsObligatoire(Table,"cp",TAB_GLOBAL_COMPO[735],cp,false))
         return -1;
 if (!ValiderChampsType(Table,"cp",TAB_GLOBAL_COMPO[735],cp))
         return -1;
 var ville=GetValAt(736);
 if (!ValiderChampsObligatoire(Table,"ville",TAB_GLOBAL_COMPO[736],ville,false))
         return -1;
 if (!ValiderChampsType(Table,"ville",TAB_GLOBAL_COMPO[736],ville))
         return -1;
 var naissance=GetValAt(737);
 if (!ValiderChampsObligatoire(Table,"naissance",TAB_GLOBAL_COMPO[737],naissance,false))
         return -1;
 if (!ValiderChampsType(Table,"naissance",TAB_GLOBAL_COMPO[737],naissance))
         return -1;
 var telephone=GetValAt(738);
 if (!ValiderChampsObligatoire(Table,"telephone",TAB_GLOBAL_COMPO[738],telephone,false))
         return -1;
 if (!ValiderChampsType(Table,"telephone",TAB_GLOBAL_COMPO[738],telephone))
         return -1;
 var fax=GetValAt(739);
 if (!ValiderChampsObligatoire(Table,"fax",TAB_GLOBAL_COMPO[739],fax,false))
         return -1;
 if (!ValiderChampsType(Table,"fax",TAB_GLOBAL_COMPO[739],fax))
         return -1;
 var portable=GetValAt(740);
 if (!ValiderChampsObligatoire(Table,"portable",TAB_GLOBAL_COMPO[740],portable,false))
         return -1;
 if (!ValiderChampsType(Table,"portable",TAB_GLOBAL_COMPO[740],portable))
         return -1;
 var qualification=GetValAt(741);
 if (!ValiderChampsObligatoire(Table,"qualification",TAB_GLOBAL_COMPO[741],qualification,false))
         return -1;
 if (!ValiderChampsType(Table,"qualification",TAB_GLOBAL_COMPO[741],qualification))
         return -1;
 var base_ht=GetValAt(742);
 if (!ValiderChampsObligatoire(Table,"base_ht",TAB_GLOBAL_COMPO[742],base_ht,false))
         return -1;
 if (!ValiderChampsType(Table,"base_ht",TAB_GLOBAL_COMPO[742],base_ht))
         return -1;
 var productions=GetValAt(743);
 if (!ValiderChampsObligatoire(Table,"productions",TAB_GLOBAL_COMPO[743],productions,false))
         return -1;
 if (!ValiderChampsType(Table,"productions",TAB_GLOBAL_COMPO[743],productions))
         return -1;
 var hectares_nb=GetValAt(744);
 if (!ValiderChampsObligatoire(Table,"hectares_nb",TAB_GLOBAL_COMPO[744],hectares_nb,false))
         return -1;
 if (!ValiderChampsType(Table,"hectares_nb",TAB_GLOBAL_COMPO[744],hectares_nb))
         return -1;
 var salaries_nb=GetValAt(745);
 if (!ValiderChampsObligatoire(Table,"salaries_nb",TAB_GLOBAL_COMPO[745],salaries_nb,false))
         return -1;
 if (!ValiderChampsType(Table,"salaries_nb",TAB_GLOBAL_COMPO[745],salaries_nb))
         return -1;
 var sacea_ttc=GetValAt(746);
 if (!ValiderChampsObligatoire(Table,"sacea_ttc",TAB_GLOBAL_COMPO[746],sacea_ttc,false))
         return -1;
 if (!ValiderChampsType(Table,"sacea_ttc",TAB_GLOBAL_COMPO[746],sacea_ttc))
         return -1;
 var cm_nb=GetValAt(747);
 if (!ValiderChampsObligatoire(Table,"cm_nb",TAB_GLOBAL_COMPO[747],cm_nb,false))
         return -1;
 if (!ValiderChampsType(Table,"cm_nb",TAB_GLOBAL_COMPO[747],cm_nb))
         return -1;
 var cm_ht=GetValAt(748);
 if (!ValiderChampsObligatoire(Table,"cm_ht",TAB_GLOBAL_COMPO[748],cm_ht,false))
         return -1;
 if (!ValiderChampsType(Table,"cm_ht",TAB_GLOBAL_COMPO[748],cm_ht))
         return -1;
 var cm_noms=GetValAt(749);
 if (!ValiderChampsObligatoire(Table,"cm_noms",TAB_GLOBAL_COMPO[749],cm_noms,false))
         return -1;
 if (!ValiderChampsType(Table,"cm_noms",TAB_GLOBAL_COMPO[749],cm_noms))
         return -1;
 var opt1=GetValAt(750);
 if (!ValiderChampsObligatoire(Table,"opt1",TAB_GLOBAL_COMPO[750],opt1,false))
         return -1;
 if (!ValiderChampsType(Table,"opt1",TAB_GLOBAL_COMPO[750],opt1))
         return -1;
 var opt2=GetValAt(751);
 if (!ValiderChampsObligatoire(Table,"opt2",TAB_GLOBAL_COMPO[751],opt2,false))
         return -1;
 if (!ValiderChampsType(Table,"opt2",TAB_GLOBAL_COMPO[751],opt2))
         return -1;
 var opt3=GetValAt(752);
 if (!ValiderChampsObligatoire(Table,"opt3",TAB_GLOBAL_COMPO[752],opt3,false))
         return -1;
 if (!ValiderChampsType(Table,"opt3",TAB_GLOBAL_COMPO[752],opt3))
         return -1;
 var opt4=GetValAt(753);
 if (!ValiderChampsObligatoire(Table,"opt4",TAB_GLOBAL_COMPO[753],opt4,false))
         return -1;
 if (!ValiderChampsType(Table,"opt4",TAB_GLOBAL_COMPO[753],opt4))
         return -1;
 var opt_num=GetValAt(754);
 if (!ValiderChampsObligatoire(Table,"opt_num",TAB_GLOBAL_COMPO[754],opt_num,false))
         return -1;
 if (!ValiderChampsType(Table,"opt_num",TAB_GLOBAL_COMPO[754],opt_num))
         return -1;
 var opt_ttc=GetValAt(755);
 if (!ValiderChampsObligatoire(Table,"opt_ttc",TAB_GLOBAL_COMPO[755],opt_ttc,false))
         return -1;
 if (!ValiderChampsType(Table,"opt_ttc",TAB_GLOBAL_COMPO[755],opt_ttc))
         return -1;
 var statut=GetValAt(756);
 if (!ValiderChampsObligatoire(Table,"statut",TAB_GLOBAL_COMPO[756],statut,false))
         return -1;
 if (!ValiderChampsType(Table,"statut",TAB_GLOBAL_COMPO[756],statut))
         return -1;
 var remarque=GetValAt(757);
 if (!ValiderChampsObligatoire(Table,"remarque",TAB_GLOBAL_COMPO[757],remarque,false))
         return -1;
 if (!ValiderChampsType(Table,"remarque",TAB_GLOBAL_COMPO[757],remarque))
         return -1;
