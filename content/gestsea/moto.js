...
var TAB_COMPO_PPTES = new Array(719);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[681].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[681].NewCle = getNewCle("activite");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[681].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 ...
 var Esclave_8=TAB_GLOBAL_COMPO[696];
 Esclave_8.ActiverComposant(true);
 var Esclave_9=TAB_GLOBAL_COMPO[697];
...
top.document.getElementById("Update_Activités_Liste_des_activités0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[681];
...
return TAB_COMPO_PPTES[681].NewCle;
}

function Delete_Activités_Liste_des_activités0()
{
 if (TAB_GLOBAL_COMPO[681].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[681].Action_en_cours = DELETE;
...
function Update_Activités_Liste_des_activités0()
{
 ...
 TAB_COMPO_PPTES[681].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[681].NewCle = TAB_GLOBAL_COMPO[681].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[681].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[688];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[681].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[681].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[688];
...
top.document.getElementById("Update_Activités_Liste_des_activités0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[681].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[681].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[698].NewCle = getNewCle("tache");
/* On désactive le composant maitre */
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[707].NewCle = getNewCle("typesujet");
/* On désactive le composant maitre */
...
top.document.getElementById("Update_Sujets_Sujets_3").disabled=false;
 var Esclave_2=TAB_GLOBAL_COMPO[711];
 Esclave_2.ActiverComposant(true);
...
{
 if (TAB_COMPO_PPTES[707].Action_en_cours == INSERT)
         {
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[711].NewCle = getNewCle("sujet");
/* On désactive le composant maitre */
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[715].NewCle = getNewCle("groupe");
/* On désactive le composant maitre */
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[703].NewCle = getNewCle("lieu");
/* On désactive le composant maitre */
...
top.TAB_GLOBAL_COMPO[681]=Compo_Activités_Liste_des_activités0;
...
top.TAB_GLOBAL_COMPO[688]=Compo_Activités_J_ai_1;
...
top.TAB_GLOBAL_COMPO[689]=Compo_Activités_au_sujet_de_2;
...
top.TAB_GLOBAL_COMPO[690]=Compo_Activités_à_3;
...
top.TAB_GLOBAL_COMPO[691]=Compo_Activités_Pendant__en_minutes__4;
...
top.TAB_GLOBAL_COMPO[692]=Compo_Activités_Le_5;
...
top.TAB_GLOBAL_COMPO[693]=Compo_Activités_de___HH_MM___6;
...
top.TAB_GLOBAL_COMPO[694]=Compo_Activités_à___HH_MM___7;
...
top.TAB_GLOBAL_COMPO[695]=Compo_Activités_Pour_quelle_nature_de_personne___8;
...
top.TAB_GLOBAL_COMPO[696]=Compo_Activités_0__1__2__Valeur__N_facture__devis_____9;
...
top.TAB_GLOBAL_COMPO[697]=Compo_Activités_3__Groupe_10;
...
top.TAB_GLOBAL_COMPO[698]=Compo_Tâches_Liste_des_tâches0;
...
top.TAB_GLOBAL_COMPO[700]=Compo_Tâches_Libellé_1;
...
top.TAB_GLOBAL_COMPO[701]=Compo_Tâches_J_ai_2;
...
top.TAB_GLOBAL_COMPO[702]=Compo_Tâches_Notes_3;
...
top.TAB_GLOBAL_COMPO[707]=Compo_Sujets_Liste_des_types_de_sujets0;
...
top.TAB_GLOBAL_COMPO[709]=Compo_Sujets_Libellé_1;
...
top.TAB_GLOBAL_COMPO[710]=Compo_Sujets_Notes_2;
...
top.TAB_GLOBAL_COMPO[711]=Compo_Sujets_Sujets_3;
...
top.TAB_GLOBAL_COMPO[713]=Compo_Sujets_Libellé_4;
...
top.TAB_GLOBAL_COMPO[714]=Compo_Sujets_Notes_5;
...
top.TAB_GLOBAL_COMPO[715]=Compo_Groupe_Liste_des_groupes0;
...
top.TAB_GLOBAL_COMPO[717]=Compo_Groupe_Libellé_1;
...
top.TAB_GLOBAL_COMPO[718]=Compo_Groupe_Notes_2;
...
top.TAB_GLOBAL_COMPO[703]=Compo_Lieu_Liste_des_lieus0;
...
top.TAB_GLOBAL_COMPO[705]=Compo_Lieu_Libellé_1;
