...
var TAB_COMPO_PPTES = new Array(725);
/* on init le tableau */
var id
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[687].NewCle = getNewCle("activite");
...
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[694];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[695];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[696];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[697];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[698];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[699];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[700];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[701];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[702];
 Esclave_8.ActiverComposant(true);
 var Esclave_9=TAB_GLOBAL_COMPO[703];
...
{
 TAB_COMPO_PPTES[704].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[704].NewCle = getNewCle("tache");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[704].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[706];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[707];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[708];
 Esclave_2.ActiverComposant(true);
...
top.document.getElementById("Update_Tâches_Liste_des_tâches0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[704];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[704].NewCle;
}

function Delete_Tâches_Liste_des_tâches0()
{
 if (TAB_GLOBAL_COMPO[704].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[704].Action_en_cours = DELETE;
...
function Update_Tâches_Liste_des_tâches0()
{
 ...
 TAB_COMPO_PPTES[704].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[704].NewCle = TAB_GLOBAL_COMPO[704].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[704].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[706];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[704].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[704].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[706];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[707];
...
top.document.getElementById("Update_Tâches_Liste_des_tâches0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[704].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[704].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[713].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[713].NewCle = getNewCle("typesujet");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[713].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[715];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[716];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Sujets_Sujets_3").disabled=false;
 var Esclave_2=TAB_GLOBAL_COMPO[717];
 Esclave_2.ActiverComposant(true);
...
top.document.getElementById("Update_Sujets_Liste_des_types_de_sujets0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[713];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[713].NewCle;
}

function Delete_Sujets_Liste_des_types_de_sujets0()
{
 if (TAB_GLOBAL_COMPO[713].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[713].Action_en_cours = DELETE;
...
function Update_Sujets_Liste_des_types_de_sujets0()
{
 ...
 TAB_COMPO_PPTES[713].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[713].NewCle = TAB_GLOBAL_COMPO[713].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[713].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[715];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[713].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[713].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[715];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[716];
...
top.document.getElementById("Update_Sujets_Liste_des_types_de_sujets0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[713].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[713].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[713].Action_en_cours == INSERT)
         {
 ...
 TAB_COMPO_PPTES[717].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[717].NewCle = getNewCle("sujet");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[717].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[719];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[720];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Delete_Sujets_Sujets_3").disabled=true;
top.document.getElementById("Update_Sujets_Sujets_3").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[717];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[717].NewCle;
}

function Delete_Sujets_Sujets_3()
{
 if (TAB_GLOBAL_COMPO[717].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[717].Action_en_cours = DELETE;
...
function Update_Sujets_Sujets_3()
{
 ...
 TAB_COMPO_PPTES[717].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[717].NewCle = TAB_GLOBAL_COMPO[717].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[717].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[719];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[717].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[717].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[719];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[720];
...
top.document.getElementById("Update_Sujets_Sujets_3").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[717].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[717].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[721].NewCle = getNewCle("groupe");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[721].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[723];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[724];
 Esclave_1.ActiverComposant(true);
...
{
 TAB_COMPO_PPTES[709].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[709].NewCle = getNewCle("lieu");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[709].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[711];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[712];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Lieu_Liste_des_lieus0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[709];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[709].NewCle;
}

function Delete_Lieu_Liste_des_lieus0()
{
 if (TAB_GLOBAL_COMPO[709].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[709].Action_en_cours = DELETE;
...
function Update_Lieu_Liste_des_lieus0()
{
 ...
 TAB_COMPO_PPTES[709].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[709].NewCle = TAB_GLOBAL_COMPO[709].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[709].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[711];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[709].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[709].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[711];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[712];
...
top.document.getElementById("Update_Lieu_Liste_des_lieus0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[709].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[709].Action_en_cours = null;
 return NewCle;
}
...
top.TAB_GLOBAL_COMPO[687]=Compo_Activités_Liste_des_activités0;
...
top.TAB_GLOBAL_COMPO[694]=Compo_Activités_J_ai_1;
...
top.TAB_GLOBAL_COMPO[695]=Compo_Activités_au_sujet_de_2;
...
top.TAB_GLOBAL_COMPO[696]=Compo_Activités_à_3;
...
top.TAB_GLOBAL_COMPO[697]=Compo_Activités_Pendant__en_minutes__4;
...
top.TAB_GLOBAL_COMPO[698]=Compo_Activités_Le_5;
...
Compo_Activités_de___HH_MM___6.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 699*/
top.TAB_GLOBAL_COMPO[699]=Compo_Activités_de___HH_MM___6;
...
top.TAB_GLOBAL_COMPO[700]=Compo_Activités_à___HH_MM___7;
...
top.TAB_GLOBAL_COMPO[701]=Compo_Activités_Pour_quelle_nature_de_personne___8;
...
top.TAB_GLOBAL_COMPO[702]=Compo_Activités_0__1__2__Valeur__N_facture__devis_____9;
...
top.TAB_GLOBAL_COMPO[703]=Compo_Activités_3__Groupe_10;
...
top.TAB_GLOBAL_COMPO[704]=Compo_Tâches_Liste_des_tâches0;
...
top.TAB_GLOBAL_COMPO[706]=Compo_Tâches_Libellé_1;
...
top.TAB_GLOBAL_COMPO[707]=Compo_Tâches_J_ai_2;
...
top.TAB_GLOBAL_COMPO[708]=Compo_Tâches_Notes_3;
...
top.TAB_GLOBAL_COMPO[713]=Compo_Sujets_Liste_des_types_de_sujets0;
...
top.TAB_GLOBAL_COMPO[715]=Compo_Sujets_Libellé_1;
...
Compo_Sujets_Notes_2.GenererXUL(top.document.getElementById("Sujets_Liste_des_types_de_sujets0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 716*/
top.TAB_GLOBAL_COMPO[716]=Compo_Sujets_Notes_2;
...
top.TAB_GLOBAL_COMPO[717]=Compo_Sujets_Sujets_3;
...
top.TAB_GLOBAL_COMPO[719]=Compo_Sujets_Libellé_4;
...
Compo_Sujets_Notes_5.GenererXUL(top.document.getElementById("Sujets_Sujets_3_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 720*/
top.TAB_GLOBAL_COMPO[720]=Compo_Sujets_Notes_5;
...
top.TAB_GLOBAL_COMPO[721]=Compo_Groupe_Liste_des_groupes0;
...
top.TAB_GLOBAL_COMPO[723]=Compo_Groupe_Libellé_1;
...
top.TAB_GLOBAL_COMPO[724]=Compo_Groupe_Notes_2;
...
top.TAB_GLOBAL_COMPO[709]=Compo_Lieu_Liste_des_lieus0;
...
Compo_Lieu_Libellé_1.GenererXUL(top.document.getElementById("Lieu_Liste_des_lieus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 711*/
top.TAB_GLOBAL_COMPO[711]=Compo_Lieu_Libellé_1;
...
top.TAB_GLOBAL_COMPO[712]=Compo_Lieu_Notes_2;
...
var Composant_0 = TAB_GLOBAL_COMPO[704];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[713];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[709];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
