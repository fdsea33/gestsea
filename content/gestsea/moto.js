...
var TAB_COMPO_PPTES = new Array(699);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[661].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[661].NewCle = getNewCle("activite");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[661].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[668];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[669];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[670];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[671];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[672];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[673];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[674];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[675];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[676];
 Esclave_8.ActiverComposant(true);
 var Esclave_9=TAB_GLOBAL_COMPO[677];
...
top.document.getElementById("Update_Activités_Liste_des_activités0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[661];
...
return TAB_COMPO_PPTES[661].NewCle;
}

function Delete_Activités_Liste_des_activités0()
{
 if (TAB_GLOBAL_COMPO[661].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[661].Action_en_cours = DELETE;
...
function Update_Activités_Liste_des_activités0()
{
 ...
 TAB_COMPO_PPTES[661].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[661].NewCle = TAB_GLOBAL_COMPO[661].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[661].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[668];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[661].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[661].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[668];
...
top.document.getElementById("Update_Activités_Liste_des_activités0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[661].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[661].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[678].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[678].NewCle = getNewCle("tache");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[678].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[680];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[681];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[682];
 Esclave_2.ActiverComposant(true);
...
top.document.getElementById("Update_Tâches_Liste_des_tâches0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[678];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[678].NewCle;
}

function Delete_Tâches_Liste_des_tâches0()
{
 if (TAB_GLOBAL_COMPO[678].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[678].Action_en_cours = DELETE;
...
function Update_Tâches_Liste_des_tâches0()
{
 ...
 TAB_COMPO_PPTES[678].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[678].NewCle = TAB_GLOBAL_COMPO[678].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[678].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[680];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[678].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[678].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[680];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[681];
...
top.document.getElementById("Update_Tâches_Liste_des_tâches0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[678].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[678].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[687].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[687].NewCle = getNewCle("typesujet");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[687].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[689];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[690];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Sujets_Sujets_3").disabled=false;
 var Esclave_2=TAB_GLOBAL_COMPO[691];
 Esclave_2.ActiverComposant(true);
...
top.document.getElementById("Update_Sujets_Liste_des_types_de_sujets0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[687];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[687].NewCle;
}

function Delete_Sujets_Liste_des_types_de_sujets0()
{
 if (TAB_GLOBAL_COMPO[687].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[687].Action_en_cours = DELETE;
...
function Update_Sujets_Liste_des_types_de_sujets0()
{
 ...
 TAB_COMPO_PPTES[687].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[687].NewCle = TAB_GLOBAL_COMPO[687].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[687].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[689];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[687].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[687].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[689];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[690];
...
top.document.getElementById("Update_Sujets_Liste_des_types_de_sujets0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[687].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[687].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[687].Action_en_cours == INSERT)
         {
 ...
 TAB_COMPO_PPTES[691].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[691].NewCle = getNewCle("sujet");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[691].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[693];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[694];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Delete_Sujets_Sujets_3").disabled=true;
top.document.getElementById("Update_Sujets_Sujets_3").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[691];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[691].NewCle;
}

function Delete_Sujets_Sujets_3()
{
 if (TAB_GLOBAL_COMPO[691].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[691].Action_en_cours = DELETE;
...
function Update_Sujets_Sujets_3()
{
 ...
 TAB_COMPO_PPTES[691].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[691].NewCle = TAB_GLOBAL_COMPO[691].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[691].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[693];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[691].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[691].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[693];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[694];
...
top.document.getElementById("Update_Sujets_Sujets_3").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[691].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[691].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[695].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[695].NewCle = getNewCle("groupe");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[695].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[697];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[698];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Groupe_Liste_des_groupes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[695];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[695].NewCle;
}

function Delete_Groupe_Liste_des_groupes0()
{
 if (TAB_GLOBAL_COMPO[695].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[695].Action_en_cours = DELETE;
...
function Update_Groupe_Liste_des_groupes0()
{
 ...
 TAB_COMPO_PPTES[695].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[695].NewCle = TAB_GLOBAL_COMPO[695].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[695].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[697];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[695].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[695].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[697];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[698];
...
top.document.getElementById("Update_Groupe_Liste_des_groupes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[695].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[695].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[683].NewCle = getNewCle("lieu");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[683].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[685];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[686];
 Esclave_1.ActiverComposant(true);
...
Compo_Activités_Liste_des_activités0.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0"));
	...
	/* On l'ajoute au tableau global à l'indice 661*/
top.TAB_GLOBAL_COMPO[661]=Compo_Activités_Liste_des_activités0;
...
top.TAB_GLOBAL_COMPO[668]=Compo_Activités_J_ai_1;
...
top.TAB_GLOBAL_COMPO[669]=Compo_Activités_au_sujet_de_2;
...
top.TAB_GLOBAL_COMPO[670]=Compo_Activités_à_3;
...
top.TAB_GLOBAL_COMPO[671]=Compo_Activités_Pendant__en_minutes__4;
...
Compo_Activités_Le_5.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 672*/
top.TAB_GLOBAL_COMPO[672]=Compo_Activités_Le_5;
...
Compo_Activités_de___HH_MM___6.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 673*/
top.TAB_GLOBAL_COMPO[673]=Compo_Activités_de___HH_MM___6;
...
Compo_Activités_à___HH_MM___7.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 674*/
top.TAB_GLOBAL_COMPO[674]=Compo_Activités_à___HH_MM___7;
...
top.TAB_GLOBAL_COMPO[675]=Compo_Activités_Pour_quelle_nature_de_personne___8;
...
top.TAB_GLOBAL_COMPO[676]=Compo_Activités_0__1__2__Valeur__N_facture__devis_____9;
...
top.TAB_GLOBAL_COMPO[677]=Compo_Activités_3__Groupe_10;
...
top.TAB_GLOBAL_COMPO[678]=Compo_Tâches_Liste_des_tâches0;
...
top.TAB_GLOBAL_COMPO[680]=Compo_Tâches_Libellé_1;
...
top.TAB_GLOBAL_COMPO[681]=Compo_Tâches_J_ai_2;
...
top.TAB_GLOBAL_COMPO[682]=Compo_Tâches_Notes_3;
...
top.TAB_GLOBAL_COMPO[687]=Compo_Sujets_Liste_des_types_de_sujets0;
...
top.TAB_GLOBAL_COMPO[689]=Compo_Sujets_Libellé_1;
...
top.TAB_GLOBAL_COMPO[690]=Compo_Sujets_Notes_2;
...
top.TAB_GLOBAL_COMPO[691]=Compo_Sujets_Sujets_3;
...
top.TAB_GLOBAL_COMPO[693]=Compo_Sujets_Libellé_4;
...
top.TAB_GLOBAL_COMPO[694]=Compo_Sujets_Notes_5;
...
top.TAB_GLOBAL_COMPO[695]=Compo_Groupe_Liste_des_groupes0;
...
top.TAB_GLOBAL_COMPO[697]=Compo_Groupe_Libellé_1;
...
top.TAB_GLOBAL_COMPO[698]=Compo_Groupe_Notes_2;
...
top.TAB_GLOBAL_COMPO[683]=Compo_Lieu_Liste_des_lieus0;
...
top.TAB_GLOBAL_COMPO[685]=Compo_Lieu_Libellé_1;
...
Compo_Lieu_Notes_2.GenererXUL(top.document.getElementById("Lieu_Liste_des_lieus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 686*/
top.TAB_GLOBAL_COMPO[686]=Compo_Lieu_Notes_2;
 if(ALeDroit(5,"activite"))
 {
/* On refresh les composants non dépendents de l'onget Activités*/
var Composant_0 = TAB_GLOBAL_COMPO[661];
if (Composant_0!=null){
...
var Composant_0 = TAB_GLOBAL_COMPO[678];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[687];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[695];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
