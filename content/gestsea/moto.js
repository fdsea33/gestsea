...
var TAB_COMPO_PPTES = new Array(706);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[668].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[668].NewCle = getNewCle("activite");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[668].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[675];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[676];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[677];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[678];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[679];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[680];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[681];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[682];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[683];
 Esclave_8.ActiverComposant(true);
 var Esclave_9=TAB_GLOBAL_COMPO[684];
...
top.document.getElementById("Update_Activités_Liste_des_activités0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[668];
...
return TAB_COMPO_PPTES[668].NewCle;
}

function Delete_Activités_Liste_des_activités0()
{
 if (TAB_GLOBAL_COMPO[668].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[668].Action_en_cours = DELETE;
...
function Update_Activités_Liste_des_activités0()
{
 ...
 TAB_COMPO_PPTES[668].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[668].NewCle = TAB_GLOBAL_COMPO[668].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[668].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[675];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[668].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[668].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[675];
...
top.document.getElementById("Update_Activités_Liste_des_activités0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[668].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[668].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[685].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[685].NewCle = getNewCle("tache");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[685].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[687];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[688];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[689];
 Esclave_2.ActiverComposant(true);
...
top.document.getElementById("Update_Tâches_Liste_des_tâches0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[685];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[685].NewCle;
}

function Delete_Tâches_Liste_des_tâches0()
{
 if (TAB_GLOBAL_COMPO[685].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[685].Action_en_cours = DELETE;
...
function Update_Tâches_Liste_des_tâches0()
{
 ...
 TAB_COMPO_PPTES[685].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[685].NewCle = TAB_GLOBAL_COMPO[685].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[685].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[687];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[685].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[685].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[687];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[688];
...
top.document.getElementById("Update_Tâches_Liste_des_tâches0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[685].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[685].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[694].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[694].NewCle = getNewCle("typesujet");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[694].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[696];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[697];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Sujets_Sujets_3").disabled=false;
 var Esclave_2=TAB_GLOBAL_COMPO[698];
 Esclave_2.ActiverComposant(true);
...
top.document.getElementById("Update_Sujets_Liste_des_types_de_sujets0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[694];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[694].NewCle;
}

function Delete_Sujets_Liste_des_types_de_sujets0()
{
 if (TAB_GLOBAL_COMPO[694].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[694].Action_en_cours = DELETE;
...
function Update_Sujets_Liste_des_types_de_sujets0()
{
 ...
 TAB_COMPO_PPTES[694].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[694].NewCle = TAB_GLOBAL_COMPO[694].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[694].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[696];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[694].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[694].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[696];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[697];
...
top.document.getElementById("Update_Sujets_Liste_des_types_de_sujets0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[694].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[694].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[694].Action_en_cours == INSERT)
         {
 ...
 TAB_COMPO_PPTES[698].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[698].NewCle = getNewCle("sujet");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[698].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
...
top.document.getElementById("Delete_Sujets_Sujets_3").disabled=true;
top.document.getElementById("Update_Sujets_Sujets_3").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[698];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[698].NewCle;
}

function Delete_Sujets_Sujets_3()
{
 if (TAB_GLOBAL_COMPO[698].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[698].Action_en_cours = DELETE;
...
function Update_Sujets_Sujets_3()
{
 ...
 TAB_COMPO_PPTES[698].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[698].NewCle = TAB_GLOBAL_COMPO[698].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[698].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[700];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[698].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[698].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[700];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[701];
...
top.document.getElementById("Update_Sujets_Sujets_3").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[698].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[698].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[702].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[702].NewCle = getNewCle("groupe");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[702].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[704];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[705];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Groupe_Liste_des_groupes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[702];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[702].NewCle;
}

function Delete_Groupe_Liste_des_groupes0()
{
 if (TAB_GLOBAL_COMPO[702].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[702].Action_en_cours = DELETE;
...
function Update_Groupe_Liste_des_groupes0()
{
 ...
 TAB_COMPO_PPTES[702].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[702].NewCle = TAB_GLOBAL_COMPO[702].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[702].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[704];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[702].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[702].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[704];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[705];
...
top.document.getElementById("Update_Groupe_Liste_des_groupes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[702].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[702].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[690].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[690].NewCle = getNewCle("lieu");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[690].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[692];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[693];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Lieu_Liste_des_lieus0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[690];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[690].NewCle;
}

function Delete_Lieu_Liste_des_lieus0()
{
 if (TAB_GLOBAL_COMPO[690].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[690].Action_en_cours = DELETE;
...
function Update_Lieu_Liste_des_lieus0()
{
 ...
 TAB_COMPO_PPTES[690].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[690].NewCle = TAB_GLOBAL_COMPO[690].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[690].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[692];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[690].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[690].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[692];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[693];
...
top.document.getElementById("Update_Lieu_Liste_des_lieus0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[690].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[690].Action_en_cours = null;
 return NewCle;
}
...
top.TAB_GLOBAL_COMPO[668]=Compo_Activités_Liste_des_activités0;
...
Compo_Activités_J_ai_1.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 675*/
top.TAB_GLOBAL_COMPO[675]=Compo_Activités_J_ai_1;
...
top.TAB_GLOBAL_COMPO[676]=Compo_Activités_au_sujet_de_2;
...
top.TAB_GLOBAL_COMPO[677]=Compo_Activités_à_3;
...
top.TAB_GLOBAL_COMPO[678]=Compo_Activités_Pendant__en_minutes__4;
...
top.TAB_GLOBAL_COMPO[679]=Compo_Activités_Le_5;
...
top.TAB_GLOBAL_COMPO[680]=Compo_Activités_de___HH_MM___6;
...
top.TAB_GLOBAL_COMPO[681]=Compo_Activités_à___HH_MM___7;
...
top.TAB_GLOBAL_COMPO[682]=Compo_Activités_Pour_quelle_nature_de_personne___8;
...
top.TAB_GLOBAL_COMPO[683]=Compo_Activités_0__1__2__Valeur__N_facture__devis_____9;
...
Compo_Activités_3__Groupe_10.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 684*/
top.TAB_GLOBAL_COMPO[684]=Compo_Activités_3__Groupe_10;
...
Compo_Tâches_Liste_des_tâches0.GenererXUL(top.document.getElementById("Tâches_Liste_des_tâches0"));
	...
	/* On l'ajoute au tableau global à l'indice 685*/
top.TAB_GLOBAL_COMPO[685]=Compo_Tâches_Liste_des_tâches0;
...
Compo_Tâches_Libellé_1.GenererXUL(top.document.getElementById("Tâches_Liste_des_tâches0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 687*/
top.TAB_GLOBAL_COMPO[687]=Compo_Tâches_Libellé_1;
...
top.TAB_GLOBAL_COMPO[688]=Compo_Tâches_J_ai_2;
...
top.TAB_GLOBAL_COMPO[689]=Compo_Tâches_Notes_3;
...
top.TAB_GLOBAL_COMPO[694]=Compo_Sujets_Liste_des_types_de_sujets0;
...
Compo_Sujets_Libellé_1.GenererXUL(top.document.getElementById("Sujets_Liste_des_types_de_sujets0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 696*/
top.TAB_GLOBAL_COMPO[696]=Compo_Sujets_Libellé_1;
...
Compo_Sujets_Notes_2.GenererXUL(top.document.getElementById("Sujets_Liste_des_types_de_sujets0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 697*/
top.TAB_GLOBAL_COMPO[697]=Compo_Sujets_Notes_2;
...
Compo_Sujets_Sujets_3.GenererXUL(top.document.getElementById("Sujets_Sujets_3"));
	...
	/* On l'ajoute au tableau global à l'indice 698*/
top.TAB_GLOBAL_COMPO[698]=Compo_Sujets_Sujets_3;
...
top.TAB_GLOBAL_COMPO[700]=Compo_Sujets_Libellé_4;
...
top.TAB_GLOBAL_COMPO[701]=Compo_Sujets_Notes_5;
...
top.TAB_GLOBAL_COMPO[702]=Compo_Groupe_Liste_des_groupes0;
...
top.TAB_GLOBAL_COMPO[704]=Compo_Groupe_Libellé_1;
...
top.TAB_GLOBAL_COMPO[705]=Compo_Groupe_Notes_2;
...
top.TAB_GLOBAL_COMPO[690]=Compo_Lieu_Liste_des_lieus0;
...
top.TAB_GLOBAL_COMPO[692]=Compo_Lieu_Libellé_1;
...
var Composant_0 = TAB_GLOBAL_COMPO[685];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[694];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[702];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[690];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
