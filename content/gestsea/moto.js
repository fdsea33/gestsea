...
var TAB_COMPO_PPTES = new Array(1579);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[1541].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1541].NewCle = getNewCle("activite");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1541].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1548];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1549];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[1550];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[1551];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[1552];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[1553];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[1554];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[1555];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[1556];
 Esclave_8.ActiverComposant(true);
 var Esclave_9=TAB_GLOBAL_COMPO[1557];
...
top.document.getElementById("Update_Activités_Liste_des_activités0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1541];
...
return TAB_COMPO_PPTES[1541].NewCle;
}

function Delete_Activités_Liste_des_activités0()
{
 if (TAB_GLOBAL_COMPO[1541].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[1541].Action_en_cours = DELETE;
...
function Update_Activités_Liste_des_activités0()
{
 ...
 TAB_COMPO_PPTES[1541].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1541].NewCle = TAB_GLOBAL_COMPO[1541].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1541].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1548];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1541].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1541].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1548];
...
top.document.getElementById("Update_Activités_Liste_des_activités0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1541].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1541].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[1558].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1558].NewCle = getNewCle("tache");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1558].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1560];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1561];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[1562];
 Esclave_2.ActiverComposant(true);
...
top.document.getElementById("Update_Tâches_Liste_des_tâches0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1558];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[1558].NewCle;
}

function Delete_Tâches_Liste_des_tâches0()
{
 if (TAB_GLOBAL_COMPO[1558].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[1558].Action_en_cours = DELETE;
...
function Update_Tâches_Liste_des_tâches0()
{
 ...
 TAB_COMPO_PPTES[1558].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1558].NewCle = TAB_GLOBAL_COMPO[1558].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1558].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1560];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1558].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1558].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1560];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[1561];
...
top.document.getElementById("Update_Tâches_Liste_des_tâches0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1558].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1558].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[1567].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1567].NewCle = getNewCle("typesujet");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1567].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1569];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1570];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Sujets_Sujets_3").disabled=false;
 var Esclave_2=TAB_GLOBAL_COMPO[1571];
 Esclave_2.ActiverComposant(true);
...
top.document.getElementById("Update_Sujets_Liste_des_types_de_sujets0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1567];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[1567].NewCle;
}

function Delete_Sujets_Liste_des_types_de_sujets0()
{
 if (TAB_GLOBAL_COMPO[1567].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[1567].Action_en_cours = DELETE;
...
function Update_Sujets_Liste_des_types_de_sujets0()
{
 ...
 TAB_COMPO_PPTES[1567].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1567].NewCle = TAB_GLOBAL_COMPO[1567].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1567].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1569];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1567].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1567].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1569];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[1570];
...
top.document.getElementById("Update_Sujets_Liste_des_types_de_sujets0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1567].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1567].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[1567].Action_en_cours == INSERT)
         {
 ...
 TAB_COMPO_PPTES[1571].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1571].NewCle = getNewCle("sujet");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1571].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1573];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1574];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Delete_Sujets_Sujets_3").disabled=true;
top.document.getElementById("Update_Sujets_Sujets_3").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1571];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[1571].NewCle;
}

function Delete_Sujets_Sujets_3()
{
 if (TAB_GLOBAL_COMPO[1571].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[1571].Action_en_cours = DELETE;
...
function Update_Sujets_Sujets_3()
{
 ...
 TAB_COMPO_PPTES[1571].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1571].NewCle = TAB_GLOBAL_COMPO[1571].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1571].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1573];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1571].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1571].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1573];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[1574];
...
top.document.getElementById("Update_Sujets_Sujets_3").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1571].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1571].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[1575].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1575].NewCle = getNewCle("groupe");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1575].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1577];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1578];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Groupe_Liste_des_groupes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1575];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[1575].NewCle;
}

function Delete_Groupe_Liste_des_groupes0()
{
 if (TAB_GLOBAL_COMPO[1575].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[1575].Action_en_cours = DELETE;
...
function Update_Groupe_Liste_des_groupes0()
{
 ...
 TAB_COMPO_PPTES[1575].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1575].NewCle = TAB_GLOBAL_COMPO[1575].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1575].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1577];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1575].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1575].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1577];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[1578];
...
top.document.getElementById("Update_Groupe_Liste_des_groupes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1575].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1575].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[1563].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1563].NewCle = getNewCle("lieu");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1563].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1565];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[1566];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Lieu_Liste_des_lieus0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[1563];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[1563].NewCle;
}

function Delete_Lieu_Liste_des_lieus0()
{
 if (TAB_GLOBAL_COMPO[1563].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[1563].Action_en_cours = DELETE;
...
function Update_Lieu_Liste_des_lieus0()
{
 ...
 TAB_COMPO_PPTES[1563].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[1563].NewCle = TAB_GLOBAL_COMPO[1563].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1563].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1565];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[1563].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[1563].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[1565];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[1566];
...
top.document.getElementById("Update_Lieu_Liste_des_lieus0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[1563].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[1563].Action_en_cours = null;
 return NewCle;
}
...
Compo_Activités_Liste_des_activités0.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0"));
	...
	/* On l'ajoute au tableau global à l'indice 1541*/
top.TAB_GLOBAL_COMPO[1541]=Compo_Activités_Liste_des_activités0;
...
Compo_Activités_J_ai_1.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1548*/
top.TAB_GLOBAL_COMPO[1548]=Compo_Activités_J_ai_1;
...
Compo_Activités_au_sujet_de_2.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1549*/
top.TAB_GLOBAL_COMPO[1549]=Compo_Activités_au_sujet_de_2;
...
Compo_Activités_à_3.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1550*/
top.TAB_GLOBAL_COMPO[1550]=Compo_Activités_à_3;
...
Compo_Activités_Pendant__en_minutes__4.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1551*/
top.TAB_GLOBAL_COMPO[1551]=Compo_Activités_Pendant__en_minutes__4;
...
Compo_Activités_Le_5.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1552*/
top.TAB_GLOBAL_COMPO[1552]=Compo_Activités_Le_5;
...
Compo_Activités_de___HH_MM___6.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1553*/
top.TAB_GLOBAL_COMPO[1553]=Compo_Activités_de___HH_MM___6;
...
Compo_Activités_à___HH_MM___7.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1554*/
top.TAB_GLOBAL_COMPO[1554]=Compo_Activités_à___HH_MM___7;
...
Compo_Activités_Pour_quelle_nature_de_personne___8.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1555*/
top.TAB_GLOBAL_COMPO[1555]=Compo_Activités_Pour_quelle_nature_de_personne___8;
...
Compo_Activités_0__1__2__Valeur__N_facture__devis_____9.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1556*/
top.TAB_GLOBAL_COMPO[1556]=Compo_Activités_0__1__2__Valeur__N_facture__devis_____9;
...
Compo_Activités_3__Groupe_10.GenererXUL(top.document.getElementById("Activités_Liste_des_activités0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1557*/
top.TAB_GLOBAL_COMPO[1557]=Compo_Activités_3__Groupe_10;
...
Compo_Tâches_Liste_des_tâches0.GenererXUL(top.document.getElementById("Tâches_Liste_des_tâches0"));
	...
	/* On l'ajoute au tableau global à l'indice 1558*/
top.TAB_GLOBAL_COMPO[1558]=Compo_Tâches_Liste_des_tâches0;
...
Compo_Tâches_Libellé_1.GenererXUL(top.document.getElementById("Tâches_Liste_des_tâches0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1560*/
top.TAB_GLOBAL_COMPO[1560]=Compo_Tâches_Libellé_1;
...
Compo_Tâches_J_ai_2.GenererXUL(top.document.getElementById("Tâches_Liste_des_tâches0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1561*/
top.TAB_GLOBAL_COMPO[1561]=Compo_Tâches_J_ai_2;
...
Compo_Tâches_Notes_3.GenererXUL(top.document.getElementById("Tâches_Liste_des_tâches0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1562*/
top.TAB_GLOBAL_COMPO[1562]=Compo_Tâches_Notes_3;
...
Compo_Sujets_Liste_des_types_de_sujets0.GenererXUL(top.document.getElementById("Sujets_Liste_des_types_de_sujets0"));
	...
	/* On l'ajoute au tableau global à l'indice 1567*/
top.TAB_GLOBAL_COMPO[1567]=Compo_Sujets_Liste_des_types_de_sujets0;
...
Compo_Sujets_Libellé_1.GenererXUL(top.document.getElementById("Sujets_Liste_des_types_de_sujets0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1569*/
top.TAB_GLOBAL_COMPO[1569]=Compo_Sujets_Libellé_1;
...
Compo_Sujets_Notes_2.GenererXUL(top.document.getElementById("Sujets_Liste_des_types_de_sujets0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1570*/
top.TAB_GLOBAL_COMPO[1570]=Compo_Sujets_Notes_2;
...
Compo_Sujets_Sujets_3.GenererXUL(top.document.getElementById("Sujets_Sujets_3"));
	...
	/* On l'ajoute au tableau global à l'indice 1571*/
top.TAB_GLOBAL_COMPO[1571]=Compo_Sujets_Sujets_3;
...
Compo_Sujets_Libellé_4.GenererXUL(top.document.getElementById("Sujets_Sujets_3_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1573*/
top.TAB_GLOBAL_COMPO[1573]=Compo_Sujets_Libellé_4;
...
Compo_Sujets_Notes_5.GenererXUL(top.document.getElementById("Sujets_Sujets_3_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1574*/
top.TAB_GLOBAL_COMPO[1574]=Compo_Sujets_Notes_5;
...
Compo_Groupe_Liste_des_groupes0.GenererXUL(top.document.getElementById("Groupe_Liste_des_groupes0"));
	...
	/* On l'ajoute au tableau global à l'indice 1575*/
top.TAB_GLOBAL_COMPO[1575]=Compo_Groupe_Liste_des_groupes0;
...
Compo_Groupe_Libellé_1.GenererXUL(top.document.getElementById("Groupe_Liste_des_groupes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1577*/
top.TAB_GLOBAL_COMPO[1577]=Compo_Groupe_Libellé_1;
...
Compo_Groupe_Notes_2.GenererXUL(top.document.getElementById("Groupe_Liste_des_groupes0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1578*/
top.TAB_GLOBAL_COMPO[1578]=Compo_Groupe_Notes_2;
...
Compo_Lieu_Liste_des_lieus0.GenererXUL(top.document.getElementById("Lieu_Liste_des_lieus0"));
	...
	/* On l'ajoute au tableau global à l'indice 1563*/
top.TAB_GLOBAL_COMPO[1563]=Compo_Lieu_Liste_des_lieus0;
...
Compo_Lieu_Libellé_1.GenererXUL(top.document.getElementById("Lieu_Liste_des_lieus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1565*/
top.TAB_GLOBAL_COMPO[1565]=Compo_Lieu_Libellé_1;
...
Compo_Lieu_Notes_2.GenererXUL(top.document.getElementById("Lieu_Liste_des_lieus0_Slaves"));
	...
	/* On l'ajoute au tableau global à l'indice 1566*/
top.TAB_GLOBAL_COMPO[1566]=Compo_Lieu_Notes_2;
 if(ALeDroit(5,"activite"))
 {
/* On refresh les composants non dépendents de l'onget Activités*/
var Composant_0 = TAB_GLOBAL_COMPO[1541];
if (Composant_0!=null){
...
var Composant_0 = TAB_GLOBAL_COMPO[1558];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[1567];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[1575];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[1563];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
