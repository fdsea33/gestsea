...
var TAB_COMPO_PPTES = new Array(724);
/* on init le tableau */
var id
...
{
 TAB_COMPO_PPTES[686].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[686].NewCle = getNewCle("activite");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[686].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 ...
 var Esclave_2=TAB_GLOBAL_COMPO[695];
 Esclave_2.ActiverComposant(true);
 var Esclave_3=TAB_GLOBAL_COMPO[696];
 Esclave_3.ActiverComposant(true);
 var Esclave_4=TAB_GLOBAL_COMPO[697];
 Esclave_4.ActiverComposant(true);
 var Esclave_5=TAB_GLOBAL_COMPO[698];
 Esclave_5.ActiverComposant(true);
 var Esclave_6=TAB_GLOBAL_COMPO[699];
 Esclave_6.ActiverComposant(true);
 var Esclave_7=TAB_GLOBAL_COMPO[700];
 Esclave_7.ActiverComposant(true);
 var Esclave_8=TAB_GLOBAL_COMPO[701];
 Esclave_8.ActiverComposant(true);
 var Esclave_9=TAB_GLOBAL_COMPO[702];
...
top.document.getElementById("Update_Activités_Liste_des_activités0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[686];
...
return TAB_COMPO_PPTES[686].NewCle;
}

function Delete_Activités_Liste_des_activités0()
{
 if (TAB_GLOBAL_COMPO[686].getCleVal()==-1)
 {
 ...
 {
        TAB_COMPO_PPTES[686].Action_en_cours = DELETE;
...
function Update_Activités_Liste_des_activités0()
{
 ...
 TAB_COMPO_PPTES[686].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[686].NewCle = TAB_GLOBAL_COMPO[686].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[686].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[693];
...
if (retour==null)
 ...
 var NewCle=null;
 switch(TAB_COMPO_PPTES[686].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[686].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[693];
...
top.document.getElementById("Update_Activités_Liste_des_activités0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[686].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[686].Action_en_cours = null;
 return NewCle;
}
...
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[703].NewCle = getNewCle("tache");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[703].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[705];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[706];
 Esclave_1.ActiverComposant(true);
 var Esclave_2=TAB_GLOBAL_COMPO[707];
 Esclave_2.ActiverComposant(true);
...
{
 TAB_COMPO_PPTES[712].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[712].NewCle = getNewCle("typesujet");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[712].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[714];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[715];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Sujets_Sujets_3").disabled=false;
 var Esclave_2=TAB_GLOBAL_COMPO[716];
 Esclave_2.ActiverComposant(true);
...
top.document.getElementById("Update_Sujets_Liste_des_types_de_sujets0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[712];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[712].NewCle;
}

function Delete_Sujets_Liste_des_types_de_sujets0()
{
 if (TAB_GLOBAL_COMPO[712].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[712].Action_en_cours = DELETE;
...
function Update_Sujets_Liste_des_types_de_sujets0()
{
 ...
 TAB_COMPO_PPTES[712].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[712].NewCle = TAB_GLOBAL_COMPO[712].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[712].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[714];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[712].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[712].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[714];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[715];
...
top.document.getElementById("Update_Sujets_Liste_des_types_de_sujets0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[712].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[712].Action_en_cours = null;
 return NewCle;
}
...
{
 if (TAB_COMPO_PPTES[712].Action_en_cours == INSERT)
         {
 ...
 TAB_COMPO_PPTES[716].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[716].NewCle = getNewCle("sujet");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[716].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[718];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[719];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Delete_Sujets_Sujets_3").disabled=true;
top.document.getElementById("Update_Sujets_Sujets_3").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[716];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[716].NewCle;
}

function Delete_Sujets_Sujets_3()
{
 if (TAB_GLOBAL_COMPO[716].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[716].Action_en_cours = DELETE;
...
function Update_Sujets_Sujets_3()
{
 ...
 TAB_COMPO_PPTES[716].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[716].NewCle = TAB_GLOBAL_COMPO[716].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[716].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[718];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[716].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[716].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[718];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[719];
...
top.document.getElementById("Update_Sujets_Sujets_3").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[716].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[716].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[720].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[720].NewCle = getNewCle("groupe");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[720].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[722];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[723];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Groupe_Liste_des_groupes0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[720];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[720].NewCle;
}

function Delete_Groupe_Liste_des_groupes0()
{
 if (TAB_GLOBAL_COMPO[720].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[720].Action_en_cours = DELETE;
...
function Update_Groupe_Liste_des_groupes0()
{
 ...
 TAB_COMPO_PPTES[720].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[720].NewCle = TAB_GLOBAL_COMPO[720].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[720].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[722];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[720].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[720].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[722];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[723];
...
top.document.getElementById("Update_Groupe_Liste_des_groupes0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[720].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[720].Action_en_cours = null;
 return NewCle;
}
...
{
 TAB_COMPO_PPTES[708].Action_en_cours = INSERT;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[708].NewCle = getNewCle("lieu");
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[708].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[710];
 Esclave_0.ActiverComposant(true);
 var Esclave_1=TAB_GLOBAL_COMPO[711];
 Esclave_1.ActiverComposant(true);
...
top.document.getElementById("Update_Lieu_Liste_des_lieus0").disabled=true;
 var Maitre=TAB_GLOBAL_COMPO[708];
 /* Pour une insertion on désectionne */
 var tree=Maitre.getComposantXul();
 if (tree.view!=null)
 {
...
return TAB_COMPO_PPTES[708].NewCle;
}

function Delete_Lieu_Liste_des_lieus0()
{
 if (TAB_GLOBAL_COMPO[708].getCleVal()==-1)
 {
         alert("Vous devez sélectionner l'enregistrement à supprimer");
         return;
 }
 ...
 if (confirm("Voulez vous vraiment supprimer l'enregistrement en cours ?"))
 {
        TAB_COMPO_PPTES[708].Action_en_cours = DELETE;
...
function Update_Lieu_Liste_des_lieus0()
{
 ...
 TAB_COMPO_PPTES[708].Action_en_cours = UPDATE;
/* On calcule la nouvelle clé */
 TAB_COMPO_PPTES[708].NewCle = TAB_GLOBAL_COMPO[708].getCleVal();
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[708].ActiverComposant(false,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[710];
...
if (retour==null)
 ...
 /* On recupère la clé du nouvel enregistrement */
 var NewCle=null;
 switch(TAB_COMPO_PPTES[708].Action_en_cours){
        case INSERT :
...
/* On désactive le composant maitre */
 TAB_GLOBAL_COMPO[708].ActiverComposant(true,true);
/* On active les composants esclaves et on vide les champs */
 var Esclave_0=TAB_GLOBAL_COMPO[710];
 Esclave_0.ActiverComposant(false);
 var Esclave_1=TAB_GLOBAL_COMPO[711];
...
top.document.getElementById("Update_Lieu_Liste_des_lieus0").disabled=false;
 if (NewCle==null)
         NewCle=TAB_COMPO_PPTES[708].NewCle;
 Maitre.ForceNextSelection(NewCle)
 Maitre.RefreshTotal();
 if(retour)
 {
 }
 TAB_COMPO_PPTES[708].Action_en_cours = null;
 return NewCle;
}
...
top.TAB_GLOBAL_COMPO[686]=Compo_Activités_Liste_des_activités0;
...
top.TAB_GLOBAL_COMPO[693]=Compo_Activités_J_ai_1;
...
top.TAB_GLOBAL_COMPO[694]=Compo_Activités_au_sujet_de_2;
...
top.TAB_GLOBAL_COMPO[695]=Compo_Activités_à_3;
...
top.TAB_GLOBAL_COMPO[696]=Compo_Activités_Pendant__en_minutes__4;
...
top.TAB_GLOBAL_COMPO[697]=Compo_Activités_Le_5;
...
top.TAB_GLOBAL_COMPO[698]=Compo_Activités_de___HH_MM___6;
...
top.TAB_GLOBAL_COMPO[699]=Compo_Activités_à___HH_MM___7;
...
top.TAB_GLOBAL_COMPO[700]=Compo_Activités_Pour_quelle_nature_de_personne___8;
...
top.TAB_GLOBAL_COMPO[701]=Compo_Activités_0__1__2__Valeur__N_facture__devis_____9;
...
top.TAB_GLOBAL_COMPO[702]=Compo_Activités_3__Groupe_10;
...
top.TAB_GLOBAL_COMPO[703]=Compo_Tâches_Liste_des_tâches0;
...
top.TAB_GLOBAL_COMPO[705]=Compo_Tâches_Libellé_1;
...
top.TAB_GLOBAL_COMPO[706]=Compo_Tâches_J_ai_2;
...
top.TAB_GLOBAL_COMPO[707]=Compo_Tâches_Notes_3;
...
top.TAB_GLOBAL_COMPO[712]=Compo_Sujets_Liste_des_types_de_sujets0;
...
top.TAB_GLOBAL_COMPO[714]=Compo_Sujets_Libellé_1;
...
top.TAB_GLOBAL_COMPO[715]=Compo_Sujets_Notes_2;
...
top.TAB_GLOBAL_COMPO[716]=Compo_Sujets_Sujets_3;
...
top.TAB_GLOBAL_COMPO[718]=Compo_Sujets_Libellé_4;
...
top.TAB_GLOBAL_COMPO[719]=Compo_Sujets_Notes_5;
...
top.TAB_GLOBAL_COMPO[720]=Compo_Groupe_Liste_des_groupes0;
...
top.TAB_GLOBAL_COMPO[722]=Compo_Groupe_Libellé_1;
...
top.TAB_GLOBAL_COMPO[723]=Compo_Groupe_Notes_2;
...
top.TAB_GLOBAL_COMPO[708]=Compo_Lieu_Liste_des_lieus0;
...
top.TAB_GLOBAL_COMPO[710]=Compo_Lieu_Libellé_1;
...
var Composant_0 = TAB_GLOBAL_COMPO[712];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[720];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
...
var Composant_0 = TAB_GLOBAL_COMPO[708];
if (Composant_0!=null){
Composant_0.ActiverComposant(true);
Composant_0.Refresh();
}
